...
@section('content')
    @php
        $formId = 'F' . uniqid();
    @endphp
    <form id="TeacherAccountForm_{{ $formId }}" action="{{ action([App\Http\Controllers\TeacherController::class, 'account'], [
        'id' => $teacher->id,
    ]) }}" method="post"
        ...
        <div class="scroll-y pe-7  py-10 px-lg-17">
            ...
            <div class="row g-9 mb-7">
                ...
                <div class="col-md-12 fv-row">
                    <!--begin::Label-->
                    <label class=" {{ $user->id ? '' : 'required' }} fs-6 fw-semibold mb-2">Email</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text"
        ...
        <div class="modal-footer flex-center">
            <!--begin::Button-->
            <button id="TeacherAccountForm_{{ $formId }}_Submit" type="submit" class="btn btn-primary">
        ...
        var UsersCreate = function() {
            ...
            submit = () => {
                ...
                $.ajax({
                    ...
                    // hide popup
                    window.teacherAccount.popup.hide();
                    ...
                    window.teacherAccount.popup.setContent(response.responseText);
            ...
            return {
                init: function() {
                    form = document.getElementById('TeacherAccountForm_{{ $formId }}');
                    btnSubmit = document.getElementById('TeacherAccountForm_{{ $formId }}_Submit');
