        ...
        <div id="courses-table-box" class="table-responsive scrollable-orders-table">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="dtHorizontalVerticalOrder">
                ...
                <tbody class="text-gray-600">
                    ...
                    @if ($courseStudent->course->subject)
                            ...
                            <td class="text-left">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    {{-- <div class="menu-item px-3">
                                        <a href="{{ action(
                                            [App\Http\Controllers\Sales\CourseController::class, 'showDetail'],
                                            [
                                    ...
                                    {{-- <div
                                        ...
                                        <a row-action="class-transfer"
                                            href="{{ action(
                                                [App\Http\Controllers\Sales\StudentController::class, 'transferClass'],
                                                [
                                                    'id' => $contact->id,
                                    ...
                                    {{-- <div
                                        ...
                                        <a row-action="class-transfer"
                                            href="{{ action(
                                                [App\Http\Controllers\Sales\StudentController::class, 'exitClass'],
                                                [
                                                    'id' => $contact->id,
                                    ...
                                    {{-- <div class="menu-item px-3 ">
                                        <a row-action="class-transfer"
                                            href="{{ action(
                                                [App\Http\Controllers\Sales\StudentController::class, 'reserveClass'],
                                                [
                                                    'id' => $contact->id,
                                                    'courseId' => $courseStudent->course->id,
                                                ],
                                    ...
                                    <div
                                        ...
                                        <a row-action="class-transfer"
                                            href="{{ action(
                                                [App\Http\Controllers\Sales\StudentController::class, 'refundRequest'],
                                                [
                                                    'id' => $contact->id,
                                                    'courseId' => $courseStudent->course->id,
                                                ],
