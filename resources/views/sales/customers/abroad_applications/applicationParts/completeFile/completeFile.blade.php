<div class="row" id="complete_file">
    ...
    <div class="col-md-9" form-data="complete-file-manager-container"
        data-upload-url="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'storeCompleteFile'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'deleteCompleteFile'], ['id' => $abroadApplication->id]) }}">
