...
<div class="row" id="student_cv">
    ...
    <div class="col-md-9" form-data="cv-manager-container" 
        data-upload-url="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'storeCV'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'deleteCV'], ['id' => $abroadApplication->id]) }}">
