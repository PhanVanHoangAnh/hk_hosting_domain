<div class="row" id="scan_of_information">
    ...
    <div class="col-md-9" form-data="scan-of-information-manager-container"
        data-upload-url="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'storeScanOfInformation'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'deleteScanOfInformation'], ['id' => $abroadApplication->id]) }}">
