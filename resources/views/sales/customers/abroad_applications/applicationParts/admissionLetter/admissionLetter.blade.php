    ...
    <div class="col-md-9" form-data="manager-container" >
        ...
        <div class="row">
            ...
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-none">
                ...
                href="{{ action(
                    [App\Http\Controllers\Sales\AbroadController::class, 'createAdmissionLetter'],
                    [
            ...
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                ...
                href="{{ action(
                    [App\Http\Controllers\Sales\AbroadController::class, 'showRecruitmentResults'],
                    [
                        'id' => $abroadApplication->id,
                    ],
                ) }}">Xem</a>
...
{{-- <div class="row">
    ...
    <div class="col-md-10" form-data="admission-letter-manager-container"
        data-upload-url="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'storeAdmissionLetter'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'deleteAdmissionLetter'], ['id' => $abroadApplication->id]) }}">
