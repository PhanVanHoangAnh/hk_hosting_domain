<div class="row" id="deposit_for_school">
    ...
    <div class="col-md-9" form-data="deposit-manager-container"
        ...
        <form form-data="deposit-for-school-form" method="POST" action="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'updateDepositForSchool'], ['id' => $abroadApplication->id]) }}" class="row d-flex justify-content-around">
            @csrf
            <div class="col-md-4">
