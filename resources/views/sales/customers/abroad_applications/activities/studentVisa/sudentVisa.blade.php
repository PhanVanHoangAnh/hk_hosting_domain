<div class="row">
    ...
    <div class="col-md-9" form-data="student-visa-manager-container"
        data-upload-url="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'storeStudentVisaFile'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'deleteStudentVisaFile'], ['id' => $abroadApplication->id]) }}">
        ...
        <form form-data="student-visa-form" method="POST"
            action="{{ action([App\Http\Controllers\Sales\AbroadController::class, 'updateStudentVisaData'], ['id' => $abroadApplication->id]) }}"
