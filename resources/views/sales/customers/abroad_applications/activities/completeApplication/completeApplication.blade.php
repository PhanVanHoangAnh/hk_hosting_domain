            ...
            @if($abroadApplication->isNewCompleteApplication())
                <div class="col-md-4 d-none">
                    <div class="d-flex justify-content-end align-items-center mt-3 ">
                        <!--begin::Button-->
                        <a href="{{ action(
                            [App\Http\Controllers\Sales\AbroadController::class, 'requestApprovalCompleteApplication'],
                            [
            ...
            @if($abroadApplication->isWaiForApprovalCompleteApplication() && Auth::user()->hasPermission(App\Library\Permission::ABROAD_MANAGE_ALL))
                    <div class="col-md-4 row">
                        <div class=" mt-3 col-6">
                            <!--begin::Button-->
                            <a href="{{ action(
                                [App\Http\Controllers\Sales\AbroadController::class, 'approveCompleteApplication'],
                                [
                                    'id' => $abroadApplication->id,
                                ],
                            ) }}"
                        ...
                        <div class="mt-3 col-6 ">
                            <!--begin::Button-->
                            <a href="{{ action(
                                [App\Http\Controllers\Sales\AbroadController::class, 'rejectCompleteApplication'],
                                [
                                    'id' => $abroadApplication->id,
                                ],
                            ) }}"
