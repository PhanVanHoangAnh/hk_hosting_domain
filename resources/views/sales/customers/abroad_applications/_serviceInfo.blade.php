<div class="d-flex align-items-center mb-3">
    ...
    <a class="d-flex flex-center rotate-n180 ms-3" data-bs-toggle="collapse" class=" px-5 rotate collapsible collapsed" href="#kt_toggle_block_customer" id="show">
        <i class="ki-duotone ki-down fs-3"></i>
    </a>
</div>

<div class="card mb-10 collapse" id="kt_toggle_block_customer">
    <div class="card-body">
        <!--begin::Stats-->
        <div class="  py-5 ">
