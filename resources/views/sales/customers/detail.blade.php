    ...
    <div class="flex-grow-1">
        ...
        <div class="d-flex flex-wrap flex-stack">
            ...
            <div class="d-flex flex-column flex-grow-1 pe-8">
                <!--begin::Stats-->
                <div class="d-flex flex-nowrap d-none">
                    <!--begin::Stat-->
                    <a class="border border-gray-300 border-dashed rounded min-w-125px py-3 me-3 mb-3 profile-stat-box"
                        ...
                        href="{{ action([App\Http\Controllers\Sales\CustomerController::class, 'education'], ['id' => $contact->id]) }}">
                        <!--begin::Header-->
                    ...
                    <a class="border border-gray-300 border-dashed rounded min-w-125px py-3 me-3 mb-3 profile-stat-box"
                        data-action="under-construction"
                        href="{{ action([App\Http\Controllers\Sales\CustomerController::class, 'studyAbroad'], ['id' => $contact->id]) }}">
                        <!--begin::Header-->
                        <div class="card-header pt-5 border-0">
                            <!--begin::Title-->
                            <div class="card-title d-flex flex-column">
                    ...
                    <a class="border border-gray-300 border-dashed rounded min-w-125px py-3 me-3 mb-3 profile-stat-box"
                        data-action="under-construction"
                        href="{{ action([App\Http\Controllers\Sales\CustomerController::class, 'debt'], ['id' => $contact->id]) }}">
                        <!--begin::Header-->
                        <div class="card-header pt-5 border-0">
                            <!--begin::Title-->
                            <div class="card-title d-flex flex-column">
