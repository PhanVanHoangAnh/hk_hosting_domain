                    ...
                    <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 text-nowrap">
                        ...
                        <th list-action="sort" sort-by="payment_date"
                            ...
                            <th  sort-by="industry"
                                ...
                                class="min-w-125px text-left fs-8" data-column="industry">
                                <span class="d-flex align-items-center">
                                    <span>
                                    Dịch vụ
                                    </span>
                            ...
                            <th list-action="sort" sort-by="description"
                                ...
                                class="min-w-125px text-left fs-8 d-none" data-column="description">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Ghi chú
                                    </span>
                            ...
                            <th list-action="sort" sort-by="account_id"
                                ...
                                class="min-w-125px text-left fs-8 d-none" data-column="account_id">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Người tạo
                                    </span>
                            ...
                            <th list-action="sort" sort-by="updated_at"
                                ...
                                class="min-w-125px text-left fs-8 d-none" data-column="updated_at">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Ngày cập nhật
                                    </span>
                            ...
                            <th list-action="sort" sort-by="created_at"
                                ...
                                class="min-w-125px text-left fs-8 d-none" data-column="created_at">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Ngày tạo
                                    </span>
                    ...
                    @foreach ($payments as $payment)
                        <tr list-control="item">
                            ...
                            <td data-filter="mastercard" data-column="payment_date">
                                ...
                                <td data-column="industry" class="text-left mb-1 text-nowrap">
                                    @if ($payment && $payment->orders)
                                ...
                                <td class="text-left d-none" data-filter="mastercard" data-column="description">
                                    {!! $payment->description !!}
                                </td>
                            
                                <td class="text-left d-none" data-filter="mastercard" data-column="account_id">
                                    {{ $payment->account ? $payment->account->name : '--' }}
                                </td>
                            
                                
                            
                                <td data-filter="mastercard " data-column="updated_at" class="d-none">
                                    {{ $payment->updated_at->format('d/m/Y ') }}
                                </td>
                            
                                <td data-filter="mastercard" data-column="created_at" class="d-none">
