<div id="percentage-bar">
    ...
    <div class="mt-3 ">
        ...
        <div class="mb-2 form-label">Cập nhật thành công:<span id="updated-customers-count"
                class="d-none">{{ $updatedCustomersCount }}
            </span>
        </div>

        <div class="mb-2 form-label">Thêm mới thành công: <span id="new-customers-count"
                class="d-none">{{ $newCustomersCount }}
            </span>
        </div>
...
<script>
    ...
    function updatePercentage() {
        ...
        var handlePercentage100 = () => {
            $('#updated-customers-count').removeClass('d-none');
            $('#new-customers-count').removeClass('d-none');
