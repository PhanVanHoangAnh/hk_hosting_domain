...
<div class="card-body pt-0 mt-5">
    @if ($contacts->count())
        <div class="table-responsive table-head-sticky" style="max-height:calc(100vh - 420px);">
            <!--begin::Table-->
            {{-- <table class="table table-striped table-bordered table-hover table-header-fixed dataTable no-footer" id="kt_customers_table"> --}}
                    ...
                    <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 text-nowrap">
                        ...
                        @if (in_array('code', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="code"
                                ...
                                class="min-w-100px fs-8 bg-info" data-column="code">
                        ...
                        @if (in_array('account_id', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="account_id"
                                ...
                                class="min-w-100px fs-8 bg-info" data-column="account_id">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Salesperson
                                    </span>
                        ...
                        @if (in_array('sale_sup', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="sale_sup"
                                class="min-w-100px fs-8 bg-info" data-column="sale_sup">
                                <span class="d-flex align-items-center">
                                    Sales sup
                        ...
                        @endif
                        @if (in_array('gender', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="gender"
                                class="min-w-100px fs-8 bg-info" data-column="gender">
                                <span class="d-flex align-items-center">
                                    Giới tính
                        ...
                        @if (in_array('source_type', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="source_type"
                                class="min-w-100px fs-8 bg-info" data-column="source_type">
                                <span class="d-flex align-items-center">
                                    Nguồn đơn hàng
                        ...
                        @if (in_array('order_type', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="order_type"
                                class="min-w-100px fs-8 bg-info" data-column="order_type">
                                <span class="d-flex align-items-center">
                        ...
                        @if (in_array('order_date', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="order_date"
                                class="min-w-100px fs-8 bg-info" data-column="order_date">
                                <span class="d-flex align-items-center">
                                    Ngày tạo
                        ...
                        @if (in_array('address', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="address"
                                ...
                                class="min-w-200px fs-8" data-column="address">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Địa chỉ học viên
                                    </span>
                        ...
                        @if (in_array('school', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="school"
                                ...
                                class="min-w-200px fs-8" data-column="school">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Trường học của học viên
                                    </span>
                                    <span>
                                        <span>
                                            <span
                        ...
                        @if (in_array('note_log', $columns) || in_array('all', $columns))
                            <th class="min-w-100px fs-8" data-column="note_log">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Ghi chú của liên hệ học viên
                                    </span>

                                </span>
                            </th>
                        @endif
                        @if (in_array('note_log_father', $columns) || in_array('all', $columns))
                            <th class="min-w-100px fs-8" data-column="note_log_father">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Ghi chú của cha
                                    </span>
                        ...
                        @endif
                        @if (in_array('note_log_mother', $columns) || in_array('all', $columns))
                            <th class="min-w-100px fs-8" data-column="note_log_mother">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Ghi chú của mẹ
                                    </span>
                ...
                <tbody class="text-gray-600">
                    @foreach ($contacts as $contact)
                        <tr list-control="item">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex flex-column">
                                            <a href="{{ action(
                                                ...
                                                class="mb-1 fw-bold text-nowrap">{{ $contact->code }}</a>
                                        </div>
                                    </div>
                                </td>
                            @endif
                            ...
                            @if (in_array('account_id', $columns) || in_array('all', $columns))
                                <td data-column="account_id" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                                    {!! $contact->studentOrders->pluck('salesperson.name')->filter()->unique()->implode('<br>') ?? '--' !!}

                                </td>
                            @endif
                            @if (in_array('order_date', $columns) || in_array('all', $columns))
                                <td data-column="order_date" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                                    {{ $contact->studentOrders()->count() ? date('d/m/Y', strtotime($contact->studentOrders->first()->order_date)) : '--' }}
                                </td>
                            @endif
                            @if (in_array('sale_sup', $columns) || in_array('all', $columns))
                                <td data-column="sale_sup" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                                    {!! $contact->studentOrders->pluck('salesperson.accountGroup.manager.name')->filter()->unique()->implode('<br>') ?? '--' !!}
                                  {{-- {{ optional($contact->studentOrders->first())->salesperson->accountGroup->manager->name ?? '--' }} --}}
                                </td>
                            @endif
                            @if (in_array('gender', $columns) || in_array('all', $columns))
                                <td data-column="gender" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                                    {!! $contact->gender ?  trans('messages.contact.gender.' . $contact->gender)  : '--' !!}
                                </td>
                            @endif
                            ...
                            @if (in_array('phone', $columns) || in_array('all', $columns))
                                <td data-column="phone" list-control="phone-inline-edit"
                                    data-url="{{ action('\App\Http\Controllers\Sales\CustomerController@save', [
                                        'id' => $contact->id,
                                    ]) }}"
                                    class="text-nowrap">
                                    <div>
                            ...
                            @if (in_array('father', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="father">
                                    ...
                                    @if ($contact->getFather() && $contact->getFather()->phone)
                                        <div>
                                            (📱 {{ $contact->getFather()->phone }})
                                        </div>
                                    @endif
                                    @if ($contact->getFather() && $contact->getFather()->email)
                                        <div>
                                            (📧 {{ $contact->getFather()->email }})
                                        </div>
                                    @endif
                            </td>
                            @endif
                            @if (in_array('mother', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="mother">
                                    ...
                                    @if ($contact->getMother() && $contact->getMother()->phone)
                                        <div>
                                            (📱 {{ $contact->getMother()->phone }})
                                        </div>
                                    @endif
                                    @if ($contact->getMother() && $contact->getMother()->email)
                                        <div>
                                            (📧 {{ $contact->getMother()->email }})
                                        </div>
                                    @endif
                                </td>
                            @endif
                            @if (in_array('source_type', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="source_type">
                                    ...
                                    {!! $contact->contactRequests()->pluck('source_type')->filter()->unique()->implode('<br>') ?? '--' !!}
                                    {{-- {{ $contactRequest->source_type }} --}}
                                </td>
                            @endif
                            @if (in_array('order_type', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="order_type">
                                    @php
                            ...
                            @if (in_array('demand', $columns) || in_array('all', $columns))
                                <td data-column="demand">
                                    <a href="javascript:;" class="text-hover-primary mb-1">{{ $contact->demand }}</a>
                                </td>
                            @endif
                            ...
                            @if (in_array('school', $columns) || in_array('all', $columns))
                                <td data-column="school">
                                    <a href="javascript:;" class="text-hover-primary mb-1">{{ $contact->school }}</a>
                                </td>
                            @endif
                            @if (in_array('efc', $columns) || in_array('all', $columns))
                                <td data-column="efc">
                            ...
                            @if (in_array('target', $columns) || in_array('all', $columns))
                                <td data-column="target">
                                    <a href="javascript:;" class="text-hover-primary mb-1">{{ $contact->target }}</a>
                                </td>
                            @endif
                            ...
                            @if (in_array('device', $columns) || in_array('all', $columns))
                                <td data-column="device">
                                    <a href="javascript:;" class="text-hover-primary mb-1">{{ $contact->device }}</a>
                                </td>
                            @endif
                            ...
                            @if (in_array('note_log', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" style="width: auto" data-column="note_log">
                                    <div class="d-flex">
                                        ...
                                        <a row-action="note-logs-customer"inline-control="edit-button-lead_status"
                                            href="{{ action(
                                                [App\Http\Controllers\Sales\NoteLogController::class, 'noteLogsPopupForContact'],
                                                [
                                                    'id' => $contact->id,
                                                ],
                                            ) }}">
                            ...
                            @endif
                            @if (in_array('note_log_father', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" style="width: auto" data-column="note_log_father">
                                    <div class="d-flex">
                                        <span class="d-inline-block  text-truncate" style="max-width: 150px;">
                                            <?php
                            ...
                            @endif
                            @if (in_array('note_log_mother', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" style="width: auto" data-column="note_log_mother">
                                    <div class="d-flex">
                                        <span class="d-inline-block  text-truncate" style="max-width: 150px;">
                                            <?php
                            ...
                            <td data-column="action">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a row-action="update"
                                            href="{{ action(
                                                [App\Http\Controllers\Sales\ContactController::class, 'edit'],
                                                [
                                                    'id' => $contact->id,
                                                ],
                                            ) }}"
                                    ...
                                    @if (Auth::user()->can('userAccount', $contact))
                                        <div class="menu-item px-3 ">
                                            <a row-action="account"
                                                href="{{ action(
                                                    [App\Http\Controllers\ContactController::class, 'account'],
                                                    [
                                                        'id' => $contact->id,
                                                    ],
                                                ) }}"
                                    ...
                                    @if (Auth()->user()->can('delete', $contact))
                                        <div class="menu-item px-3">
                                            <a row-action="delete"
                                                href="{{ action(
                                                    [App\Http\Controllers\Sales\CustomerController::class, 'destroy'],
                                                    [
                                                        'id' => $contact->id,
                                                    ],
                                                ) }}"
    ...
    @else
        <div class="py-15">
            ...
            <p class="text-center d-none">
                <a class="btn btn-outline btn-outline-default" id="addCustomerSearch">
                    <span class="d-flex align-items-center">
...
<script>
    $(function() {
        ...
        if (document.getElementById('addCustomerSearch') !== null) {
            AddCustomer.init();
        }
        ...
        // Contact Account
        window.contactAccount = new ContactAccount({
            buttons: $(ContactsList.getList().container).find('[row-action="account"]'),
        });
    });

    var ContactAccount = class {
        constructor(options) {
    ...
    var CustomersIndexList = function() {
        return {
            init: function() {
    ...
    var AddConstract = function() {
        let addConstractBbtns;

        return {
            init: function() {
                addConstractBbtns = document.querySelectorAll('[row-action="add-constract"]');

                addConstractBbtns.forEach(button => {
                    button.addEventListener('click', function(e) {
                        ...
                        $.ajax({
                            ...
                            window.location.href =
                                `sales/orders/create-constract\\${orderIdFromResponse}\\create`;
                        }).fail(response => {})
                    })
                })
            }
    ...
    var AddCustomer = function() {
        return {
            init: function() {
                ...
                // click on create customer button in the empty list
