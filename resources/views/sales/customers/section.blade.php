    ...
    <div class="post" id="kt_post">
        ...
        <div id="SectionsIndexContainer" class="  position-relative" id="kt_post">
            ...
            <div class="card">
                ...
                <!--end::Card header-->
                <div class=" border-0 p-2 d-none list-filter-box pt-0 pb-0" list-action="filter-action-box">
                    <!--begin::Card toolbar-->
                    <div class="card-toolbar mb-0 w-100 d-flex justify-content-center" list-action="tool-action-box">
                        ...
                        <div class="row w-100">
                            ...
                            <div class="col-md-3 mb-5">
                                ...
                                <select list-action="type-filter-select" class="form-select form-control filter-select"
                                    name="type" data-control="select2" data-placeholder="Phân loại"
                                    data-allow-clear="true">
                                    <option value="">Phân loại</option>
                                    @foreach (App\Models\Section::getAllType() as $type)
                                        <option value="{{ $type }}">{{ trans('messages.section.' . $type) }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
        ...
        <script>
            ...
            let SectionList = function() {
                ...
                return {
                    init: () => {
                        list = new DataList({
                            url: "{{ action('App\Http\Controllers\Sales\CustomerController@sectionList', ['id' => $contact->id]) }}",
            ...
            const FilterData = function() {
                ...
                const getTypeValues = () => {
                    types = Array.from(document.querySelector('[list-action="type-filter-select"]').selectedOptions)
                        .map(option => option.value).filter(function(value) {
                ...
                return {
                    init: () => {
                        ...
                        $('.filter-select').on('change', () => {
                            ...
                            SectionList.getList().setTeachers(teachers);
                        ...
                        $('.filter-select').on('change', () => {
                            ...
                            SectionList.getList().setSubjects(subjects);
                            SectionList.getList().load();
                        });
                        ...
                        $('[list-action="created_at-select"]').on('change', function() {
                            ...
                            SectionList.getList().setCreatedAtFrom(fromDate);
                            SectionList.getList().setCreatedAtTo(toDate);
                            SectionList.getList().load();
                        });
                        ...
                        $('[list-action="updated_at-select"]').on('change', function() {
                            ...
                            SectionList.getList().setUpdatedAtFrom(fromDate);
                            SectionList.getList().setUpdatedAtTo(toDate);
                            SectionList.getList().load();
                        });
            ...
            let DataList = class {
                ...
                getDeleteReportButtons() {
                    return this.listContent.querySelectorAll('[row-action="delete-report"]');
                };
                ...
                initContentEvents() {
                    ...
                    if (this.getListItemsCount()) {
                        ...
                        this.getDeleteReportButtons().forEach(button => {
                            button.addEventListener('click', (e) => {
                                e.preventDefault();
                                ...
                                this.deleteReport(url, section_id, contact_id);
                            });
                        });
                ...
                deleteReport(url, section_id, contact_id) {
