...
@section('content')
    ...
    <div id="kt_post" class="position-relative">
        ...
        <!--end::Navbar-->
        <!--begin::details View-->
        <div class="card" id="PaymentsIndexContainer">
            <!--begin::Card header-->
                ...
                <div class="card-title" list-action="search-action-box">
                    <div id="search-form" class="d-flex align-items-center position-relative my-1">
                        ...
                        <input list-action="keyword-input" type="text" data-kt-note-log-table-filter="search"
                            class="form-control w-250px ps-12" placeholder="Nhập để tìm phiếu thu " />
                    </div>
                    <!--begin::Search-->
        ...
        <div id="PaymentsIndexListContent">
    ...
    <script>
        $(() => {
            PaymentsFeatureIndex.init();
        });
        
        const PaymentsFeatureIndex = function() {
        ...
        let PaymentList = function() {
            ...
            return {
                init: () => {
                    ...
                    list = new DataList({
                        url: "{{ action('App\Http\Controllers\Sales\CustomerController@paymentList', ['id' => $contact->id]) }}",
                        container: document.querySelector("#PaymentsIndexContainer"),
                        listContent: document.querySelector("#PaymentsIndexListContent")
                });
        ...
        let DeletePaymentPopup = function() {
            let popup;
                ...
                return {
                    init: () => {
                        $('.filter-select').on('change', () => {
                            ...
                            PaymentList.getList().setIndustries(industries);
                            PaymentList.getList().setContact(contact);
                            PaymentList.getList().setPaymentTypes(orderTypes);
                            PaymentList.getList().setTypes(types);
                            PaymentList.getList().setSales(sales);
                            PaymentList.getList().setSaleSups(saleSups);
                            PaymentList.getList().load();
                        });
                        ...
                        $('[list-action="created_at-select"]').on('change', function() {
                            ...
                            PaymentList.getList().setCreatedAtFrom(fromDate);
                            PaymentList.getList().setCreatedAtTo(toDate);
                            PaymentList.getList().load();
                        });
                        ...
                        $('[list-action="updated_at-select"]').on('change', function() {
                            ...
                            PaymentList.getList().setUpdatedAtFrom(fromDate);
                            PaymentList.getList().setUpdatedAtTo(toDate);
                            PaymentList.getList().load();
                        });
                    ...
                    if (this.getNumberOfItems()) {
                        ...
                        this.getUpdateBtns().forEach(button => {
                            button.addEventListener("click", function(e) {
                                ...
                                const currentPaymentId = this.getAttribute("data-ids");
    
                                _this.addLoadEffect();
    
                                window.location.href = `sales/orders/create-constract\\${currentPaymentId}\\update`;
                            })
                        });
                         ...
                         */
                         this.getShowConstractBtns().forEach(button => {
                            button.addEventListener('click', function(e) {
                                ...
                                ShowPaymentPopup.updateUrl(url);
                            });
                        });
                    };
                };
                ...
                load() {
                    ...
                    this.listXhr = $.ajax({
                        ...
                        data: {
                            ...
                            orderTypes: this.getPaymentTypes(),
                            types: this.getTypes(),
                            sales: this.getSales(),
