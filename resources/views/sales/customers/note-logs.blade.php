                        ...
                        {{-- <div class="col-md-3 mb-5 ">
                            ...
                            <div>
                                <select list-action="customer-select" class="form-select" data-control="select2"
                                    data-placeholder="Chọn học viên/liên hệ" data-allow-clear="true" multiple>
            ...
            return {
                init: () => {
                    ...
                    noteList = new DataList({
                        ...
                        url: "{{ action('App\Http\Controllers\Sales\CustomerController@noteLogList', ['id' => $contact->id]) }}",
