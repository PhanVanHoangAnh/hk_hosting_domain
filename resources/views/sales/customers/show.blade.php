        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-body p-9" id="ContactsInformation">
                ...
                <div class="row mb-7">
                    ...
                    <label class="col-lg-1 text-muted">Email
                ...
                <div class="row mb-7">
                    ...
                    <label class="col-lg-1 text-muted">Cha</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-2">
                    ...
                    <label class="col-lg-1 text-muted">Số điện thoại</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-3">
                        <span class="fs-6 text-gray-800 me-2">
                            {{ $contact->getFather() ? $contact->getFather()->phone : '--' }}
                        </span>
                    </div>
                    <!--end::Col-->
                    ...
                    <div class="col-lg-3">
                        <span class="fs-6 text-gray-800 me-2">
                            {{ $contact->getFather() ? $contact->getFather()->email : '--' }}
                        </span>
                    </div>
                    <!--end::Col-->
                </div>
                ...
                <div class="row mb-7">
                    ...
                    <label class="col-lg-1 text-muted">Mẹ</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-2">
                        <span class="fs-6 text-gray-800 me-2">
                    ...
                    <div class="col-lg-3">
                        <span class="fs-6 text-gray-800 me-2">
                            {{ $contact->getMother() ? $contact->getMother()->phone : '--' }}
                        </span>
                    </div>
                    <!--end::Col-->
                    <label class="col-lg-1 text-muted">Email</label>
                    ...
                    <div class="col-lg-3">
                        <span class="fs-6 text-gray-800 me-2">
                            {{ $contact->getMother() ? $contact->getMother()->email : '--' }}
                        </span>
                    </div>
                    <!--end::Col-->
                </div>
    ...
    <script>
        ...
        var DeleteCustomer = function () {
            ...
            const handleDelete = () => {
                buttonDeleteCustom.addEventListener('click', (e) => {
                    e.preventDefault();
                    const customerId = buttonDeleteCustom.getAttribute('data-customer-id');
                        ...
                        ok: () => {
                            ...
                            $.ajax({
                                ...
                                ASTool.alert({
                                    ...
                                    ok: () => {
                                        window.location.href = "{{ action('\App\Http\Controllers\Sales\CustomerController@index') }}";
                                    }
                                });
                            }).fail(() => {
                                // Handle failure
        ...
        var ContactsList = function() {
            ...
            return {
                init: function() {
                    list = new DataList({
                        url: "{{ action('App\Http\Controllers\Sales\CustomerController@show', ['id' => $contact->id]) }}",
