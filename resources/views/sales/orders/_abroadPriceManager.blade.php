<h3 class="mt-10 mb-5 fs-2 text-primary {{ $order && $order->type == \App\Models\Order::TYPE_REQUEST_DEMO ? 'd-none' : '' }}">Giá hợp đồng</h3>
<div data-container="abroad-price-manager">
    <div class="row mb-4">
        <div class="col-12 col-md-4">
            <div class="form-outline">
                <label class="required fs-6 fw-semibold mb-2" for="price-after-discount">Giá bán</label>
                <input id="price-create-input"
                       type="text" 
                       class="form-control cursor-pointer"
                       readonly data-bs-toggle="tooltip" 
                       data-bs-placement="top" data-bs-html="true"
                       title='Giá trị hợp đồng bằng tổng giá trị các dịch vụ của hợp đồng!' 
                       value="{{ isset($order) ? number_format($order->getPriceBeforeDiscount(), 0, '.', ',') : 0 }}">
            </div>
        </div>
                            ...
                            <script>
                               ...
                               var PercentInput = class {
                                   ...
                                   init() {
                                       ...
                                       this.mask = new IMask(_this.self()[0], {
                                           mask: Number,
                                           scale: 0,
                                           thousandsSeparator: ',',
                                   ...
                                   events() {
                                       ...
                                       _this.self().on('change', e => {
                                           e.preventDefault();

                                           _this.mask.updateValue(e.target.value);
                                       })
                                   }
                               }
                           </script>
        ...
        <div class="col-lg-4 col-md-4 col-sm-10 col-10 mb-2">
            <div class="form-outline">
                ...
                <input id="price-after-discount" 
                       type="text" 
                       data-action="markup-price" 
                       class="form-control border-0 bg-light-info ps-0 fs-2 text-end fw-semibold"
                       name="price"
                       readonly
                       value="{{ isset($order) ? number_format($order->getTotal(), 0, '.', ',') : 0 }}">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                                <div class="form-outline">
                                    <label class="required fs-6 fw-semibold mb-2"
                                        for="schedule-price-input">Giá hợp đồng</label>
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                                        <div class="form-outline">
                                            <div id="balance-form"
                                                class="form-control border-0 bg-light-info ps-0 fs-4 text-end fw-semibold">
                                                0</div>
                                        </div>
                                    </div>
                                </div>

                                <label id="error-balance-schedule" class="fs-7 fw-semibold mb-2 text-danger text-center w-100 d-none"></label>
                            </div>
...
<script>
    $(() => {
        abroadPriceManager = new PriceManager({
            container: document.querySelector('[data-container="abroad-price-manager"]'),
