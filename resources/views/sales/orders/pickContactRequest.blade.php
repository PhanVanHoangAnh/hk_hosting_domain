                        ...
                        @if (Auth::user()->can('create', App\Models\ContactRequest::class))
                            ...
                            <script>
                                ...
                                var AddContactRequestBtn = class {
                                    ...
                                    getUrl() {
                                        return "{!! action([\App\Http\Controllers\Sales\ContactRequestController::class, 'create'], ['contact_id' => isset($contactIds) && $contactIds ? $contactIds[0] : null, 'orderType' => isset($orderType) ? $orderType : null]) !!}";
                                    }
                                ...
                                <td>
                                    ...
                                    @else
                                        <div><a class="fw-semibold text-info"
                                            data-bs-toggle="tooltip" data-bs-trigger="hover" title="Nhấn để chỉnh sửa hợp đồng này"
                                            href="{{ action([App\Http\Controllers\Sales\OrderController::class, 'showFormCreateConstract'], [
                                                'orderId' => $request->getOrder()->id,
                                                'actionType' => 'update',
                                            ]) }}">{{ $request->getOrder()->code }}</a>
                                        </div>
