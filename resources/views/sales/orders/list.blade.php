<!--begin::Card body-->
<div class="card-body pt-0 mt-5" id="sales-order-list">
    @if ($orders->count())
        <div id="order-table-box" class="table-responsive table-head-sticky freeze-column" style="max-height:calc(100vh - 420px);">
            <!--begin::Table-->
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="dtHorizontalVerticalOrder">
                <thead>
                    <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 bg-light text-nowrap">
                        ...
                        @endif
                        @if (in_array('contact_code', $columns) || in_array('all', $columns))
                            <th 
                                class="min-w-125px text-left" data-column="contact_code">
                                <span class="d-flex align-items-center">
                                    <span>
                                        {{ trans('messages.contact.code') }}
                                    </span>
                                   
                                </span>
                            </th>
                        @endif
                        @if (in_array('fullname', $columns) || in_array('fullname', $columns))
                            <th list-action="sort" sort-by="contacts.name" 
                                sort-direction="{{ $sortColumn == 'contacts.name' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-125px text-left" data-column="fullname">
                                <span class="d-flex align-items-center">
                                    <span>
                                    ...
                                    <span>
                                        <span>
                                            <span
                                                class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'fullname' ? '' : 'text-muted' }}">
                                                sort
                                            </span>
                                        </span>
                                    </span>
                        ...
                        @endif
                        @if (in_array('is_pay_all', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="is_pay_all"
                                sort-direction="{{ $sortColumn == 'is_pay_all' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-125px text-left" data-column="is_pay_all">
                                <span class="d-flex align-items-center">
                                    <span>
                                        {{ trans('messages.order.is_pay_all') }}
                                    </span>
                                    <span>
                                        <span>
                                            <span
                                                class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'is_pay_all' ? '' : 'text-muted' }}">
                                                sort
                                            </span>
                                        </span>
                                    </span>
                        ...
                        @endif
                        @if (in_array('payment_status', $columns) || in_array('all', $columns))
                            <th  sort-by="payment_status"
                                sort-direction="{{ $sortColumn == 'payment_status' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-125px text-left" data-column="payment_status">
                                <span class="d-flex align-items-center">
                                    <span>
                                        {{ trans('messages.order.payment_status') }}
                                    </span>
                        ...
                        @if (in_array('code_student', $columns) || in_array('all', $columns))
                            <th 
                                ...
                                <span class="d-flex align-items-center">
                                    <span>
                                        {{ trans('messages.order.student_code') }}
                                    </span>
                        ...
                        @if (in_array('student', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="contacts.name" data-control="freeze-column"
                                sort-direction="{{ $sortColumn == 'contacts.name' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-125px text-left bg-info" data-column="student">
                                <span class="d-flex align-items-center">
                                    <span>
                                        {{ trans('messages.order.student') }}
                                    </span>
                                    <span>
                                        <span>
                                            <span
                        ...
                        @if (in_array('id', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="id"
                                ...
                                class="min-w-125px text-left" data-column="id">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Số
                                    </span>
                        ...
                        @if (in_array('paid_amount', $columns) || in_array('all', $columns))
                            <th sort-by="paid_amount"
                                sort-direction="{{ $sortColumn == 'paid_amount' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-125px text-left" data-column="paid_amount">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Đã thanh toán
                                    </span>
                        ...
                        @if (in_array('remain_amount', $columns) || in_array('all', $columns))
                            <th sort-by="remain_amount"
                                sort-direction="{{ $sortColumn == 'remain_amount' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-125px text-left" data-column="remain_amount">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Còn lại
                                    </span>
                        ...
                        @if (in_array('sale', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="sale"
                                sort-direction="{{ $sortColumn == 'sale' && $sortDirection ? $sortDirection : 'desc' }}"
                                ...
                                <span class="d-flex align-items-center">
                                    ...
                                    <span>
                                        <span>
                                            <span
                                                class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'sale' ? '' : 'text-muted' }}">
                                                sort
                                            </span>
                                        </span>
                                    </span>
                        ...
                        @endif
                        @if (in_array('sale_sup', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="sale_sup"
                                sort-direction="{{ $sortColumn == 'sale_sup' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-125px text-left" data-column="sale_sup">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Sale sup
                                    </span>
                                    <span>
                                        <span>
                                            <span
                                                class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'sale_sup' ? '' : 'text-muted' }}">
                                                sort
                                            </span>
                                        </span>
                                    </span>
                        ...
                        @endif
                        @if (in_array('current_school', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="current_school"
                                sort-direction="{{ $sortColumn == 'current_school' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-125px text-left" data-column="current_school">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Trường đang học
                                    </span>
                                    <span>
                                        <span>
                                            <span
                                                class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'current_school' ? '' : 'text-muted' }}">
                                                sort
                                            </span>
                                        </span>
                                    </span>
                        ...
                        @if (in_array('parent_note', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="parent_note"
                                sort-direction="{{ $sortColumn == 'parent_note' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-125px text-left" data-column="parent_note">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Ghi chú của sale
                                    </span>
                                    <span>
                                        <span>
                                            <span
                                                class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'parent_note' ? '' : 'text-muted' }}">
                                                sort
                                            </span>
                                        </span>
                                    </span>
                        ...
                        @if (in_array('industry', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="industry"
                                sort-direction="{{ $sortColumn == 'industry' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-125px text-left" data-column="industry">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Loại dịch vụ
                                    </span>
                                    <span>
                                        <span>
                                            <span
                                                class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'industry' ? '' : 'text-muted' }}">
                                                sort
                                            </span>
                                        </span>
                                    </span>
                        ...
                        @endif
                        @if (in_array('rejected_reason', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="rejected_reason"
                                sort-direction="{{ $sortColumn == 'rejected_reason' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-125px text-left" data-column="rejected_reason">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Lý do từ chối
                                    </span>
                                    <span>
                                        <span>
                                            <span
                                                class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'rejected_reason' ? '' : 'text-muted' }}">
                                                sort
                                            </span>
                                        </span>
                                    </span>
                        ...
                        <tr list-control="item">
                            <td class="text-left ps-1">
                                <div class="form-check form-check-sm form-check-custom">
                                    <input data-item-id="{{ $order->id }}" list-action="check-item" class="form-check-input" type="checkbox"
                                        value="1" />
                                </div>
                            </td>
                            @if (in_array('code', $columns) || in_array('all', $columns))
                                <td data-column="code" class="text-left mb-1 text-nowrap"
                            ...
                            @endif
                            @if (in_array('is_pay_all', $columns) || in_array('all', $columns))
                                <td data-column="is_pay_all" class="text-left mb-1 text-nowrap"
                                    data-filter="mastercard">
                            ...
                            @endif
                            @if (in_array('payment_status', $columns) || in_array('all', $columns))
                                <td data-column="payment_status" class="text-left" data-filter="mastercard">
                                    @php
                                        $bgs = [
                                            App\Models\PaymentReminder::STATUS_PART_PAID => 'secondary',
                                            App\Models\PaymentReminder::STATUS_PAID => 'success',
                                            App\Models\PaymentReminder::STATUS_UNPAID => 'danger text-white',
                                        ];
                                    @endphp
                                    
                                        <span class="badge bg-{{ $bgs[$order->getPaymentStatus()] ?? 'info text-white' }}"
                                            data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                            data-bs-placement="right">
                                            {{ trans('messages.payment_reminders.status.' . $order->getPaymentStatus()) }}
                                        </span>
                                </td>
                            @endif
                            @if (in_array('contact_code', $columns) || in_array('all', $columns))
                                <td data-column="contact_code" class="text-left mb-1 text-nowrap"
                                    data-filter="mastercard">
                                    {{ $order->contacts->code }}
                                </td>
                            @endif
                            @if (in_array('fullname', $columns) || in_array('all', $columns))
                                <td data-column="fullname" class="text-left mb-1 text-nowrap"
                                    data-filter="mastercard">
                                    {{ $order->contacts->name }}
                                </td>
                            @endif
                            @if (in_array('code_student', $columns) || in_array('all', $columns))
                                <td data-column="code_student" class="text-left mb-1 text-nowrap"
                                    data-filter="mastercard">
                                    {{ $order->student->code }}
                                </td>
                            @endif
                            @if (in_array('student', $columns) || in_array('all', $columns))
                                <td data-column="student" class="text-left mb-1 text-nowrap" data-control="freeze-column"
                                    data-filter="mastercard">
                                    {{ $order->student ? $order->student->name : '--' }}
                                </td>
                            @endif
                            @if (in_array('id', $columns) || in_array('all', $columns))
                                <td data-column="id" class="text-left" data-filter="mastercard">
                                    {{ $order->id }}
                                </td>
                            @endif
                            @if (in_array('phone', $columns) || in_array('all', $columns))
                                <td data-column="phone" class="text-left" data-filter="mastercard">
                                    {{ $order->contacts->phone }}
                                </td>
                            @endif
                            @if (in_array('email', $columns) || in_array('all', $columns))
                                <td data-column="email" class="text-left" data-filter="mastercard">
                                    {{ $order->contacts->email }}
                                </td>
                            @endif
                            @if (in_array('price', $columns) || in_array('all', $columns))
                                <td data-column="price" class="text-left" data-filter="mastercard">
                                    {{ number_format($order->getTotal(), 0, '.', ',') }}₫
                                </td>
                            @endif
                            @if (in_array('paid_amount', $columns) || in_array('all', $columns))
                                <td data-column="paid_amount" class="text-left" data-filter="mastercard">
                                    {{ App\Helpers\Functions::formatNumber($order->sumAmountPaid()) }}₫
                                </td>
                            @endif
                            @if (in_array('remain_amount', $columns) || in_array('all', $columns))
                                <td data-column="remain_amount" class="text-left" data-filter="mastercard">
                                      {{App\Helpers\Functions::formatNumber(max($order->getTotal() - $order->sumAmountPaid(), 0), 0, '.', ',') }}₫
                                </td>
                            @endif
                            @if (in_array('order_date', $columns) || in_array('all', $columns))
                                <td data-column="order_date" class="text-left" data-filter="mastercard">
                            ...
                            @endif
                            @if (in_array('sale', $columns) || in_array('all', $columns))
                                <td data-column="sale" class="text-left" data-filter="mastercard">
                                    {{ App\Models\Account::find($order->sale) ? App\Models\Account::find($order->sale)->name : '' }}
                                </td>
                            @endif
                            @if (in_array('sale_sup', $columns) || in_array('all', $columns))
                                <td data-column="sale_sup" class="text-left" data-filter="mastercard">
                                    {{ App\Models\Account::find($order->sale_sup) ? App\Models\Account::find($order->sale_sup)->name : '' }}
                                </td>
                            @endif
                            @if (in_array('current_school', $columns) || in_array('all', $columns))
                                <td data-column="current_school" class="text-left" data-filter="mastercard">
                                    {{ $order->current_school }}
                                </td>
                            @endif
                            @if (in_array('parent_note', $columns) || in_array('all', $columns))
                                <td data-column="parent_note" class="text-left" data-filter="mastercard">
                                    {{ $order->parent_note }}
                                </td>
                            @endif
                            @if (in_array('industry', $columns) || in_array('all', $columns))
                                <td data-column="industry" class="text-left" data-filter="mastercard">
                                    {{ $order->industry }}
                                </td>
                            @endif
                            @if (in_array('status', $columns) || in_array('all', $columns))
                                <td data-column="status" class="text-left" data-filter="mastercard">
                                    @php
                                        $bgs = [
                                            ...
                                            App\Models\Order::STATUS_DELETED => 'light',
                                        ];
                                    @endphp 
                                    <a row-action="show" class="menu-link px-3"
                                        href="{{ action(
                                            [App\Http\Controllers\Sales\OrderController::class, 'historyRejected'],
                                            [
                                                'id' => $order->id,
                                            ]
                                        ) }}">
                                        @if ($order->isRejected())
                                            <span title="Xem chi tiết"
                                                class="badge bg-{{ $bgs[$order->status] ?? 'info' }}"
                                                data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                                data-bs-placement="right">
                            ...
                            @endif
                            @if (in_array('rejected_reason', $columns) || in_array('all', $columns))
                            <td data-column="rejected_reason" class="text-left" data-filter="mastercard">
                            ...
                            <td class="text-left">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ action(
                                            [App\Http\Controllers\Sales\OrderController::class, 'showConstract'],
                                            [
                                                'id' => $order->id,
                                            ],
                                        ) }}"
                                            row-action="show" class="menu-link px-3">Xem chi tiết</a>
                                    </div>
                                    @if ($order->status == App\Models\Order::STATUS_APPROVED && $order->type != App\Models\Order::TYPE_REQUEST_DEMO && $order->getRemainAmount()>0)
                                        <div class="menu-item px-3">
                                            <a href="{{ $order->getTotal() - $order->sumAmountPaid() > 0
                                                ? action(
                                                    [App\Http\Controllers\Sales\PaymentRecordController::class, 'createReceiptContact'],
                                                    ['id' => $order->id],
                                                )
                                                : 'javascript:void(0)' }}"
                                                row-action="show"
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                data-action='check-status' class="menu-link px-3 "
                                                data-cache-total="{{ $order->getTotal() }}"
                                                data-sum-amount-paid="{{ $order->sumAmountPaid() }}"
                                                title="{{ $order->getTotal() - $order->sumAmountPaid() < 1 ? 'Đã thanh toán' : '' }}">
                                                Tạo phiếu thu</a>
                                        </div>
                                    @endif
                                    @if (Auth::user()->can('requestApproval', $order))
                                        @if ($order->canRequestApprove())
                                            <div class="menu-item px-3">
                                                <a row-action="request-approval"
                                                    href="{{ action(
                                                        [App\Http\Controllers\Sales\OrderController::class, 'requestApproval'],
                                                        [
                                                            'id' => $order->id,
                                                        ],
                                                    ) }}"
                                                    class="menu-link px-3">Xác nhận & Yêu cầu duyệt</a>
                                            </div>
                                        @endif
                                    @endif
                                    
                                    @if (Auth::user()->can('confirmRequestDemo', $order))
                                        @if ($order->orderItems->count())
                                            <div class="menu-item px-3">
                                                <a row-action="confirm-request-demo"
                                                    href="{{ action(
                                                        [App\Http\Controllers\Sales\OrderController::class, 'confirmRequestDemo'],
                                                        [
                                                            'id' => $order->id,
                                                        ],
                                                    ) }}"
                                                    class="menu-link px-3">Xác nhận hoàn thành</a>
                                            </div>
                                        @endif
                                    @endif
                                    @if ($order->isApproved() && !$order->isRequestDemo())
                                        <div class="menu-item px-3">
                                            <a row-action="show"
                                                href="{{ action(
                                                    [App\Http\Controllers\Sales\OrderController::class, 'showQrCode'],
                                                    [
                                                        'id' => $order->id,
                                                    ]
                                                ) }}"
                                               class="menu-link px-3">Lấy mã thanh toán</a>
                                        </div>
                                    @endif
                                    @if ($order->isApproved() && ($order->isEdu() || $order->isAbroad()))
                                        <div class="menu-item px-3">
                                            <a row-action="show"
                                                href="{{ action(
                                                    [App\Http\Controllers\Sales\OnePayController::class, 'createReceipt'],
                                                    [
                                                        'id' => $order->id,
                                                    ]
                                                ) }}"
                                            class="menu-link px-3">Thanh toán OnePay</a>
                                        </div>
                                    @endif
                                    ...
                                    @if (Auth::user()->can('update', $order))
                                        <div class="menu-item px-3">
                                            <a data-ids="{{ $order->id }}" row-action="update"
                                                href="javascript:;" class="menu-link px-3">Chỉnh sửa</a>
                                        </div>
                                    @endif

                                    <!--begin::Menu item-->
                                    @if (Auth::user()->can('copy', $order))
                                        <div class="menu-item px-3">
                                            <a data-ids="{{ $order->id }}" row-action="copy"
                                                @if ($order->isRequestDemo())
                                                    href="{{ action('\App\Http\Controllers\Sales\OrderController@pickContactForRequestDemo', [
                                                        'copy_from_order_id' => $order->id,
                                                    ]) }}"
                                                @else
                                                    href="{{ action('\App\Http\Controllers\Sales\OrderController@pickContact', [
                                                        'copy_from_order_id' => $order->id,
                                                    ]) }}"
                                                @endif
                                                
                                                class="menu-link px-3">Sao chép</a>
                                        </div>
                                    @endif

                                    @if (Auth::user()->can('delete', $order))
                                        <div class="menu-item px-3">
                                            <a data-ids-delete="{{ $order->id }}"
                                                href="{{ action(
                                                    [App\Http\Controllers\Sales\OrderController::class, 'delete'],
                                                    [
                                                        'id' => $order->id,
                                                    ],
                                                ) }}"
    ...
    @else
        <div class="py-15">
            ...
            <p class="fs-4 text-center mb-5">
                Chưa có {{ $screenType === App\Models\Order::TYPE_REQUEST_DEMO ? 'yêu cầu học thử' : 'hợp đồng' }} nào!
            </p>
            <p class="text-center">
                <a list-action="create-constract" href="javascript:;" id="buttonCreateNewOrder"
                    class="btn btn-outline btn-outline-default">
                    <span class="material-symbols-rounded me-2">
                        add
                    </span>
                    Thêm mới {{ $screenType === App\Models\Order::TYPE_REQUEST_DEMO ? 'yêu cầu học thử' : 'hợp đồng' }}
                </a>
            </p>
        </div>
        <script>
            GENERAL_CONTROLLER_METHOD = `{{ action('\App\Http\Controllers\Sales\OrderController@pickContact') }}`;
            REQUEST_DEMO_CONTROLLER_METHOD = `{{ action('\App\Http\Controllers\Sales\OrderController@pickContactForRequestDemo') }}`;

            $(() => {
                let orderListWhenNoExistingManager = new OrderListWhenNoExistingManager({
                    container: document.querySelector('#sales-order-list')
                })
            });

            var OrderListWhenNoExistingManager = class {
                constructor(options) {
                    this.container = options.container;
                    this.controllerMethod = "{!! $screenType !!}" === "{!! App\Models\Order::TYPE_REQUEST_DEMO !!}" ? REQUEST_DEMO_CONTROLLER_METHOD : GENERAL_CONTROLLER_METHOD;
                    
                    this.events();
                };

                getCreateOrderButton() {
                    return this.container.querySelector('#buttonCreateNewOrder');
                };

                events() {
                    this.getCreateOrderButton().addEventListener('click', e => {
                        pickContactPopup.updateUrl(this.controllerMethod);
                    });
                };
            };
        </script>
    ...
    <script>
        $(() => {
            ...
            ConfirmRequestDemo.init();

            //
            new CopyOrder({
                links: $('[row-action="copy"]')
            });
        });
        ...
        var CopyOrder = class {
            ...
            events() {
                this.links.on('click', function(e) {
                    ...
                    pickContactPopup.updateUrl($(this).attr('href'));
                });
            }
        }

        var HorizonScrollFix = function() {
            let orderBox = $('#order-table-box');
            ...
            let applyScroll = () => {
                orderBox.scrollLeft(window.ordersListScrollFromLeft);
            }
        ...
        var RequestApproval = function() {
            ...
            return {
                init: function() {
                    ...
                    links = list.container.querySelectorAll('[row-action="request-approval"]');
                    ...
                    links.forEach(link => {
                        link.addEventListener('click', e => {
                            ...
                            ASTool.confirm({
                                message: 'Bạn đã hoàn tất thông tin hợp đồng và yêu cầu duyệt? Một khi yêu cầu được gửi đi bạn không thể chỉnh sửa nội dung hợp đồng được nữa.',
                                ok: function() {
                                    request(url);
                                }
                            });
        ...
        //
        var ConfirmRequestDemo = function() {
            var list;
            var links;
            ...
            return {
                init: function() {
                    list = OrderList.getList();
                    links = list.container.querySelectorAll('[row-action="confirm-request-demo"]');
                    ...
                    links.forEach(link => {
                        link.addEventListener('click', e => {
                            ...
                            ASTool.confirm({
                                message: 'Bạn đã hoàn tất thông tin yêu cầu học thử và xác nhận? Một khi xác nhận bạn không thể chỉnh sửa nội dung yêu cầu được nữa.',
                                ok: function() {
                                    request(url);
                                }
                            });
