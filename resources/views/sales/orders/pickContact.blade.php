...
@section('content')
<form id="{{ $formId }}" method="POST" action="{{ action('\App\Http\Controllers\Sales\OrderController@createConstract') }}">
    @csrf
    ...
    <div class="mt-10">
        ...
        <div class="row w-100 px-15 mx-auto d-flex justify-content-around mb-10">
            <div class="col-12">
                @include('sales.orders._contact_form', [
                    'formId' => $formId,
        ...
        return {
            init: () => {
                ...
                form.addEventListener('submit', e => {
                    ...
                    addSubmitEffect();
                        $.ajax({
                            url: "{{ action('\App\Http\Controllers\Sales\OrderController@createConstract') }}",
                            method: 'POST',
                            data: data
                        }).done(response => {
