                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a row-action="delete-all" href="{{ action([App\Http\Controllers\Sales\OrderController::class, 'deleteAll']) }}"
                ...
                <div class="card-toolbar w-100 mb-0" list-action="tool-action-box">
                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-md-3 mb-5">
                            ...
                            <div class="row" list-action="created_at-select">
                                    <div class="form-outline">
                                        <select id="order-filter-student-select" data-control="select2-ajax" data-url="{{ action('App\Http\Controllers\Sales\ContactController@select2') }}" class="form-control filter-select"
    ...
    let OrderList = function() {
        ...
        return {
            init: () => {
                ...
                list = new DataList({
                url: `{{ action('\App\Http\Controllers\Sales\OrderController@list', ['screenType' => '']) }}${screenType}`,
            ...
            init: () => {
                createOrderBtns.forEach(btn => {
                    btn.addEventListener('click', e => {
                        ...
                        pickContactPopup.updateUrl("{{ action('\App\Http\Controllers\Sales\OrderController@pickContact') }}");
                    });
                });
            ...
            return {
                init: () => {
                    ...
                    $('[list-action="export-excel"]').on('click', function() {
                        ...
                        $.ajax({
                            url: "{{ action('\App\Http\Controllers\Sales\OrderController@export') }}",
                            type: "GET",
                            data: query,
                            xhrFields: {
                                responseType: 'blob' 
