...
@section('content')
    <form id="UpdateNoteLogForm" enctype="multipart/form-data">
        ...
        <div class="scroll-y pe-7  py-5 px-lg-17" >
            ...
            <div data-control="date-with-clear-button" class="d-flex align-items-center date-with-clear-button mb-5 " >       
                <input data-control="input" name="reminder"
                    placeholder="=asas" type="datetime-local" class="form-control"
                    placeholder="" value="{{  $noteLog->contactRequest ?  $noteLog->contactRequest->reminder : '' }}" />
