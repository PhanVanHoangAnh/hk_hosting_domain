...
@section('content')
    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Báo cáo tiến độ thanh toán theo hợp đồng</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Tiến độ thanh toán theo hợp đồng</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
        ...
        <div class="d-flex align-items-center py-1">
            ...
            <div class="me-3" list-action="export-contact" >
                <a type="button" 
                    href="{{ action([\App\Http\Controllers\Sales\Report\PaymentReportController::class, 'showFilterForm']) }}"
    ...
    <div id="PaymentReportIndexContainer" class="position-relative" id="kt_post">
        <!--begin::Card-->
        <div class="card ">
            <!--begin::Card header-->
        ...
        <!--end::Card header-->
        <div id="PaymentReportIndexListContent">
        </div>
    </div>
    <script>
        $(function() {
            PaymentReportIndex.init();
        });
        //
        var PaymentReportIndex = function() {
            return {
                init: function() {
                    PaymentReportList.init();
                    //
                    FilterData.init();
                    //
                    ExportExcel.init();
            ...
            return {
                init: function() {
                    ...
                    popupExcelContactStatusReport = new Popup({
                        url: "{{ action('\App\Http\Controllers\Sales\Report\PaymentReportController@showFilterForm') }}",
                    });
            ...
            return {
                init: () => {
                    ...
                    function applyDateFilter() {
                        ...
                        // Gửi phạm vi ngày tạo đến PaymentReportList và tải lại danh sách
                        PaymentReportList.getList().setCreatedAtFrom(fromDate);
                        PaymentReportList.getList().setCreatedAtTo(toDate);
                        PaymentReportList.getList().load();
                    };
                }
            };
        }();
        ...
        //
        var PaymentReportList = function() {
            var list;
            return {
                init: function() {
                    list = new DataList({
                        url: "{{ action('App\Http\Controllers\Sales\Report\PaymentReportController@list') }}",
                        container: document.querySelector('#PaymentReportIndexContainer'),
                        listContent: document.querySelector('#PaymentReportIndexListContent'),
                    });
                    list.load();
                },
                getList: function() {
