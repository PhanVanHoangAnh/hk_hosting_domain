...
@section('content')
    <form id="filterContactForm" action="{{ action('App\Http\Controllers\Sales\Report\UpsellReportController@exportRun') }}"
        method="POST">
        @csrf
    ...
    <script>
        $(document).ready(function() {
             ...
             $('#exportContactFilterButton').click(function(event) {
                 ...
                 $.ajax({
                     url: "{{ action('App\Http\Controllers\Sales\Report\UpsellReportController@exportRun') }}",
                     type: 'POST',
                     data: formData,
                     beforeSend: function() {
                     ...
                     success: function(response) {
                         // Download the file
                         window.location = "{{ action('App\Http\Controllers\Sales\Report\UpsellReportController@exportDownload') }}?file=" + response.file;
