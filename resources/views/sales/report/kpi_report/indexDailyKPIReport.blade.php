...
@section('content')
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Báo cáo KPI của Sale theo ngày</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">KPI của Sale theo ngày</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
        ...
        <div class="d-flex align-items-center py-1">
            ...
            <div class="me-3" list-action="export-contact" >
                <a type="button"
                    href="{{ action([\App\Http\Controllers\Sales\Report\KPIReportController::class, 'showFilterForm']) }}"
    ...
    <div id="DailyReportIndexContainer" class="position-relative" id="kt_post">
        <!--begin::Card-->
        <div class="card ">
            <!--begin::Card header-->
        ...
        <!--end::Card header-->
        <div id="DailyReportIndexListContent">
        </div>
    </div>
...
<script>
            ...
            return {
                init: function() {
                    ...
                    popupExcelDebtReport = new Popup({
                        url: "{{ action('\App\Http\Controllers\Sales\Report\KPIReportController@showFilterForm') }}",
                    });
        ...
        var KpiTargetList = function() {
            ...
            return {
                init: function() {
                    ...
                    // list
                    list = new DataList({
                        url: "{{ action('App\Http\Controllers\Sales\Report\KPIReportController@listDailyKPIReport') }}",
                        container: document.querySelector('#DailyReportIndexContainer'),
                    });
        ...
        var DataList = class {
            constructor(options) {
                ...
                this.listContent = this.getContainer().querySelector('#DailyReportIndexListContent');
