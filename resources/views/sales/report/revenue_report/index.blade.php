...
@section('content')
    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Báo cáo dự thu của Sales</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
    ...
    <div id="RevenueReportIndexContainer" class="position-relative" id="kt_post">
        <!--begin::Card-->
        <div class="card ">
            <!--begin::Card header-->
            <div class="card-header border-0 px-4">
                ...
                <div class="card-title" list-action="search-action-box" style="width:80%;">
                    <div class="row w-100 mb-1 list-filter-box" list-action="created_at-select">
                        ...
                        @endif
                        <div class="col-md-3">
                            <label class="form-label fw-semibold mb-1">Ngày bắt đầu</label>
                            <div class="form-outline">
                        ...
                        <div class="col-md-3">
                            <label class="form-label fw-semibold mb-1">Ngày kết thúc</label>
                            <div class="form-outline">
                                <div data-control="date-with-clear-button"
                                    class="d-flex align-items-center date-with-clear-button">
        ...
        <!--end::Card header-->
        <div id="RevenueReportIndexListContent">
        </div>
    </div>
    <script>
        $(function() {
            RevenueReportIndex.init();
        });
        //
        var RevenueReportIndex = function() {
            return {
                init: function() {
                    RevenueReportList.init();
                    //
                    FilterData.init();
                }
            };
            ...
            return {
                init: () => {
                    ...
                    function applyDateFilter() {
                        ...
                        // Gửi phạm vi ngày tạo đến RevenueReportList và tải lại danh sách
                        RevenueReportList.getList().setCreatedAtFrom(fromDate);
                        RevenueReportList.getList().setCreatedAtTo(toDate);
                        RevenueReportList.getList().load();
                    };
                }
            };
        }();
        ...
        //
        var RevenueReportList = function() {
            var list;
            return {
                init: function() {
                    list = new DataList({
                        url: "{{ action('App\Http\Controllers\Sales\Report\RevenueReportController@list') }}",
                        container: document.querySelector('#RevenueReportIndexContainer'),
                        listContent: document.querySelector('#RevenueReportIndexListContent'),
                    });
                    list.load();
                },
                getList: function() {
