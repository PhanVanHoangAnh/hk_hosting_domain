...
<form class="form" action="{{ action([App\Http\Controllers\Sales\ContactRequestController::class, 'importExcelShow']) }}" id="kt_modal_upload_form" method="POST" enctype="multipart/form-data">
    @csrf
    <!--begin::Modal body-->
        ...
        init: () => {
            ...
            document.querySelector('#kt_modal_upload_form').addEventListener('submit', e => {
                ...
                ExcelPopup.updateUrlImportFile(
                    "{{ action('\App\Http\Controllers\Sales\ContactRequestController@importExcelShow') }}",
                    'POST', csrfToken, file);
            })
        }
    }
