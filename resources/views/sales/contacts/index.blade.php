    ...
    <script>
            ...
            return {
                init: function() {
                    ...
                    popupExportContact = new Popup({
                        url: "{{ action('\App\Http\Controllers\Sales\ContactController@showFilterForm') }}",
                    });
            ...
            return {
                init: function() {
                    popupEditTags = new Popup({
                        url: "{{ action('\App\Http\Controllers\Sales\ContactController@addTagsBulk') }}",
                    });
            ...
            return {
                init: function() {
                    popupDeleteTags = new Popup({
                        url: "{{ action('\App\Http\Controllers\Sales\ContactController@deleteTags') }}",
                    });
        ...
        var ContactsList = function() {
            ...
            return {
                init: function() {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Sales\ContactController@list') }}",
