    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="fv-row mb-7">
                ...
                {{-- <input type="text" class="form-control @if ($errors->has('gender')) is-invalid @endif"
                    placeholder="" name="gender" value="{{ $contact->gender }}" /> --}}
                <!--end::Input-->
        ...
        <div class="col-md-6">
            ...
            <div class="fv-row mb-7">
                ...
                <input type="text" class="form-control @if ($errors->has('school')) is-invalid @endif"
                    placeholder="" name="school" value="{{ $contact->school }}" />
...
<script>
    $(document).ready(function() {
        ...
        new RelatedContactManager({
            form: $('#{{ $formId }}'),
            url: "{!! action('\App\Http\Controllers\Sales\ContactController@relatedContactsBox', ['contact_id' => $contact->id,]) !!}",
        ...
        events() {
            this.getUpdateButtons().forEach(button => {
                button.addEventListener('click', (e) => {
                    ...
                    if (id) {
                        var url =
                            "{{ action([\App\Http\Controllers\Sales\ContactController::class, 'edit'], ['id' => ':id']) }}";
