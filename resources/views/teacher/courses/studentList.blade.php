        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="dtHorizontalVerticalOrder">
            <thead>
                <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 bg-light text-nowrap">
                            ...
                            <input list-action="check-all" class="form-check-input" type="hidden" />
                    ...
                    {{-- <th class="fs-8 min-w-70px d-none">Thao tác</th> --}}
                </tr>
            </thead>
            <tbody class="text-gray-600">
                @foreach($students as $student)
                    <tr list-control="item">
                        ...
                        {{-- <td data-column="action d-none">
                            <a href="javascript:;"
                                class="d-none btn btn-sm btn-outline btn-flex btn-center btn-active-light-default text-nowrap"
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3 d-none">
                                    <a row-action="update"
                                        href="{{ action(
                                            [App\Http\Controllers\Teacher\StudentController::class, 'edit'],
                                            [
                                                'id' => $student->student->id,
                                            ],
                                        ) }}"
                                ...
                                <div class="menu-item px-3 text-start d-none">
                                    <a row-action="note-logs-customer"
                                        href="{{ action(
                                            [App\Http\Controllers\Teacher\StudentController::class, 'noteLogsPopup'],
                                            [
                                                'id' => $student->student->id,
                                            ],
                                        ) }}"
                                ...
                                <div class="menu-item px-3 d-none">
                                    <a row-action="delete"
                                        href="{{ action(
                                            [App\Http\Controllers\Teacher\StudentController::class, 'destroy'],
                                            [
                                                'id' => $student->student->id,
                                            ],
                                        ) }}"
