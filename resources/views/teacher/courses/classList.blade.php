                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div
                                        ...
                                        <a row-action="class-transfer"
                                            href="{{ action(
                                                [App\Http\Controllers\Teacher\StudentController::class, 'transferClass'],
                                                [
                                                    'id' => $contact->id,
                                    ...
                                    {{-- <div
                                        ...
                                        <a row-action="class-transfer"
                                            href="{{ action(
                                                [App\Http\Controllers\Teacher\StudentController::class, 'exitClass'],
                                                [
                                                    'id' => $contact->id,
                                    ...
                                    {{-- <div class="menu-item px-3 ">
                                        <a row-action="class-transfer"
                                            href="{{ action(
                                                [App\Http\Controllers\Teacher\StudentController::class, 'reserveClass'],
                                                [
                                                    'id' => $contact->id,
                                                    'courseId' => $courseStudent->course->id,
                                                ],
                                    ...
                                    <div
                                        ...
                                        <a row-action="class-transfer"
                                            href="{{ action(
                                                [App\Http\Controllers\Teacher\StudentController::class, 'refundRequest'],
                                                [
                                                    'id' => $contact->id,
                                                    'courseId' => $courseStudent->course->id,
                                                ],
