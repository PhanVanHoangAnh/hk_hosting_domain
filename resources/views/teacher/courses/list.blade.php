                ...
                <thead>
                    <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 bg-light text-nowrap">
                        ...
                        @if (in_array('class_code_old', $columns) || in_array('class_code_old', $columns))
                            <th class="min-w-125px text-left" data-column="class_code_old">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Mã lớp cũ
                                    </span>
                            ...
                            <td class="text-left">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ action(
                                            [App\Http\Controllers\Teacher\CourseController::class, 'showDetail'],
                                                [
                                                    'id' => $course->id,
                                                ],
                                            ) }}"
                                    ...
                                    <div
                                        class="menu-item px-3 {{ $course->checkStatusSubject() === App\Models\Course::WAITING_OPEN_STATUS ? 'd-none' : '' }} d-none">
                                        <a data-ids-update="{{ $course->id }}"
                                            href="{{ action(
                                                [App\Http\Controllers\Teacher\SectionReportsController::class, 'reportSection'],
                                                [
                                                    'id' => $course->id,
                                                ],
                                            ) }}"
