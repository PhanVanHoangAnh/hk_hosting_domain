...
@section('content')
<form method="POST" id="{{ $formId }}" action="{{ action([App\Http\Controllers\Teacher\SectionReportsController::class, 'saveReportSectionPopup'], ['id' => $course->id, 'contact_id' => $student->id]) }}">
    @csrf
    <!--begin::Scroll-->
                    ...
                    <script>
                        $(() => {
                            new SectionBox({
                                ...
                                url: '{{ action('\App\Http\Controllers\Teacher\SectionReportsController@getStudents') }}', getSectionSelectBox: function() {
                        ...
                        $('[list-action="section-select"]').on('change', function () {
                            ...
                            $.ajax({
                                url: '{{ action('\App\Http\Controllers\Teacher\SectionReportsController@getSectionReportData') }}',
                                type: 'GET',
                                data: {
