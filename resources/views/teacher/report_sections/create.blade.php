...
@section('content')
<form method="POST" id="{{ $formId }}" action="{{ action([App\Http\Controllers\Teacher\SectionReportsController::class, 'saveReportSection'], ['id' => $section->id, 'contact_id' => $contact->id]) }}">
    @csrf
    <!--begin::Scroll-->
    <div class="pe-7 py-5   px-lg-17">
        @include('teacher.report_sections._form', [
                'formId' => $formId,
            ])
