    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Danh sách bảo lưu</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Quản lý đào tạo</li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-200 w-5px h-2px"></span>
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Danh sách bảo lưu</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
            ...
            let ReserveList = function() {
                ...
                return {
                    init: () => {
                        ...
                        list = new DataList({
                            url: "{{ action('App\Http\Controllers\Student\CourseController2@reserveList', ['id' => $contact->id]) }}",
                ...
                return {
                    ...
                    init: () => {
                        $('.filter-select').on('change', () => {
                            ...
                            ReserveList.getList().setTeachers(teachers);
                            ReserveList.getList().load();
                        });

                        $('.filter-select').on('change', () => {
                            getSubjectValues();

                            ReserveList.getList().setSubjects(subjects);
                            ReserveList.getList().load();
                        });
                        ...
                        $('[list-action="start_at-select"]').on('change', function() {
                            ...
                            ReserveList.getList().setStartAtFrom(fromDate);
                            ReserveList.getList().setStartAtTo(toDate);
                            ReserveList.getList().load();
                        });
                        $('[list-action="end_at-select"]').on('change', function() {
                            ...
                            ReserveList.getList().setEndAtFrom(fromDate);
                            ReserveList.getList().setEndAtTo(toDate);
                            ReserveList.getList().load();
                        });
                    }
                };
