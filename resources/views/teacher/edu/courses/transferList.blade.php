                ...
                <tbody class="text-gray-600">
                    @foreach ($transfers as $transfer)
                        <tr list-control="item">
                            <td class="text-left mb-1 text-nowrap ms-4" data-filter="mastercard"
                                data-column="orderItem_id">
                                <span class="ms-4"> {{ $transfer->orders->code }}</span>
                            ...
                            <td class="text-left mb-1 text-nowrap" data-filter="mastercard" data-column="orderItem_id">
                                {{ $transfer->updated_at->format('d/m/Y') }}
                            </td>
                            <td class="text-left mb-1 text-nowrap" data-filter="mastercard" data-column="orderItem_id">
                                {{ $transfer->status }}
                            </td>
