    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Danh sách yêu cầu hoàn phí</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Danh sách yêu cầu hoàn phí</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
            ...
            let RefundList = function() {
                ...
                return {
                    init: () => {
                        ...
                        list = new DataList({
                            url: "{{ action('App\Http\Controllers\Student\CourseController2@refundList', ['id' => $contact->id]) }}",
                ...
                return {
                    ...
                    init: () => {
                        $('.filter-select').on('change', () => {
                            ...
                            RefundList.getList().setTeachers(teachers);
                        ...
                        $('.filter-select').on('change', () => {
                            ...
                            RefundList.getList().setSubjects(subjects);
                            RefundList.getList().load();
                        });
                        ...
                        $('[list-action="start_at-select"]').on('change', function() {
                            ...
                            RefundList.getList().setStartAtFrom(fromDate);
                            RefundList.getList().setStartAtTo(toDate);
                            RefundList.getList().load();
                        });
                        $('[list-action="end_at-select"]').on('change', function() {
                            ...
                            RefundList.getList().setEndAtFrom(fromDate);
                            RefundList.getList().setEndAtTo(toDate);
                            RefundList.getList().load();
                        });
                    }
                };
