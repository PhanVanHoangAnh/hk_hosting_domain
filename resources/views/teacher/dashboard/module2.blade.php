                            ...
                            <div class="m-0 d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="text-gray-700 fw-bolder fs-2 lh-1 ls-n1 mb-1 me-5 text-nowrap" >
                                        ...
                                        {{App\Models\Course::forTeacher($teacher->id)->count()}}
                            ...
                            <div class="m-0 d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="text-gray-700 fw-bolder fs-2 lh-1 ls-n1 mb-1 me-5 text-nowrap" >
                                        ...
                                        {{App\Models\Course::forTeacher($teacher->id)->getIsLearning()->count()}}
                                    </span>
                                    <!--end::Number-->
                                    <br>
                                    <!--begin::Desc-->
                                    <span class="text-gray-500">Đang dạy</span>
                                    <!--end::Desc-->
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="m-0 d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="text-gray-700 fw-bolder fs-2 lh-1 ls-n1 mb-1 me-5 text-nowrap" >
                                        ...
                                        {{App\Models\Course::forTeacher($teacher->id)->getIsUnstudied()->count()}}
                            ...
                            <div class="m-0 d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="text-gray-700 fw-bolder fs-2 lh-1 ls-n1 mb-1 me-5 text-nowrap" >
                                        ...
                                        {{App\Models\Course::forTeacher($teacher->id)->getIsStudied()->count()}}
