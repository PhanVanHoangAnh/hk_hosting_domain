        ...
        <div class="card ">
            ...
            <div class="card-header border-0 p-4 pb-0 d-none list-filter-box" list-action="filter-action-box">
                ...
                <div class="card-toolbar w-100 mb-0" list-action="tool-action-box">
                    ...
                    <div class="row w-100">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-3 d-none mb-5">
                            <!--begin::Label-->
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-3 mb-5 d-none">
                            <!--begin::Label-->
    ...
    <script>
        ...
        let SectionsList = function() {
            ...
            return {
                init: () => {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Teacher\SectionController@list') }}",
