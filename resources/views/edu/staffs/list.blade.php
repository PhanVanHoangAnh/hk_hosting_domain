...
<div class="card-body pt-0 mt-5">
    @if($staffs->count())
    <div id="staffs-table-box" class="table-responsive scrollable-orders-table">
        <!--begin::Table-->
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="dtHorizontalVerticalOrder">
            <thead>
                <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 bg-light text-nowrap">
                    ...
                    <th list-action="sort" sort-by="id" sort-direction="{{ $sortColumn == 'id' && $sortDirection ? $sortDirection : 'desc' }}" class="min-w-125px text-left" data-column="id">
                    ...
                    <td class="text-left">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ action(
                                    [App\Http\Controllers\Edu\StaffController::class, 'class'],
                                    [
                                        'id' => $staff->id,
                                    ],
                                ) }}"
                            ...
                            <div class="menu-item px-3">
                                <a row-action="show"
                                    href="{{ action([App\Http\Controllers\Edu\StaffController::class, 'showSchedule'],
                                        [
                                            'id' => $staff->id,
                                        ],
                                    ) }}"
