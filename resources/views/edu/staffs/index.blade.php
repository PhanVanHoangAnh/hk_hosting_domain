                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a row-action="delete-all" href="{{ action([App\Http\Controllers\Edu\StaffController::class, 'deleteAll']) }}"
    ...
    <script>
        ...
        const OrdersFeatureIndex = function() {
            ...
            return {
                init: () => {
                    ...
                    BusySchedulePopup.init();
                }
            }
        }();

          //
          var BusySchedulePopup = function() {
                    ...
                    createBtns.forEach(button => {
                        button.addEventListener('click', e => {
                            ...
                            CreateStaffPopup.updateUrl(
                                "{{ action('\App\Http\Controllers\Edu\StaffController@create') }}");
                        });
                    })
                }
            }
        ...
        let StaffsList = function() {
            ...
            return {
                init: () => {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Edu\StaffController@list') }}",
            ...
            const FilterData = function() {
                ...
                let updatedAtFrom = null;
                let updatedAtTo = null;
                ...
                const getCreatedAtValues = () => {
                    createdAtFrom = document.querySelector('[name="created_at_from"]').value;
                    createdAtTo = document.querySelector('[name="created_at_to"]').value;
                };

                const getUpdatedAtValues = () => {
                    updatedAtFrom = document.querySelector('[name="updated_at_from"]').value;
                    updatedAtTo = document.querySelector('[name="updated_at_to"]').value;
                };
                ...
                return {
                    init: () => {
                        ...
                        $('[list-action="export-excel"]').on('click', function() {
                            ...
                            $.ajax({
                                url: "{{ action('\App\Http\Controllers\Edu\StaffController@export') }}",
                                type: "GET",
                                data: query,
                                xhrFields: {
                                    responseType: 'blob' 
            ...
            let DataList = class {
                ...
                initContentEvents() {
                    ...
                    if (this.getNumberOfItems()) {
                        ...
                        // Nút thêm lịch rảnh
                        this.getBusyScheduleBtns().forEach(button => {
                            button.addEventListener('click', (e) => {
                                e.preventDefault();
