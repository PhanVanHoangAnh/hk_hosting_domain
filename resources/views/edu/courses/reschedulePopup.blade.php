                ...
                <div class="col-md-12">
                    <div class="fv-row mb-7">
                        ...
                        <div class="form-outline">
                            <select class="form-select form-control" data-placeholder="Chọn buổi học" data-dropdown-parent="#{{$formId}}"
    ...
    <script>
        ...
        var ScheduleUpdate = (function() {
            ...
            var submit = function() {
                ...
                var url = "{{ action('App\Http\Controllers\Edu\CourseController@updateSchedulePopup', ['id' => 'PLACEHOLDER']) }}";
