                ...
                <div class="card-header border-0 px-4">
                    ...
                    <div class="card-toolbar" list-action="tool-action-box">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <!--begin::Filter-->
                            <button data-action="under-construction" type="button" class="btn btn-outline btn-outline-default d-none" id="filterButton">
                                <span class="d-flex align-items-center">
                                    <span class="material-symbols-rounded me-2 text-gray-600">
                                        filter_alt
                                    </span>
        ...
        let StudentList = function() {
            ...
            return {
                init: () => {
                    ...
                    list = new DataList({
                        url: "{{ action('App\Http\Controllers\Edu\CourseController@studentList', ['id' => $course->id]) }}",
