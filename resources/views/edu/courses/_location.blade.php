...
<div class="row" id="createCourseLocationUniqId_{{ $createCourseLocationUniqId }}">
    <div class="col-4 mb-4">
        <div class="form-outline">
            ...
            <select id="branch-select" class="{{ isset($editNotAllow) && $editNotAllow ? 'border-0 pe-none bg-secondary' : 'form-select' }} form-control" data-control="select2"
                data-dropdown-parent="#createCourseLocationUniqId_{{ $createCourseLocationUniqId }}"
                data-placeholder="{{ isset($editNotAllow) && $editNotAllow ? 'Đang load chi nhánh' : 'Chọn chi nhánh' }}" name="branch">
    ...
    <div class="col-4 mb-4">
        <div class="form-outline">
            ...
            <input id="class-room-select" type="text" class="form-control" name="class_room" placeholder="Nhập lớp học" value="{{ isset($course->class_room) ? $course->class_room : (isset($courseCopy->class_room) ? $courseCopy->class_room : '' ) }}">
        </div>
