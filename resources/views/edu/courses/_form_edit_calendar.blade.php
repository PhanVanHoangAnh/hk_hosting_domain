    ...
    <div>
        ...
        <div class="row ps-5 form-outline mb-2">
            <div class="col-lg-5 col-xl-5 col-md-5 col-sm-5 col-5">
                <div class="row">
                    <div class="col-lg-4 col-xl-4 col-md-4 col-sm-4 col-4">
                        <span class="fs-5">Gia sư:</span>
                    </div>
            
                    <div class="col-lg-8 col-xl-8 col-md-8 col-sm-8 col-8">
                        <span class="fs-5 fw-bold">{{ \App\Helpers\Functions::convertMinutesToHours($course->getRemainStudyMinutesOfTutor()) }} &nbsp;~&nbsp; {{ $course->getRemainStudyMinutesOfTutor() }} phút</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row ps-5 form-outline mb-2">
            <div class="col-lg-5 col-xl-5 col-md-5 col-sm-5 col-5">
                <div class="row">
                    <div class="col-lg-4 col-xl-4 col-md-4 col-sm-4 col-4">
                        <span class="fs-5">Trợ giảng:</span>
                    </div>
            
                    <div class="col-lg-8 col-xl-8 col-md-8 col-sm-8 col-8">
                        <span class="fs-5 fw-bold">{{ \App\Helpers\Functions::convertMinutesToHours($course->getRemainStudyMinutesOfAssistant()) }} &nbsp;~&nbsp; {{ $course->getRemainStudyMinutesOfAssistant() }} phút</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-4" data-container="subject-level">
        ...
        <div class="col-lg-6 col-xl-3 col-md-6 col-sm-12 col-12 mb-4">
            <div class="form-outline">
                ...
                <select class="form-select form-control" data-action="study-method-select"
        ...
        <div class="col-lg-6 col-xl-3 col-md-6 col-sm-12 col-12 mb-4">
            <div class="form-outline">
                ...
                <div data-control="date-with-clear-button" class="d-flex align-items-center date-with-clear-button">
                    <input data-control="input" {{ $action === 'edit' && $course->hasFinished() ? 'readonly' : '' }} value="{{ isset($course->start_at) ? \Carbon\Carbon::parse($course->start_at)->format('Y-m-d') : '' }}" name="start_at" placeholder="=asas" type="date" class="form-control" placeholder=""/>
                    <span data-control="clear" class="material-symbols-rounded clear-button" style="display:none;">close</span>
                </div>
        ...
        <x-input-error :messages="$errors->get('study_method_error_custom')" class="mt-2"/>
        <x-input-error :messages="$errors->get('teacher_conflict_teach_time_custom')" class="mt-2"/>
</div>  
</div>  
                ...
                */
                ...
                if (addCourseManager.getStudyMethodSelectValue().toLowerCase() === onlineMethod.toLowerCase()) {
                    ...
                    $.ajax({
                        ...
                        reject(new Error("Error in process get available zoom user ids!"));
                    })
                } else {
                    // Áp dụng events mới vào data của lịch, lịch sẽ tự động cập nhật lại UI với events mới
                    calendar.updateEvents(currWeekScheduleEvents);
            ...
            $(_this.getApplyBtn()).on('click', e => {
                ...
                (async () => {
                    try {
                        ...
                        // This step is rendering data to calendar
                        const renderResult = await _this.applyToCalendar(); // running
                        
                        // if apply OK => return true else false
                        if (renderResult) {
                            ASTool.alert({
