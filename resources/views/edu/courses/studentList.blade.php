        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="dtHorizontalVerticalOrder">
            <thead>
                <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 bg-light text-nowrap">
                    ...
                    <th list-action="sort"  class="min-w-125px text-left" data-column="code">
                        <span class="d-flex align-items-center">
                            <span>
                                Mã học viên
                            </span>
                    ...
                    <th list-action="sort"  class="min-w-125px text-left" data-column="student_code_old">
                        <span class="d-flex align-items-center">
                            <span>
                                Mã học viên cũ
                            </span>
                    ...
                    <th list-action="sort"  class="min-w-125px text-left" data-column="status">
                        <span class="d-flex align-items-center">
                            <span>
                                Trạng thái
                            </span>
                    ...
                    <th list-action="sort" sort-by="age" sort-direction="{{ $sortColumn == 'age' && $sortDirection ? $sortDirection : 'desc' }}" class="min-w-125px text-left" data-column="age">
                        <span class="d-flex align-items-center">
                            <span>
                               Độ tuổi học sinh
                            </span>
                            <span>
                                <span>
                                    <span class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'age' ? '' : 'text-muted' }}">
                                        sort
                                    </span>
                                </span>
                            </span>
                    ...
                    <tr list-control="item">
                        <td class="text-left ps-1">
                            <div class="form-check form-check-sm form-check-custom">
                                <input data-item-id="{{ $student->id }}" list-action="check-item" class="form-check-input" type="checkbox" value="1" />
                            </div>
                        </td>
                        ...
                        <td  class="text-left mb-1 text-nowrap" data-filter="mastercard">
                            {{ $student->orderItems->order->code }}
                        </td>
                        <td  class="text-left mb-1 text-nowrap" data-filter="mastercard">
                            {{ $student->orderItems->order->import_id }}
                        </td>
                        ...
                        <td data-column="status" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                            ...
                            @php
                                $bgs = [
                                    ...
                                    'Hoàn phí' => 'danger text-white',
                                    'Đang học' => 'success text-white',
                                ];

                            @endphp
                            <span class="badge bg-{{ $bgs[$student->student->getStatusStudent($course)] }}"
                                data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                data-bs-placement="right">
                                {{ $student->student->getStatusStudent($course) }}

                            </span>
                        </td>
                       

                        <td data-column="age" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                            {{ $student->student->age }}
                        </td>
                        ...
                        <td data-column="action">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3 d-none">
                                    <a row-action="update"
                                        href="{{ action(
                                            [App\Http\Controllers\Edu\StudentController::class, 'edit'],
                                            [
                                                'id' => $student->student->id,
                                            ],
                                        ) }}"
