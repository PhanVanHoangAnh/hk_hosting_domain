        ...
        <script>
            ...
            let SectionList = function() {
                ...
                return {
                    init: () => {
                        list = new DataList({
                            url: "{{ action('App\Http\Controllers\Edu\CourseController@sectionList', ['id' => $course->id]) }}",
            ...
            var AttendancePopup = function() {
                ...
                return {
                    ...
                    reload: function() {
                        ...
                        // save all checkeds
                        $('[data-student-id]:checked').each(function() {
                            checkeds.push({
                        ...
                        popupUpdateUser.load(function() {
                            // restore all checkeds
                            checkeds.forEach(element => {
                                $('[data-student-id="'+element.id+'"][value="'+element.value+'"]').prop('checked', true);
                            });
                        });
                    },
                };
