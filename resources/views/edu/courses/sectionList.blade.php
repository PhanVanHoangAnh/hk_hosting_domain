                    ...
                    @foreach ($sections as $section)
                        <tr list-control="item">
                            ...
                            <td data-column="start_link" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                                <button data-action="show-join-links" data-href="{{ action([App\Http\Controllers\Edu\SectionController::class, 'showZoomJoinLinks'], ['id' => $section->id]) }}" class="form-control">Xem thông tin</button>
                            </td>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    @if ($section->course->study_method === \App\Models\Course::STUDY_METHOD_ONLINE)
                                        <div
                                            class="menu-item px-3 {{ $section->checkStatusSectionCalendar() === App\Models\Section::COMPLETED_STATUS ? 'd-none' : '' }}">
                                            <a href="{{ action(
                                                [App\Http\Controllers\Edu\SectionController::class, 'updateZoomLinksPopup'],
                                                [
                                                    'id' => $section->id,
                                                ],
                                            ) }}"
                                    ...
                                    @if ($section->course->study_method === \App\Models\Course::STUDY_METHOD_OFFLINE)
                                        <div
                                            class="menu-item px-3 {{ $section->checkStatusSectionCalendar() === App\Models\Section::COMPLETED_STATUS ? 'd-none' : '' }}">
                                            <a href="{{ action(
                                                [App\Http\Controllers\Edu\SectionController::class, 'createZoomLinksForOfflineSectionPopup'],
                                                [
                                                    'id' => $section->id,
                                                ],
                                            ) }}"
                                                ...
                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                title="{{ $section->checkStatusSectionCalendar() == App\Models\Section::COMPLETED_STATUS ? App\Models\Section::COMPLETED_STATUS : '' }}"
                                                class="menu-link px-3 {{ $section->checkStatusSectionCalendar() == App\Models\Section::COMPLETED_STATUS ? 'd-none ' : '' }}">{{ $section->zoom_start_link || $section->zoom_join_link || $section->zoom_password ? 'Chỉnh sửa' : 'Tạo' }} link học online</a>
                                        </div>
                                    @endif
                                    ...
                                    <div
                                        class="menu-item px-3 {{ $section->checkStatusSectionCalendar() === App\Models\Section::COMPLETED_STATUS ? 'd-none' : '' }}">
                                        <a href="{{ action(
                                            [App\Http\Controllers\Edu\SectionController::class, 'changeTeacherPopup'],
                                            [
                                                'id' => $section->id,
                                            ],
                                        ) }}"
                                    ...
                                    <div
                                        ...
                                        <a data-ids-delete="{{ $section->id }}"
                                            ...
                                            href="{{ action(
                                                [App\Http\Controllers\Edu\SectionController::class, 'destroy'],
                                                [
                                                    'id' => $section->id,
                                            ],
                                            ) }}"
                                    ...
                                    <div class="menu-item px-3">
                                        <a row-action="update"
                                            href="{{ action(
                                                [App\Http\Controllers\Edu\SectionController::class, 'shiftPopup'],
                                                [
                                                    'id' => $section->id,
                                                ],
                                            ) }}"
