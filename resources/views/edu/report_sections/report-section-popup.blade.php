            ...
            <div class="card-body pt-0">
                @if ($sectionReports->count())
                                        ...
                                        <td class="text-left ">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a  href="{{ action([App\Http\Controllers\Edu\SectionReportsController::class, 'edit'], [
                    ...
                    <div class="modal-footer flex-end">
                        ...
                        data-url="{{ action(
                            [App\Http\Controllers\Edu\SectionReportsController::class, 'createReportSectionPopup'],
                            [
                                'id' => $student->id,
                                'course_id' => $course->id,
                            ],
            ...
            return {
                init: function() {
                    document.querySelector('#buttonCreateNewReport').addEventListener('click', e => {
                        e.preventDefault();
                        var url = "{{ action(  [App\Http\Controllers\Edu\SectionReportsController::class, 'createReportSectionPopup'], [ 'id' => $student->id, 'course_id' => $course->id, ], ) }}"
