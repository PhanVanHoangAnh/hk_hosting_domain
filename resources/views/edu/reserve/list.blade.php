                ...
                <thead>
                    <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 text-nowrap">
                        ...
                        @if (in_array('start_at', $columns) || in_array('all', $columns))
                            <th class="min-w-100px fs-8" data-column="start_at">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Ngày bảo lưu
                                    </span>
                        ...
                        @if (in_array('end_at', $columns) || in_array('all', $columns))
                            <th class="min-w-100px fs-8" data-column="end_at">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Ngày hêt hạn bảo lưu
                                    </span>
                        ...
                        @if (in_array('status', $columns) || in_array('all', $columns))
                            <th class="min-w-100px fs-8" data-column="status">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Trạng thái
                                    </span>
                ...
                <tbody class="text-gray-600">
                    @foreach ($reserves as $reserve)
                        <tr list-control="item">
                            <td class="ps-1">
                                <div class="form-check form-check-sm form-check-custom">
                                    <input data-item-id="{{ $reserve->id }}" list-action="check-item"
                                        class="form-check-input" type="checkbox" value="{{ $reserve->id }}" />
                                </div>
                            </td>
                            @if (in_array('name', $columns) || in_array('all', $columns))
                                <td data-column="name">
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex flex-column">
                                            <a href="{{ action(
                                                ...
                                                [
                                                    'id' => $reserve->student->id,
                                                ],
                                            ) }}"
                                                class="mb-1 fw-bold text-nowrap">{{ $reserve->student->name }}</a>
                                        </div>
                                        <!--begin::User details-->
                                    </div>
                                    ...
                                    <div>
                                        <div class="text-nowrap">
                                            <span inline-control="data-phone">
                                                @if ($reserve->student->phone)
                                                    {{ $reserve->student->phone }}
                                                @else
                                            ...
                                            <div inline-control="form-edit-phone" style="display:none;">
                                                <div class="d-flex align-items-center">
                                                    <input type="text" class="form-control" name="phone"
                                                        placeholder="" value="{{ $reserve->student->phone }}"
                                    ...
                                    <div>
                                        <div>
                                            <span inline-control="data-email">
                                                @if ($reserve->student->email)
                                                    {{ $reserve->student->email }}
                                                @else
                            ...
                            @if (in_array('start_at', $columns) || in_array('all', $columns))
                                ...
                                <td class="text-nowrap" data-column="start_at">
                                    {{ $reserve->start_at->format('d/m/Y') }}</td>
                            @endif
                            @if (in_array('end_at', $columns) || in_array('all', $columns))
                                @php
                                ...
                                <td class="text-nowrap" data-column="end_at">
                                    {{ $reserve->end_at->format('d/m/Y') }}</td>
                            @endif

                            @if (in_array('reason', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="reason">
                                    {{ $reserve->reason }}</td>
                            @endif

                            @if (in_array('mother', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="mother">
                                    {{ $reserve->getMother() ? $reserve->getMother()->name : '' }}</td>
                            @endif
                            @if (in_array('address', $columns) || in_array('all', $columns))
                                <td data-column="address">
                                    <a href="javascript:;"
                                        class="text-hover-primary mb-1">{{ $reserve->address }}</a>
                                </td>
                            @endif
                            @if (in_array('deadline', $columns) || in_array('all', $columns))
                                <td data-column="deadline" class="text-nowrap">
                                    @if ($reserve->assigned_at)
                                        <span
                                            class="{{ $reserve->isOutdated() ? 'text-danger' : '' }}">{{ $reserve->getDeadlineCountDownInMinutes() }}</span>
                                    @else
                            ...
                            @if (in_array('demand', $columns) || in_array('all', $columns))
                                <td data-column="demand">
                                    <a href="javascript:;" class="text-hover-primary mb-1">{{ $reserve->demand }}</a>
                                </td>
                            @endif
                            @if (in_array('country', $columns) || in_array('all', $columns))
                                <td data-column="country">
                                    <a href="javascript:;"
                                        class="text-hover-primary mb-1">{{ $reserve->country }}</a>
                                </td>
                            @endif
                            @if (in_array('city', $columns) || in_array('all', $columns))
                                <td data-column="city">
                                    <a href="javascript:;" class="text-hover-primary mb-1">{{ $reserve->city }}</a>
                                </td>
                            @endif
                            @if (in_array('district', $columns) || in_array('all', $columns))
                                <td data-column="district">
                                    <a href="javascript:;"
                                        class="text-hover-primary mb-1">{{ $reserve->district }}</a>
                                </td>
                            @endif
                            @if (in_array('ward', $columns) || in_array('all', $columns))
                                <td data-column="ward">
                                    <a href="javascript:;" class="text-hover-primary mb-1">{{ $reserve->ward }}</a>
                                </td>
                            @endif
                            @if (in_array('school', $columns) || in_array('all', $columns))
                                <td data-column="school">
                                    <a href="javascript:;" class="text-hover-primary mb-1">{{ $reserve->school }}</a>
                                </td>
                            @endif
                            @if (in_array('efc', $columns) || in_array('all', $columns))
                                <td data-column="efc">
                                    <a href="javascript:;" class="text-hover-primary mb-1">
                                        @if (isset($reserve->efc) && $reserve->efc !== '')
                                            {{ $reserve->efc . ' $' }}
                                        @else
                                            {{ $reserve->efc }}
                                        @endif
                            ...
                            @if (in_array('list', $columns) || in_array('all', $columns))
                                <td data-column="list">
                                    <a href="javascript:;" class="text-hover-primary mb-1">{{ $reserve->list }}</a>
                                </td>
                            @endif
                            @if (in_array('target', $columns) || in_array('all', $columns))
                                <td data-column="target">
                                    <a href="javascript:;" class="text-hover-primary mb-1">{{ $reserve->target }}</a>
                                </td>
                            @endif
                            @if (in_array('source_type', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="source_type">{{ $reserve->source_type }}
                                </td>
                            @endif
                                    ...
                                    <div>
                                        <div>
                                            <span inline-control="data-lead_status">
                                                {!! $reserve->lead_status ?? '<span class="text-gray-500">Chưa khai thác</span>' !!}
                                            </span>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <select inline-control="input-lead_status" class="form-select"
                                                        ...
                                                        @foreach (App\Models\ContactRequest::getEditableLeadStatuses() as $type)
                                                            <option value="{{ $type }}"
                                                                {{ $reserve->lead_status === $type ? 'selected' : '' }}>
                                                                {{ $type ?? 'None' }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                            ...
                            @if (in_array('updated_at', $columns) || in_array('all', $columns))
                                <td data-filter="mastercard" data-column="updated_at">
                                    {{ $reserve->updated_at->format('d/m/Y') }}
                                </td>
                            @endif
                            ...
                            <td data-column="action">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div
                                        class="menu-item px-3 {{ $reserve->status === App\Models\Reserve::STATUS_CANCELLED ? 'd-none' : '' }}">
                                        <a row-action="update"
                                            href="{{ action(
                                                [App\Http\Controllers\Edu\ReserveController::class, 'reserveExtend'],
                                                [
                                                    'id' => $reserve->id,
                                                ],
                                            ) }}"
                                            class="menu-link px-3">Gia hạn bảo lưu</a>
                                    </div>
                                    <div
                                        class="menu-item px-3  {{ $reserve->status === App\Models\Reserve::STATUS_CANCELLED ? 'd-none' : '' }}">
                                        <a row-action="update"
                                            href="{{ action(
                                                [App\Http\Controllers\Edu\ReserveController::class, 'reserveCancelled'],
                                                [
                                                    'id' => $reserve->id,
                                                ],
                                            ) }}"
