        ...
        <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
            ...
            <div class="page-title d-flex flex-column py-1">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Bảo lưu</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-200 w-5px h-2px"></span>
            ...
            <div class="d-flex align-items-center py-1">
                <!--begin::Button-->
                <a href="{{ action('App\Http\Controllers\Edu\ReserveController@reserveStudent') }}"
                    class="btn btn-flex btn-sm btn-primary fw-bold border-0 fs-6 h-45px" id="reserveBtn">
    ...
    <script>
        ...
        var ContactsList = function() {
            ...
            return {
                init: function() {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Edu\ReserveController@list') }}",
        ...
        var StudentsManager = class {
            ...
            getReserveBtn() {
                return this.container.querySelector('#reserveBtn');
            };

            events() {
                const _this = this;

                $(_this.getReserveBtn()).on('click', function(e) {
                    e.preventDefault();

                    const url = this.getAttribute('href');

                    reservePopup.updateUrl(url);
                    reservePopup.show();
                });
            };
        };

        var ReservePopup = class {
            constructor(options) {
