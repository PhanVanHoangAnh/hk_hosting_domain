...
<div class="mb-10">
    <div class="col-12">
        <div data-control="order-item-section">
            <div class="">
                <div data-control="order-form-request-demo">
            ...
            <script>
                $(() => {
                    new OrderBox({
                        box: $('[data-control="order-form-request-demo"]'),
                        url: '{{ action('\App\Http\Controllers\Edu\StudentController@orderFormRequestDemo') }}',
