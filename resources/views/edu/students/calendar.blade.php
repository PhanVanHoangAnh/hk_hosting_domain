...
<div class="post" id="kt_post">
                                ...
                                <div class="form-outline">
                                    <div data-control="date-with-clear-button"
                                        ...
                                        <input data-control="input" name="updated_at_from" placeholder="=asas"
                                            type="date" class="material-symbols-rounded clear-button form-control" placeholder="" />
    ...
    <div id="ClassesIndexListContent">
        ...
        <!--begin::Card body-->
    <div form-control="student-calendar" class="card-body pt-0 mt-5">
...
<script>
    ...
    $(() => {
        calendar = new Calendar({
            container: document.querySelector('[form-control="student-calendar"]')
        });
    })
    ...
    var Calendar = class {
        constructor(options) {
            ...
            this.dateData = {
                ...
                events: JSON.parse('{!! json_encode($sections) !!}'),
            };

            // this.dateData.events.map(event => {
            //     return event.viewer = 'student';
            // });
