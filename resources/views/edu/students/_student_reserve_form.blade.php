...
<div class="mb-10">
    <div class="col-12">
        ...
        <div class="">
            <div data-control="course-reserve-form">
        ...
        <script>
            $(() => {
                new CourseStudentBox({
                    box: $('[data-control="course-reserve-form"]'),
                    url: '{{ action('\App\Http\Controllers\Edu\StudentController@courseReserveStudentForm') }}',
