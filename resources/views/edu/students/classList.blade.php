                ...
                <tbody class="text-gray-600">
                    @foreach ($courseStudents as $courseStudent)
                        <tr list-control="item">
                            ...
                            <td data-column="class_code_old" class="text-left mb-1 text-nowrap"
                                data-filter="mastercard">
                                {{ $courseStudent->orderItems->order->code }}
                            </td>
                            <td data-column="class_code_old" class="text-left mb-1 text-nowrap"
                                data-filter="mastercard">
                                {{ $courseStudent->orderItems->order->import_id }}
                            </td>
                            ...
                            <td data-column="report_section" class="text-left mb-1 text-nowrap "
                                ...
                                <a row-action="report-student" class="badge badge-secondary"
                                    href="{{ action(
                                        [App\Http\Controllers\Edu\SectionReportsController::class, 'reportSectionPopup'],
                                        [
                                            'id' => $contact->id,
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div
                                        ...
                                        <a row-action="class-transfer"
                                            href="{{ action(
                                                [App\Http\Controllers\Edu\StudentController::class, 'transferClass'],
                                                [
                                                    'id' => $contact->id,
                                                    'courseId' => $courseStudent->course->id,
                                                ],
                                            ) }}"
                                            class="menu-link px-3">Chuyển lớp</a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a row-action="report-student"
                                            ...
                                            class="menu-link px-3">Báo cáo học tập</a>
                                    </div>
                                    {{-- <div
                                        class="menu-item px-3   {{ $contact->checkExitClass($courseStudent->course) === false ? 'd-none' : '' }}">
                                        <a row-action="class-transfer"
                                            href="{{ action(
                                                [App\Http\Controllers\Edu\StudentController::class, 'exitClass'],
                                                [
                                                    'id' => $contact->id,
                                    ...
                                    {{-- <div class="menu-item px-3 ">
                                        <a row-action="class-transfer"
                                            href="{{ action(
                                                [App\Http\Controllers\Edu\StudentController::class, 'reserveClass'],
                                                [
                                                    'id' => $contact->id,
                                                    'courseId' => $courseStudent->course->id,
                                                ],
