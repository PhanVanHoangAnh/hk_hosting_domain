                ...
                <tbody class="text-gray-600">
                    ...
                    @foreach ($sections as $section)
                        <tr list-control="item">
                            ...
                            @endphp
                             @if($section->getReasonRequestAbsent($contact->id))
                            ...
                            <td class="text-left">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3  {{ $section->hasReportForStudent($contact->id) ? 'd-none' : '' }}">
                                        {{-- {{ $contact->getStudentSectionStatus($section) === App\Models\StudentSection::STATUS_PRESENT ? '' : 'd-none' }} --}}
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        <a data-ids-delete="{{ $section->id }}"
                                            ...
                                            href="{{ action([App\Http\Controllers\Edu\CourseController::class, 'delete'], ['id' => $section->id]) }}"
