                ...
                <tbody>
                    @foreach($orderItems as $orderItem)
                        ...
                        <tr class="border" list-control="item">
                            ...
                            <td rowspan="4" class="px-5 ">
                                <a row-action="detail-student" title="Click vào tên học viên xem chi tiết" data-bs-toggle="tooltip"
                                    href="{{ action([App\Http\Controllers\Edu\Report\StudentHourReportController::class, 'listDetailStudent'],
                                    [
                                        'id' => $orderItem->id,
                                    ]) }}">
                            ...
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedForOrderItem($updated_at_from)) }}₫ </td>
                            <td class="px-5 ">{{ $hourTotalLuyKe }} giờ {{ $minutesTotalLuyKe }} phút </td>
                            <td class="px-5 d-none">  {{App\Helpers\Functions::formatNumber($orderItem-> calculatePriceTotalHoursStudiedByLuyKeForOrderItem( $updated_at_to))}}₫ </td>
                            
                            <td class="px-5 "> {{ $hourTotalDauKy }} giờ {{ $minutesTotalDauKy }} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedByDauKyForOrderItem($updated_at_from)) }}₫</td>
                           

                            <td class="px-5 "> {{ $hourTotalTrongKy}} giờ {{ $minutesTotalTrongKy}} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedByTrongKyForOrderItem($updated_at_from, $updated_at_to)) }}₫</td>
                            
                            <td class="px-5 "> {{ $hourTotalCuoiKy}} giờ {{ $minutesTotalCuoiKy}} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedByCuoiKyForOrderItem($updated_at_from, $updated_at_to)) }}₫</td>
                        </tr>
                        ...
                        <tr class="border" list-control="item">
                            ...
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfForeignTeacherForOrderItem($updated_at_from)) }}₫ </td>
                            <td class="px-5 ">{{ $hourForeignLuyKe }} giờ {{ $minutesForeignLuyKe }} phút </td>
                            <td class="px-5 d-none">  {{App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfForeignTeacherByLuyKeForOrderItem( $updated_at_to))}}₫ </td>
                        
                            <td class="px-5 "> {{ $hourForeignDauKy }} giờ {{ $minutesForeignDauKy }} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfForeignTeacherByDauKyForOrderItem($updated_at_from)) }}₫</td>
                            <td class="px-5 "> {{ $hourForeignTrongKy}} giờ {{ $minutesForeignTrongKy}} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfForeignTeacherByTrongKyForOrderItem($updated_at_from, $updated_at_to)) }}₫</td>
                            <td class="px-5 "> {{ $hourForeignCuoiKy}} giờ {{ $minutesForeignCuoiKy}} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfForeignTeacherByCuoiKyForOrderItem($updated_at_from, $updated_at_to)) }}₫</td>
                        </tr>
                        <tr class="border" list-control="item">
                            <td class="px-5 ">Gia sư</td>
                            <td class="px-5 ">{{ $hourKhoaHocOfTutor }} giờ {{ $minutesKhoaHocOfTutor }} phút</td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfTutorForOrderItem($updated_at_from)) }}₫ </td>
                            <td class="px-5 ">{{ $hourTutorLuyKe }} giờ {{ $minutesTutorLuyKe }} phút </td>
                            <td class="px-5 d-none">  {{App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfTutorByLuyKeForOrderItem( $updated_at_to))}}₫ </td>

                            <td class="px-5 "> {{ $hourTutorDauKy }} giờ {{ $minutesTutorDauKy }} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfTutorByDauKyForOrderItem($updated_at_from)) }}₫</td>
                            <td class="px-5 "> {{ $hourTutorTrongKy}} giờ {{ $minutesTutorTrongKy}} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfTutorByTrongKyForOrderItem( $updated_at_from, $updated_at_to)) }}₫</td>
                            <td class="px-5 "> {{ $hourTutorCuoiKy}} giờ {{ $minutesTutorCuoiKy}} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfTutorByCuoiKyForOrderItem( $updated_at_from, $updated_at_to)) }}₫</td>
                        </tr>
                        <tr class="border" list-control="item">
                            <td class="px-5 ">Giáo viên Việt Nam</td>
                            <td class="px-5 "> {{ $hourKhoaHocOfVNTeacher }} giờ {{ $minutesKhoaHocOfVNTeacher }} phút</td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfVNTeacherForOrderItem($updated_at_from)) }}₫ </td>
                            <td class="px-5 ">{{ $hourVnLuyKe }} giờ {{ $minutesVnLuyKe }} phút</td>
                            <td class="px-5 d-none">  {{App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfVNTeacherByLuyKeForOrderItem( $updated_at_to))}}₫ </td>
                            <td class="px-5 "> {{ $hourVnDauKy }} giờ {{ $minutesVnDauKy }} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfVNTeacherByDauKyForOrderItem($updated_at_from)) }}₫</td>
                            <td class="px-5 "> {{ $hourVnTrongKy}} giờ {{ $minutesVnTrongKy}} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfVNTeacherByTrongKyForOrderItem($updated_at_from, $updated_at_to)) }}₫</td>
                            <td class="px-5 "> {{ $hourVnCuoiKy}} giờ {{ $minutesVnCuoiKy}} phút </td>
                            <td class="px-5 d-none">{{ App\Helpers\Functions::formatNumber($orderItem->calculatePriceTotalHoursStudiedOfVNTeacherByCuoiKyForOrderItem($updated_at_from, $updated_at_to)) }}₫</td>
                        </tr>
                    @endforeach
                </tbody>
