    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Báo cáo giờ tồn của học viên</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Giờ tồn của học viên</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
                            ...
                            <div class="form-outline pt-8">
                                <div class="d-flex align-items-center date-with-clear-button">
                                    <button type="button" id="runButton" class="btn btn-primary ms-2"
                                        style="padding-top: 7px; padding-bottom: 7px;">Báo cáo</button>
        ...
        var StudentHourReportList = function() {
            ...
            return {
                init: function() {
                    ...
                    // list
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Edu\Report\StudentHourReportController@list') }}",
        ...
        var FilterData = class {
            ...
            events() {
                ...
                $('#exportButton').on('click', () => {
                    ...
                    $.ajax({
                        url: "{{ action('\App\Http\Controllers\Edu\Report\StudentHourReportController@export') }}?" + query,
                        method: 'GET',
                        xhrFields: {
                            responseType: 'blob'
                        },
                        ...
                        success: function(data) {
                            ...
                            a.href = url;
                            a.download = 'edu-student-hour-report.xlsx';
