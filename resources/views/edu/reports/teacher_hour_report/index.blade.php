...
@section('content')
                ...
                <div class="card-title" list-action="search-action-box" style="width:100%;">
                    <div class="row w-100 mb-1 list-filter-box" list-action="created_at-select">
                        <div class="col-md-3">
                            ...
                            <select list-action="teacher-filter-select" class="form-select form-control filter-select" name="teacher_ids[]"
    ...
    <script>
        $(function() {
            ...
            PopupTeacherHourDetailReport.init();
        });
        ...
        var TeacherHourReportList = function() {
            ...
            return {
                init: function() {
                    ...
                    // list
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Edu\Report\TeacherHourReportController@list') }}",
        ...
        var DataList = class {
            ...
            getDetailHourButtons() {
                return this.listContent.querySelectorAll('[row-action="detail-teacher"]');
            }
            //tạo sự kiện
            initContentEvents() {
                ...
                if (this.getListItemsCount()) {
                    ...
                    this.getDetailHourButtons().forEach(button => {
                        button.addEventListener('click', (e) => {
                            ...
                            PopupTeacherHourDetailReport.load(url);
                        });
                    });
                }
            }
        ...
        //
        var PopupTeacherHourDetailReport = function() {
            var updatePopup;
            return {
