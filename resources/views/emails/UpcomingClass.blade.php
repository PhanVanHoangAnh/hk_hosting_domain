                                    ...
                                    <td class="content-cell"
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 text-center text-dark fw-bold">
                                                <span class="text-center text-dark fw-bold">Lớp học {{$course->code}} sắp tới giờ học</span>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 my-3">
                                                <p class="notification-header">Kính gửi Quý Phụ huynh và học viên
                                                    Trung tâm American Study xin thông báo lịch học của lớp {{$course->code}} như sau</p>
