                                    ...
                                    <td class="content-cell"
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 text-center text-dark fw-bold">
                                                <span class="text-center text-dark fw-bold">Thông báo xếp lớp thành công</span>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 my-3">
                                                <p class="notification-header">Kính gửi Quý Phụ huynh/ Học viên,</p>
                                                    <p class="notification-header">Hợp đồng số {{$orderItem->order->code}} của học viên {{$orderItem->order->student->name}} đã được xếp lớp thành công.
                                                        Trung tâm American Study xin thông báo Quý Phụ huynh/ Học viên lịch học cụ thể như sau:
                                                        </p>
                                                ...
                                                <table>
                                                    ...
                                                    <tr class="online">
                                                        ...
                                                        <td>
                                                            @if($course->zoom_join_link)
                                                                <a href="{{ $course->zoom_join_link }}">Link Zoom</a>
                                                            @else
                                                           {{$course->trainingLocation->address }}, {{$course->trainingLocation->name }}, {{$course->trainingLocation->branch }}  
                                                            @endif
                                                        </td>
                                                ...
                                                <p><a href="{{ action([App\Http\Controllers\Student\SectionController::class, 'index']) }}" class="report-link">Link</a></p>
                                                <p>Trong trường hợp Quý Phụ huynh/ Học viên có bất kì thắc mắc gì, vui lòng liên hệ chủ nhiệm của lớp <strong>{{$course->code}}</strong>:</p>
                                                <p>Chủ nhiệm: <strong>{{$course->teacher->name}}</strong></p>
                                                <p>Số điện thoại: <strong>{{$course->teacher->phone}}</strong></p>
                                                <p>Email: <strong>{{$course->teacher->email}}</strong></p>
                                                <p>American Study  tin tưởng rằng với sự cố gắng nỗ lực của học viên, cùng với sự chuyên nghiệp của đội ngũ giảng dạy, học viên {{$course->subject->name}} sẽ tích lũy được nhiều kiến thức, đạt được thành tích cao trong môn học {{$course->subject->name}}
                                                </p>
                                                <p>Chúc học viên {{$course->subject->name}} học hiệu quả!
                                                </p>
                                                <p>Trân trọng.</p>
                                        </div>
