                                    ...
                                    <td class="content-cell"
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 text-center text-dark fw-bold">
                                                <span class="text-center text-dark fw-bold">Mạng xã hội và kênh truyền thông của bạn đã được cập nhật. Vui lòng click vào <strong>đây</strong> để xem chi tiết</span>
                                            </div>
