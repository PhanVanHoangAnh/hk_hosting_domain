                                    ...
                                    <td class="content-cell"
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 300vw; padding: 32px;">
                                            ...
                                            <div class="row mb-5">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 text-center text-dark fw-bold">
                                                    <span class="text-center text-dark fw-bold">Thông báo doanh thu từ ngày {{ \Carbon\Carbon::parse($startOfWeek)->format('d/m/Y') }} - {{ \Carbon\Carbon::parse($endOfWeek)->format('d/m/Y') }}
                                                    </span>
                                                </div>
                                            </div>
                                        <!-- Table header -->
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 my-3">
                                                <p class="">Kính gửi ban giám đốc,</p>
                                                <p class="">Trung tâm American Study xin thông báo về doanh thu tuần trước:</p>
                                                <div class="row mb-3">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
                                                        <div class="row">
                                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
                                                                <p>Ban giám đốc truy cập vào <a href="https://asms-americanstudy.com/">đường link</a> để truy cập vào hệ thống:</p>
                                                            </div>
                                                        </div>
                                                    </div>
