                                    ...
                                    <td class="content-cell"
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 text-center text-dark fw-bold">
                                                <span class="text-center text-dark fw-bold">Thông báo chuyển buổi của lớp</span>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 my-3">
                                                <p class="notification-header">Kính gửi Quý Phụ huynh/ Học viên,</p>
                                                    <p class="notification-header">Trung tâm American Study xin thông báo về thông tin chuyển buổi của lớp học {{$section->course->code}}:
                                                        </p>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
                                                        <div class="row">
                                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
                                                                <span class="fw-bold text-dark fs-7">Thông tin cụ thể buổi học mới</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <tr class="online">
                                                            ...
                                                            <td> {{$section->course->subject->name}}</td>
                                                            <td>{{$section->course->level}}</td>
                                                            ...
                                                            @php
                                                                ...
                                                                Carbon::setLocale('vi');
                                                            @endphp
                                                            <td>{{ Carbon::parse($section->end_at)->translatedFormat('l') }} Ngày {{ date('d/m/Y', strtotime($section->end_at)) }} từ {{ date('H:i', strtotime($section->start_at)) }} đến {{ date('H:i', strtotime($section->end_at)) }}</td>
                                                            <td>{{$section->course->study_method}}</td>

                                                        <td>
                                                            @if($section->course->zoom_join_link)
                                                                <a href="{{ $section->course->zoom_join_link }}">Link Zoom</a>
                                                            @else
                                                           {{$section->course->trainingLocation->address }}, {{$section->course->trainingLocation->name }}, {{$section->course->trainingLocation->branch }}  
                                                            @endif
                                                        </td>
                                                ...
                                                <p>Trong trường hợp Quý Phụ huynh/ Học viên có bất kì thắc mắc gì, vui lòng liên hệ chủ nhiệm của lớp <strong>{{$section->course->code}}</strong>:</p>
                                                <p>Chủ nhiệm: <strong>{{$section->course->teacher->name}}</strong></p>
                                                <p>Số điện thoại: <strong>{{$section->course->teacher->phone}}</strong></p>
                                                <p>Email: <strong>{{$section->course->teacher->email}}</strong></p>
