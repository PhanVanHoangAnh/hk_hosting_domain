                                    ...
                                    <td class="content-cell"
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 text-center text-dark fw-bold">
                                                <span class="text-center text-dark fw-bold">Thông báo bảo lưu</span>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 my-3">
                                                <p class="notification-header">Kính gửi Quý Phụ huynh/ Học viên,</p>
                                                    <p class="notification-header">Trung tâm American Study xin thông báo về thông tin bảo lưu của học viên {{$orderItems->first()->order->student->name}}:
                                                        </p>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
                                                        <div class="row">
                                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12">
                                                                <span class="fw-bold text-dark fs-7">1. THÔNG TIN KHOÁ HỌC</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <table>
                                                    <tr>
                                                        <th>Khoá học</th>
                                                        <th>Trình độ</th>
                                                        <th>Số giờ giáo viên Việt Nam còn lại</th>
                                                        <th>Giờ giáo viên nước ngoài còn lại</th>
                                                        <th>Giờ gia sư còn lại</th>
                                                    ...
                                                    @foreach ($orderItems as $orderItem)
                                                        ...
                                                        @endphp
                                                            ...
                                                            <td>{{ date('d/m/Y', strtotime($reserveStartAt)) }} </td>
                                                            <td>{{ date('d/m/Y', strtotime($reserveEndAt)) }} </td>
