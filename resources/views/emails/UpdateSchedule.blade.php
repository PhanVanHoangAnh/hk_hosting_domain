                                    ...
                                    <td class="content-cell"
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 text-center text-dark fw-bold">
                                                <span class="text-center text-dark fw-bold">Lớp học {{$course->code}} đã thay đổi thời khoá biểu</span>
                                            </div>
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 my-3">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 col-4 d-flex align-items-center">
                                                        ...
                                                        <span class="text-dark content">Mã lớp:</span>
                                                    </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 col-8">
                                                        <span class="content">{{ $course->subject->name }}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 col-4 d-flex align-items-center">
                                                        <span class="large-dot"></span>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <span class="text-dark content">Hình thức học:</span>
                                                    </div>
                                                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 col-8">
                                                        <span class="content">{{ $course->study_type }}</span>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 col-4 d-flex align-items-center">
                                                    ...
                                                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-xs-8 col-8">
                                                        <span class="content">{{ $course->level }}</span>
                                                    </div>
                                                </div>
