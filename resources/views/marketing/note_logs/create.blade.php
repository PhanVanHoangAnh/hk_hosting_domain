...
@section('content')
    <form id="CreateNoteLogForm" tabindex="-1" method="post" 
        action="{{ action([App\Http\Controllers\Marketing\NoteLogController::class, 'store']) }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="scroll-y pe-7  py-10 px-lg-17" id="kt_modal_add_note_log_scroll">
            ...
            <div class="mb-7">
                <div class="">
                    ...
                    <x-input-error :messages="$errors->get('contact_id')" class="mt-2 mb-0" />
                </div>
            </div>
    ...
    <script>
        ...
        var CreateNoteLog = function() {
            ...
            submit = () => {
                ...
                $.ajax({
                    url: "{{ action([App\Http\Controllers\Marketing\NoteLogController::class, 'store']) }}",
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false
