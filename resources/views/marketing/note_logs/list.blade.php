            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_contacts_table">
                <thead>
                    <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 text-nowrap">
                        ...
                        @endif
                        @if (in_array('image', $columns) || in_array('all', $columns))
                            <th class="min-w-50px text-left fs-8" data-column="image">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Ảnh
                                    </span>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    @if (Auth::user()->can('update', $note))
                                        <div class="menu-item px-3">
                                            <a row-action="update"
                                                href="{{ action(
                                                    [App\Http\Controllers\Marketing\NoteLogController::class, 'edit'],
                                                    [
                                                        'id' => $note->id,
                                                    ],
                                                ) }}"
                                    ...
                                    @if (Auth::user()->can('delete', $note))
                                        <div class="menu-item px-3">
                                            <a row-action="delete"
                                                href="{{ action(
                                                    [App\Http\Controllers\Marketing\NoteLogController::class, 'destroy'],
                                                    [
                                                        'id' => $note->id,
                                                    ],
                                                ) }}"
