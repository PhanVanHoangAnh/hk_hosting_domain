...
<div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                <thead>
                    <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 text-nowrap">
                        ...
                        <th class="min-w-125px fs-8 d-none">Người tạo</th>
                        <th >Ngày tạo</th>
                        <th >Thao tác</th>
                    </tr>
                </thead>
                        ...
                        <td class="">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a row-action="update" href="{{ action([App\Http\Controllers\Marketing\ContactListController::class, 'edit'], [
                                                'id' => $contact->id,
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a row-action="delete" href="{{ action([App\Http\Controllers\Marketing\ContactListController::class, 'destroy'], [
                                                'id' => $contact->id,
    ...
    @else
        <div class="py-15">
            ...
            <p class="text-center">
                <a href="" class="btn btn-outline btn-outline-default">
