                    ...
                    <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 text-nowrap">
                        ...
                        @if (in_array('name', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="contacts.name"
                                ...
                                class="min-w-100px fs-8 bg-info" data-control="freeze-column" data-column="name">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Khách hàng/Liên hệ
                                    </span>
                        ...
                        @if (in_array('status', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="status" style="min-width:200px!important;"
                        ...
                        @if (in_array('deadline', $columns) || in_array('all', $columns))
                            <th class="min-w-100px fs-8" data-column="deadline">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Thời hạn
                                    </span>
                        ...
                        @if (in_array('added_from', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="added_from" style="min-width:200px!important;"
                                sort-direction="{{ $sortColumn == 'added_from' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-100px fs-8" data-column="added_from">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Nhập từ
                                    </span>
                                    <span>
                                        <span>
                                            <span
                                                class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'added_from' ? '' : 'text-muted' }}">
                                                sort
                                            </span>
                                        </span>
                                    </span>
                        ...
                        @if (in_array('lead_status', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="lead_status"
                                ...
                                class="min-w-200px fs-8" data-column="lead_status">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Lead Status
                                    </span>
                        ...
                        @endif
                        @if (in_array('sheet_id', $columns) || in_array('all', $columns))
                            <th class="min-w-100px fs-8" data-column="sheet_id">
                                <span class="d-flex align-items-center">
                                    <span>
                                        Google Sheet ID
                                    </span>
                        ...
                        <tr list-control="item">
                            ...
                            alt="image" class="w-100" alt="{{ $contactRequest->contact->name }}" />
                                        ...
                                        <div class="d-flex flex-column">
                                            <span
                                                class="mb-1 fw-bold text-nowrap">{{ $contactRequest->contact->name }}</span>
                            ...
                            @if (in_array('status', $columns) || in_array('all', $columns))
                                <td data-column="status">       
                                    @if ($contactRequest->getAllContactRequestsByContact()->count() > 1)
                                        <a row-action="note-logs-contact"
                                                href="{{ action(
                                                    [App\Http\Controllers\Marketing\ContactRequestController::class, 'contactRquestPopup'],
                                                    [
                                    ...
                                    @else
                                        <span class="badge badge-secondary">Mới</span>
                                    @endif
                                </td>
                            @endif
                            @if (in_array('phone', $columns) || in_array('all', $columns))
                                        ...
                                        <div class="text-nowrap">
                                            <span inline-control="data-phone">
                                                @if ($contactRequest->contact->phone)
                                                    {{ $contactRequest->contact->displayPhoneNumberByUser(Auth::user()) }}
                                                @else
                                            ...
                                            <div inline-control="form-edit-phone" style="display:none;">
                                                <div class="d-flex align-items-center">
                                                    <input type="text" class="form-control" name="phone"
                                                        placeholder="" value="{{ $contactRequest->contact->displayPhoneNumberByUser(Auth::user()) }}"
                            ...
                            @if (in_array('father', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="father">
                                    @if ($contactRequest->contact->getFather())
                                        ...
                                        @if ($contactRequest->contact->getFather()->displayPhoneNumberByUser(Auth::user()))
                                            <div>
                                                (📱 {{ $contactRequest->contact->getFather()->displayPhoneNumberByUser(Auth::user()) }})
                                            </div>
                                        @endif
                                    @endif
                                </td>
                            ...
                            @if (in_array('mother', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="mother">
                                    @if ($contactRequest->contact->getMother())
                                        ...
                                        @if ($contactRequest->contact->getMother()->displayPhoneNumberByUser(Auth::user()))
                                            <div>
                                                (📱 {{ $contactRequest->contact->getMother()->displayPhoneNumberByUser(Auth::user()) }})
                                            </div>
                                        @endif
                                    @endif
                                </td>
                            ...
                            @if (in_array('added_from', $columns) || in_array('all', $columns))
                                <td data-column="added_from">
                                    <a href="javascript:;"
                                        class="text-hover-primary mb-1">{{ trans('messages.contact.added_from.' . $contactRequest->added_from) }}</a>
                                </td>
                            @endif
                            ...
                            @if (in_array('source_type', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="source_type">
                                  {{ isset($contactRequest->source_type) ? trans('messages.contact_request.source_type.' . $contactRequest->source_type) : '' }}
                            ...
                            @if (in_array('account_id', $columns) || in_array('all', $columns))
                                <td data-column="account_id" list-control="salepersion-inline-edit"
                                    data-url="{{ action('\App\Http\Controllers\Marketing\ContactRequestController@save', [
                                    ...
                                    <div>
                                        <div>
                                            <span inline-control="data-lead_status" class="badge bg-secondary">
                                                {{-- {!! trans('messages.contact_request.lead_status.' . $contactRequest->lead_status ?? '<span class="text-danger">Chưa khai thác</span>') !!} --}}
                            ...
                            @endif
                            @if (in_array('lifecycle_stage', $columns) || in_array('all', $columns))
                                <td data-column="lifecycle_stage"
                                    list-control="lifecycle_stage-inline-edit"
                                    data-url="{{ action('\App\Http\Controllers\Marketing\ContactRequestController@save', [
                                        'id' => $contactRequest->id,
                                    ]) }}"
                                    class="text-nowrap">
                                    <div>
                                        <div>
                                            <span inline-control="data-lifecycle_stage" class="badge bg-secondary">
                                                {!! $contactRequest->lifecycle_stage ?? '<span class="text-'.($contactRequest->lifecycle_stage ? 'gray-500' : 'danger').'">--</span>' !!}
                                            </span>

                                            @if (Auth::user()->can('updateLifeCycleStage', $contactRequest))
                                                <a href="javascript:;" inline-control="edit-button-lifecycle_stage">
                                                    <span class="material-symbols-rounded fs-6 inline-edit-button">
                                                        edit
                                                    </span>
                                                </a>
                                                <div inline-control="form-lifecycle_stage" style="display:none; width: 100%;">
                                                    <div class="d-flex align-items-center">
                                                        <select inline-control="input-lifecycle_stage" class="form-select"
                                                            data-control="select2"
                                                            data-placeholder="Select an option">
                                                            <option value="">Select an option</option>
                                                            @foreach (config('lifecycleStages') as $lifecycleStage)
                                                                <option value="{{ $lifecycleStage }}">{{ $lifecycleStage }}</option>
                                                            @endforeach
                                                        </select>
                                                        <button inline-control="close-lifecycle_stage" type="button"
                                                            class="btn btn-icon">
                                                            <span class="material-symbols-rounded">
                                                                close
                                                            </span>
                                ...
                                <td class="text-nowrap" style="width: auto" data-column="note_log">
                                    <div class="d-flex">
                                        <span class="d-inline-block  text-truncate w-100 pe-3 list-note-log-col">
                                            <?php
                                                $latestNoteLog = $contactRequest->getMarketingLatestNoteLog();
                                            ?>
                                            
                                            @if ($latestNoteLog)
                                                <span data-bs-toggle="tooltip" title="{{ strip_tags($latestNoteLog->content) }}">
                                                    {{ strip_tags($latestNoteLog->content) }}
                                                </span>
                                            @else
                                        ...
                                        <a row-action="note-logs-contact"
                                            href="{{ action(
                                                [App\Http\Controllers\NoteLogController::class, 'MarketingContactRequest'],
                                                [
                                                    'id' => $contactRequest->id,
                                                ],
                                            ) }}">
                            ...
                            @endif
                            @if (in_array('sheet_id', $columns) || in_array('all', $columns))
                                <td data-column="sheet_id">
                                    @if (App\Library\GoogleSheetImporter::find($contactRequest->google_sheet_id))
                                        <a href="javascript:;"
                                            class="text-hover-primary mb-1">{{ App\Library\GoogleSheetImporter::find($contactRequest->google_sheet_id)->getName() }}
                                        </a>
                                    @endif
                                </td>
                            @endif
                            <td data-column="action">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3 d-none">
                                        <a href="{{ action(
                                            [App\Http\Controllers\Marketing\ContactRequestController::class, 'show'],
                                            [
                                                'id' => $contactRequest->id,
                                            ],
                                        ) }}"
                                    ...
                                    @if (Auth::user()->can('update', $contactRequest))
                                        ...
                                        <div class="menu-item px-3 d-none">
                                            <a row-action="update"
                                                href="{{ action(
                                                    [App\Http\Controllers\Marketing\ContactRequestController::class, 'edit'],
                                                    [
                                                        'id' => $contactRequest->id,
                                                    ],
                                                ) }}"
                                    ...
                                    @if (Auth()->user()->can('delete', $contactRequest))
                                        <div class="menu-item px-3">
                                            <a row-action="delete"
                                                href="{{ action(
                                                    [App\Http\Controllers\Marketing\ContactRequestController::class, 'destroy'],
                                                    [
                                                        'id' => $contactRequest->id,
                                                    ],
                                                ) }}"
                                    ...
                                    <div class="menu-item px-3 d-none">
                                        <a row-action="update"
                                            href="{{ action(
                                                [App\Http\Controllers\Marketing\ContactRequestController::class, 'showFreeTimeSchedule'],
                                                [
                                                    'id' => $contactRequest->id,
                                                ],
                                            ) }}"
                                    ...
                                    <div class="menu-item px-3 text-start">
                                        <a row-action="handover-contact"
                                            href="{{ action(
                                                [App\Http\Controllers\Marketing\ContactRequestController::class, 'addHandover'],
                                                [
                                                    'id' => $contactRequest->id,
                                                ],
                                            ) }}"
                                            class="menu-link px-3">Bàn giao cho nhân viên sale</a>
                                    </div>
                                    <!--end::Menu item-->
                                </div>
                                <!--end::Menu-->
...
<script>
    ...
    var ContactRequestsListInline = function() {
        return {
            init: function() {
                ...
                //lead_status Inline edit
                document.querySelectorAll('[list-control="lifecycle_stage-inline-edit"]').forEach(control => {
                    var url = control.getAttribute('data-url');
                    //var lifecycleStageInlineEdit = new LifecycleStageInlineEdit({
                    //    container: control,
                    //    url: url,
                    //});
                });
    ...
    var LifecycleStageInlineEdit = class {
        constructor(options) {
            this.container = options.container;
            this.saveUrl = options.url;
        ...
        getEditButtonLifecycleStage() {
            return this.container.querySelector('[inline-control="edit-button-lifecycle_stage"]');
        }

        showFormBoxLifecycleStage() {
            this.getFormBoxLifecycleStage().style.display = 'inline-block';
        }

        hideFormBoxLifecycleStage() {
            this.getFormBoxLifecycleStage().style.display = 'none';
        }

        getFormBoxLifecycleStage() {
            return this.container.querySelector('[inline-control="form-lifecycle_stage"]');
        }

        getDataContainerLifecycleStage() {
            return this.container.querySelector('[inline-control="data-lifecycle_stage"]')
        }

        hideDataContainerLifecycleStage() {
            this.getDataContainerLifecycleStage().style.display = 'none';
        }

        showDataContainerLifecycleStage() {
            this.getDataContainerLifecycleStage().style.display = 'inline-block';
        }

        updateLifecycleStage(lifecycle_stage) {
            this.getDataContainerLifecycleStage().innerHTML = lifecycle_stage;
        }

        getInputControlLifecycleStage() {
            return this.container.querySelector('[inline-control="input-lifecycle_stage"]');
        }

        getLifecycleStage() {
            return this.getInputControlLifecycleStage().value;
        }

        hideEditButtonLifecycleStage() {
            this.getEditButtonLifecycleStage().style.display = 'none';
        }

        showEditButtonLifecycleStage() {
            this.getEditButtonLifecycleStage().style.display = 'inline-block';
        }

        getCloseButtonLifecycleStage() {
            return this.container.querySelector('[ inline-control="close-lifecycle_stage"]');
        }
        ...
        save(afterSave) {
            ...
            $.ajax({
                ...
                _this.updateLifecycleStage(response.lifecycle_stage);
        ...
        setEditModeLifecycleStage() {
            this.showFormBoxLifecycleStage();
            this.hideDataContainerLifecycleStage();
            this.hideEditButtonLifecycleStage();
        }

        closeEditModeLifecycleStage() {
            this.hideFormBoxLifecycleStage();
            this.showDataContainerLifecycleStage();
            this.showEditButtonLifecycleStage();
        }
        ...
        events() {
            ...
            //click
            $(this.getEditButtonLifecycleStage()).on('click', (e) => {
                this.setEditModeLifecycleStage();
            })

            // close
            $(this.getCloseButtonLifecycleStage()).on('click', (e) => {
                this.closeEditModeLifecycleStage();
            });

            // Click để lưu thay đổi
            $(this.getInputControlLifecycleStage()).on('change', (e) => {
                this.save(function() {
                    //
                    ASTool.alert({
                        message: 'Đã cập nhật Lead Status thành công!',
                        ok: function() {
                            // close box
                            _this.closeEditModeLifecycleStage();
                        }
                    });
                });
            });
