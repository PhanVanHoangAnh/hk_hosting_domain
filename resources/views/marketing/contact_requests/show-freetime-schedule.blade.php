...
<form id="popupFreeTimeUniqId" tabindex="-1">
    ...
    <div class="scroll-y pe-7 py-10 px-lg-17"  data-kt-scroll-offset="300px">
        @if ($contactRequest->freetimes->count())
        <div class="table-responsive">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="dtHorizontalVerticalOrder">
                ...
                <tbody class="text-gray-600">
                    @foreach($contactRequest->freetimes as $freetime)
                        <tr>
                            <td>
                            ...
                            <td class="text-left">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        href="{{ action(
                                            [App\Http\Controllers\Edu\StaffController::class, 'deleteFreeTime'],
                                            [
                                                'id' => $freetime->id,
                                            ],
                                        ) }}">Xóa</a>
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        class="fs-6 fw-bold btn btn-info btn-outline-secondary btn-sm fs-4"
                                        href="{{ action(
                                            [App\Http\Controllers\Marketing\ContactRequestController::class, 'editFreetimeSchedule'],
                                            [
                                                'id' => $freetime->id,
                                            ],
                                        ) }}">Chỉnh sửa</a>
        ...
        <div class="row">
            @if(isset($contactRequest) && $contactRequest->freeTimes->count() > 0)
            @php
                ...
                var Calendar = class {
                    constructor(options) {
                        ...
                        this.dateData = {
                            ...
                            events: JSON.parse('{!! json_encode($contactRequest->getFreeTimeSections()) !!}')
                        };
        ...
        <div class="d-flex bd-highlight">
            <div class="p-2 flex-grow-1 bd-highlight">
                <a href="{{ action(
                    [App\Http\Controllers\Marketing\ContactRequestController::class, 'createFreetimeSchedule'],
                    [
