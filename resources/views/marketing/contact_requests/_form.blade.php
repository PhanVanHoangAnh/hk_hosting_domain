<div class="scroll-y pe-7 py-10 px-lg-17">
    ...
    <div class="fv-row mb-7">
        ...
        @include('helpers.contactSelector', [
            'name' => 'contact_id',
            'url' => action('App\Http\Controllers\Marketing\ContactController@select2'),
            ...
            'createUrl' => action('\App\Http\Controllers\Marketing\ContactController@create'),
            'editUrl' => action('\App\Http\Controllers\Marketing\ContactController@edit', 'CONTACT_ID'),
        ])
    ...
    <script>
        ...
        var FreeTimeManager = class {
            ...
            getAddEventPopupForm(row, cell) {
                ...
                <form class="modal-dialog modal-lg modal-{{ $size ?? '' }} modal-dialog-centered modal " tabindex="-1" 
                role="dialog" id="input-schedule-{{ $formId }}" aria-hidden="true">
                        ...
                        <div class="modal-dialog modal-dialog-centered" style="width: 500px">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" onclick="closeModal()" aria-label="Close">
                                ...
                                <div class="modal-body">
                                    <div class="form-outline">
                                        ...
                                        <div class="d-flex align-items-center date-with-clear-button">
                                            <input free-time-control="start-at-value" id="start-at" type="time" data-control="input" class="form-control"
                                                name="start_at" placeholder=""  required="required" />
                                    ...
                                    <div class="form-outline py-3">
                                        ...
                                        <div class="d-flex align-items-center date-with-clear-button">
                                            <input free-time-control="end-at-value" id="end-at" type="time" data-control="input" class="form-control"
                                                name="end_at" placeholder="" required/>
