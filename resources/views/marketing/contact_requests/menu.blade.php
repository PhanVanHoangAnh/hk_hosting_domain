...
<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
    ...
    <li class="nav-item mt-2 px-2">
        <a data-action="under-construction"
            ...
            href="{{ action(
                [App\Http\Controllers\Marketing\ContactRequestController::class, 'debt'],
                [
                    'id' => $contactRequest->id,
                ],
            ) }}">
    ...
    <li class="nav-item mt-2 px-2">
        <a data-action="under-construction"
            ...
            href="{{ action(
                [App\Http\Controllers\Marketing\ContactRequestController::class, 'contract'],
                [
                    'id' => $contactRequest->id,
                ],
            ) }}">
    ...
    <li class="nav-item mt-2 px-2">
        <a data-action="under-construction"
            ...
            href="{{ action(
                [App\Http\Controllers\Marketing\ContactRequestController::class, 'education'],
                [
                    'id' => $contactRequest->id,
                ],
            ) }}">
    ...
    <li class="nav-item mt-2 px-2">
        <a data-action="under-construction"
            ...
            href="{{ action(
                [App\Http\Controllers\Marketing\ContactRequestController::class, 'studyAbroad'],
                [
                    'id' => $contactRequest->id,
                ],
            ) }}">
    ...
    <li class="nav-item mt-2 px-2">
        <a data-action="under-construction"
            ...
            href="{{ action(
                [App\Http\Controllers\Marketing\ContactRequestController::class, 'extraActivity'],
                [
                    'id' => $contactRequest->id,
                ],
            ) }}">
    ...
    <li class="nav-item mt-2 px-2">
        <a data-action="under-construction"
            ...
            href="{{ action(
                [App\Http\Controllers\Marketing\ContactRequestController::class, 'kidTech'],
                [
                    'id' => $contactRequest->id,
                ],
            ) }}">
