    ...
    <div class="post" id="kt_post">
        ...
        <div class="card mb-5 mb-xl-10">
            <div class="card-body pt-9 pb-0">
                <!--begin::Details-->
                @include('marketing.contact_requests.detail', [
                    'detail' => 'show',
                ])
                <!--end::Details-->

                @include('marketing.contact_requests.menu', [
                    'menu' => 'show',
                ])
            ...
            <div class="card-body p-9" id="ContactRequestsInformation">
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-4 d-flex align-items-center">
                        <span class="fw-semibold fs-6 text-gray-800 me-2">{{ $contactRequest->contact->displayPhoneNumberByUser(Auth::user()) }}</span>
                ...
                buttonDeleteCustom.addEventListener('click', (e) => {
                    ...
                    ASTool.confirm({
                        ...
                        ok: () => {
                            ...
                            $.ajax({
                                url: "/marketing/contact_requests/" + contactRequestId,
                                method: 'DELETE',
                                data: {
                                    _token: "{{ csrf_token() }}"
                                }
                                ...
                                ASTool.alert({
                                    ...
                                    ok: () => {
                                        window.location.href =
                                            "{{ action('\App\Http\Controllers\Marketing\ContactRequestController@index') }}";
                                    }
                                });
                            }).fail(() => {
                                // Handle failure
            ...
            return {
                init: function() {
                    ...
                    popupHandoverContactRequest = new Popup({
                        url: "{{ action('App\Http\Controllers\Marketing\ContactRequestController@addHandover', ['id' => $contactRequest->id]) }}",
                    });
            ...
            return {
                init: function() {
                    ...
                    popupEditContactRequest = new Popup({
                        url: "{{ action('App\Http\Controllers\Marketing\ContactRequestController@edit', ['id' => $contactRequest->id]) }}",
                    });
