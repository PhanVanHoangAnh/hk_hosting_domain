            ...
            <tbody>
                @foreach ($contacts as $contact)
                    <tr>
                        ...
                        <td class="{{ App\Helpers\Functions::camparePhones(request()->phone, $contact->displayPhoneNumberByUser(Auth::user())) ? 'bg-light-warning' : '' }}">
                            <span class="d-flex align-items-center">
                                <span class="material-symbols-rounded me-2 small">
                                    call
                                </span>
                                <span>{{ $contact->displayPhoneNumberByUser(Auth::user()) }}</span>
                            </span>
                        </td>
                        <td>
                            <div class="text-end">
