...
<script>
    $(document).ready(function() {
        ...
        new RelatedContactManager({
            form: $('#{{ $formId }}'),
            url: "{!! action('\App\Http\Controllers\Marketing\ContactController@relatedContactsBox', [
        ...
        events() {
            this.getUpdateButtons().forEach(button => {
                button.addEventListener('click', (e) => {
                    ...
                    if (id) {
                        var url =
                            "{{ action([\App\Http\Controllers\Marketing\ContactController::class, 'edit'], ['id' => ':id']) }}";
