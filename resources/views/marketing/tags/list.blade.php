                ...
                <tbody class="text-gray-600">
                    @foreach ($tags as $tag)
                        <tr list-control="item">
                            ...
                            @endif
                            @if (in_array('account_id', $columns) || in_array('all', $columns))
                                <td data-column="account_id" class="text-left">
                                    @php
                            ...
                            <td data-column="action">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a row-action="update"
                                            href="{{ action(
                                                [App\Http\Controllers\Marketing\TagController::class, 'edit'],
                                                [
                                                    'id' => $tag->id,
                                                ],
                                            ) }}"
                                    ...
                                    <div class="menu-item px-3">
                                        <a row-action="delete"
                                            href="{{ action([App\Http\Controllers\Marketing\TagController::class, 'destroy'], ['id' => $tag->id]) }}"
    ...
    @else
        <div class="py-15">
            ...
            <p class="fs-4 text-center mb-5">
                Chưa có thông tin tag!
            </p>
            <p class="text-center">
                <a row-action="create" id="buttonCreateTagList" class="btn btn-outline btn-outline-default">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#buttonCreateTagList").on('click', function(e) {
            let buttonCreateTag = document.getElementById('buttonCreateTag');
