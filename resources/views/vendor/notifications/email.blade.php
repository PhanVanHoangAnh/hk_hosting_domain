...
@section('content')
    ...
    <p
        ...
        Bạn nhận được email này vì lý do ASMS được yêu cầu khôi phục lại mật khẩu tài khoản.</p>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                                                    <a href="{{ $url }}"
                                                        class="m_-8964627225826320569button" rel="noopener"
                                                        ...
                                                        target="_blank"
                                                        data-saferedirecturl="">Khôi phục mật khẩu</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
    ...
    <p
        style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
        Đường dẫn khôi phục mật khẩu chỉ có hiệu lực trong 60 phút.</p>
    <p
        style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
        Nếu bạn không phải là người yêu cầu khôi phục mật khẩu, vui lòng bỏ qua email này.</p>
    <p
        style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
        Thân ái,<br>
        ASMS</p>
