            ...
            <div class="table-responsive">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a  row-action="update-application-school" class="menu-link px-3"
                                                    href="{{ action([App\Http\Controllers\Student\AbroadController::class, 'updateApplicationSchool'], ['id' => $applicationSchool->id,]) }}">
                                                    Chỉnh sửa
                                                </a>
                                            </div>
                                        </div>
                ...
                <div class="d-flex bd-highlight">
                    <div class="p-2 flex-grow-1 bd-highlight d-none">
                        <a href="{{ action(
                            [App\Http\Controllers\Student\AbroadController::class, 'createApplicationSchool'],
                            [
                    ...
                    <div class="p-2 bd-highlight">
                        <a href="{{ action(
                            [App\Http\Controllers\Student\AbroadController::class, 'updateActiveApplicationSchool'],
                            [
                                'id' => $abroadApplication->id,
                            ],
                        ) }}"
