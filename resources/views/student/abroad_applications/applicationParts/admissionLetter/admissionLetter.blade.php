        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1">
                    ...
                    <button value="admission_letter" action-control="admission_letter" type="button" class="badge badge-success d-none {{ $abroadApplication->isDoneRecruitmentResults() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="manager-container" >
        ...
        <div class="row">
            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                <input type="date" value="{{$dayFinish->admission_letter ?? ''}}" name="admission_letter" class="form-control pe-none">
            </div>
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-none">
                ...
                href="{{ action(
                    [App\Http\Controllers\Student\AbroadController::class, 'createAdmissionLetter'],
                    [
            ...
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                ...
                href="{{ action(
                    [App\Http\Controllers\Student\AbroadController::class, 'showRecruitmentResults'],
                    [
                        'id' => $abroadApplication->id,
                    ],
                ) }}">Xem</a>
...
{{-- <div class="row">
    ...
    <div class="col-md-10" form-data="admission-letter-manager-container"
        data-upload-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'storeAdmissionLetter'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'deleteAdmissionLetter'], ['id' => $abroadApplication->id]) }}">
