...
<div class="row" id="student_cv">
        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1">
                    ...
                    <button value="student_cv" action-control="student_cv" type="button" class="badge badge-success d-none {{ $abroadApplication->isDoneCV() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="cv-manager-container" 
        data-upload-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'storeCV'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'deleteCV'], ['id' => $abroadApplication->id]) }}">
        ...
        <div class="row d-flex justify-content-around">
            {{-- Date input --}}
            <div class="col-md-4">
                <input type="date" value="{{$dayFinish->student_cv ?? ''}}" name="student_cv" class="form-control pe-none">
            </div>
            {{-- Draft form --}}
            <div class="col-md-8">
...
<script>
    ...
    var Manager = class {
        ...
        getCVFileElements() {
            return this.getContainer().find('[data-control="cv-file"]').toArray();
        }
        ...
        getUpLoadCVBtn() {
            return this.getContainer().find('[action-control="upload-cv-btn"]');
        }

        getCVInput() {
            return this.getContainer().find('[action-control="cv-input"]');
        }
