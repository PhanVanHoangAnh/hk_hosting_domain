...
<div class="row" id="recommendationLetterScreenId">
    ...
    <div class="col-md-9" form-data="manager-container" 
        data-upload-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'storeRecommendationLetter'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'deleteRecommendationLetter'], ['id' => $abroadApplication->id]) }}">
