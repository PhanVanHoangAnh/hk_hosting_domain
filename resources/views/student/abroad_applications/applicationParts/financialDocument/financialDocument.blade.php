<div class="row" id="financial_document">
    ...
    <div class="col-md-9" form-data="financial-document-manager-container" 
        data-upload-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'storeFinancialDocument'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'deleteFinancialDocument'], ['id' => $abroadApplication->id]) }}">
