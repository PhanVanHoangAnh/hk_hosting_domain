            ...
            <div class="fw-semibold">
               Hoạt động ngoại khoá
                <div class="mt-1">
                    ...
                    <button value="extracurricular_activity" action-control="extracurricular_activity" type="button" class="badge badge-success d-none {{ $abroadApplication->isDoneExtracurricularActivity() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="extracurricular-plan-manager-container">
        ...
        <div class="row">
            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                <input type="date" value="{{$dayFinish->extracurricular_activity ?? ''}}" name="extracurricular_activity" class="form-control pe-none">
            </div>
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-none">
                <button action-control="extracurricular-activity-declare" data-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'extracurricularActivityDeclaration'], ['id' => $abroadApplication->id,]) }}" class="btn btn-info w-100">Kê khai</button>
            </div>
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                <button action-control="extracurricular-activity-show" data-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'extracurricularActivityShow'], ['id' => $abroadApplication->id]) }}" class="btn btn-secondary w-100">Xem</button>
            </div>
        </div>
