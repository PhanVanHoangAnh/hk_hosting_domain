    ...
    <div class="col-md-9" form-data="strategic-learning-curriculum-container">
        ...
        <div class="row">
            ...
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-none">
                <button action-control="declare" value="lo_trinh_ht_cl" data-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'declareStrategicLearningCurriculum'], ['id' => $abroadApplication->id]) }}" class="btn {{$checkFill ? 'btn-info': 'btn-info'}} w-100">{{$checkFill ? 'Cập nhật' : 'Kê khai'}}</button>
            </div>
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                <button action-control="view-declaration" data-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'viewStrategicLearningCurriculum'], ['id' => $abroadApplication->id]) }}" class="btn btn-secondary w-100">Xem</button>
            </div>
        </div>
