            ...
            <div class="fw-semibold">
               Kế hoạch ngoại khoá
                <div class="mt-1">
                    ...
                    <button value="extracurricular_schedule" action-control="extracurricular_schedule" type="button" class="badge badge-success d-none {{ $abroadApplication->isDoneExtracurricularSchedule() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="extracurricular-plan-manager-container">
        ...
        <div class="row">
            <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                <input type="date" value="{{$dayFinish->extracurricular_schedule ?? ''}}" name="extracurricular_schedule" class="form-control pe-none">
            </div>
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-none">
                <button action-control="extracurricular-schedule-declare" data-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'extracurricularScheduleDeclaration'], ['id' => $abroadApplication->id,]) }}" class="btn {{$checkFill ? 'btn-info': 'btn-info'}} w-100">{{$checkFill ? 'Cập nhật' : 'Kê khai'}}</button>
            </div>
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                <button action-control="extracurricular-schedule-show" data-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'extracurricularScheduleShow'], ['id' => $abroadApplication->id]) }}" class="btn btn-secondary w-100">Xem</button>
            </div>
        </div>
