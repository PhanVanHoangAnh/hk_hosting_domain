            ...
            <div class="table-responsive">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a row-action="update-certification"
                                                ...
                                                href="{{ action(
                                                    [App\Http\Controllers\Student\AbroadController::class, 'updateCertification'],
                                                    [
                                                        'id' => $certification->id,
                                                    ],
                                                ) }}">
                ...
                <div class="d-flex bd-highlight">
                    <div class="p-2 flex-grow-1 bd-highlight">
                        <a href="{{ action(
                            [App\Http\Controllers\Student\AbroadController::class, 'createCertifications'],
                            [
                    ...
                    <div class="p-2 bd-highlight">
                        <a href="{{ action(
                            [App\Http\Controllers\Student\AbroadController::class, 'updateActiveCertification'],
                            [
                                'id' => $abroadApplication->id,
                            ],
                        ) }}"
