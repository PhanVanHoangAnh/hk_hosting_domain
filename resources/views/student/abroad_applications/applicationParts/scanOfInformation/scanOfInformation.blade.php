<div class="row" id="scan_of_information">
        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1">
                    ...
                    <button value="scan_of_information" action-control="scan_of_information" type="button" class="badge badge-success d-none {{ $abroadApplication->isDoneScanOfInformation() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="scan-of-information-manager-container"
        data-upload-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'storeScanOfInformation'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'deleteScanOfInformation'], ['id' => $abroadApplication->id]) }}">
        ...
        <div class="row d-flex justify-content-around">
            {{-- Date input --}}
            <div class="col-md-4">
                <input type="date" value="{{$dayFinish->scan_of_information ?? ''}}" name="scan_of_information" class="form-control pe-none">
            </div>
            {{-- Draft form --}}
            <div class="col-md-8">
...
<script>
    ...
    var Manager = class {
        ...
        getScanOfInformationFileElements() {
            return this.getContainer().find('[data-control="scan-of-information-file"]').toArray();
        }
        ...
        getUpLoadScanOfInformationBtn() {
            return this.getContainer().find('[action-control="upload-scan-of-information-btn"]');
        }

        getScanOfInformationInput() {
            return this.getContainer().find('[action-control="scan-of-information-input"]');
        }
