            ...
            <form  id="tableApplicationSubmission" tabindex="-1">
                ...
                <div class="table-responsive">
                            ...
                            <tr>
                                ...
                                <td class="min-w-125px text-left">
                                    <div class="col-md-3 ps-0 d-flex justify-content-start align-items-center">
                                        ...
                                        href="{{ action(
                                            [App\Http\Controllers\Student\AbroadController::class, 'editApplicationSubmission'],
                                            [
                    ...
                    <div class="d-flex justify-content-end align-items-center mt-3">
                        <!--begin::Button-->
                        <a href="{{ action(
                            [App\Http\Controllers\Student\AbroadController::class, 'createApplicationSubmission'],
                            [
