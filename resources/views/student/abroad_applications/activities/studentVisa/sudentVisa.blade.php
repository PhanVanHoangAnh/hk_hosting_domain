<div class="row">
    ...
    <div class="col-md-9" form-data="student-visa-manager-container"
        data-upload-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'storeStudentVisaFile'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Student\AbroadController::class, 'deleteStudentVisaFile'], ['id' => $abroadApplication->id]) }}">
        <div class="row d-flex justify-content-around">
            <div class="col-md-4">
                <label class="fs-6 fw-bold fs-4 d-none">
        ...
        <form form-data="student-visa-form" method="POST"
            action="{{ action([App\Http\Controllers\Student\AbroadController::class, 'updateStudentVisaData'], ['id' => $abroadApplication->id]) }}"
            class="row d-flex justify-content-around">
            @csrf
            <div class="col-md-4">
                <span class="badge badge-secondary">{{ trans('messages.student_visa.' . $abroadApplication->student_visa_status) }}</span>
            </div>
            <div class="col-md-8">
