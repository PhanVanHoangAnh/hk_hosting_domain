        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1"> 
                    ...
                    <button value="cultural_orientation" action-control="cultural_orientation" type="button" class="badge badge-success d-none {{ $abroadApplication->isDoneCulturalOrientation() || isset($culturalOrientation)  ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a row-action="update-cultural-orientation"
                                                    ...
                                                    href="{{ action(
                                                        [App\Http\Controllers\Student\AbroadController::class, 'updateCulturalOrientation'],
                    ...
                    @endif
                        ...
                        <p class="fs-4 text-center mb-5 text-danger mt-10 d-none">
                            ...
                            <div class="d-flex justify-content-end align-items-center mt-3 d-none">
                                <!--begin::Button-->
                                <a href="{{ action(
                                    [App\Http\Controllers\Student\AbroadController::class, 'createCulturalOrientation'],
                                    [
