...
<div class="row">
    ...
    >
        ...
        <form form-data="deposit-form" method="POST" action="{{ action([App\Http\Controllers\Student\AbroadController::class, 'updateDepositData'], ['id' => $abroadApplication->id]) }}" class="row d-flex justify-content-around">
            @csrf
            <div class="col-md-4">
