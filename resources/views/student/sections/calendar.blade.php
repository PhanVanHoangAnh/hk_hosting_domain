                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a row-action="delete-all" href="{{ action([App\Http\Controllers\Student\SectionController::class, 'deleteAll']) }}"
                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-3 mb-5">
                            ...
                            @include('helpers.contactSelector', [
                                'name' => 'contact_id',
                                'url' => action('App\Http\Controllers\Student\StudentController@select2'),
                                'controlParent' => '#SectionIndexContainer',
                                'placeholder' => 'Tìm học viên từ hệ thống',
                                'value' => null,
                                'text' => null,
                                'createUrl' => action('\App\Http\Controllers\Student\StudentController@create'),
                                'editUrl' => action('\App\Http\Controllers\Student\StudentController@edit', 'CONTACT_ID'),
                                'notAdd' => true,
                                'notEdit' => true,
                                'multiple' => true,
                            ])
    ...
    <script>
        ...
        let SectionsList = function() {
            ...
            return {
                init: () => {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Student\SectionController@eduCalendarContent') }}",
                    ...
                    this.getDeleteAllItemsBtn().addEventListener('click', function() {
                        ...
                        ASTool.confirm({
                            ...
                            ok: function() {
                                ...
                                $.ajax({
                                    url: "{{ action('\App\Http\Controllers\Student\SectionController@deleteAll') }}",
                                    method: "DELETE",
                                    data: {
                                        _token: "{{ csrf_token() }}",
                                        items: items
