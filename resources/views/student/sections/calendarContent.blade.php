<div class="position-relative" id="kt_post">
    <div id="sectionsCalendarContent">
...
<script>
    ...
    $(() => {
        calendar = new Calendar({
            container: document.querySelector('#sectionsCalendarContent'),
            isShowCode: {{ isset($showCourseCode) ? true : false }}
        });
    })
    ...
    var Calendar = class {
        constructor(options) {
            ...
            this.isShowCode = options.isShowCode;
            this.dateData = {
        ...
        render() {
            const _this = this;
            const data = {};
            const eventsByMonth = this.getEventByMonth(this.dateData.events); // This method to improve performance

            data.events = JSON.stringify(eventsByMonth);
            data._token = "{{ csrf_token() }}";
            data.date = this.dateData.date;
            data.isShowCode = this.isShowCode;
