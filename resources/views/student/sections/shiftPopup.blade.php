            ...
            events() {
                ...
                _this.container.addEventListener('submit', function(e) {
                    ...
                    const actionWhenStudied =
                        "{{ action([App\Http\Controllers\Student\SectionController::class, 'saveAttendancePopup'], ['id' => $section->id]) }}";
                    const actionWhenCancelled =
                        "{{ action([App\Http\Controllers\Student\SectionController::class, 'saveShift'], ['id' => $section->id]) }}";
