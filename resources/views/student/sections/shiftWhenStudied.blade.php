                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                                ...
                                                <div
                                                    ...
                                                    <a data-ids-delete="{{ $section->id }}"
                                                        href="{{ action(
                                                            [App\Http\Controllers\Student\SectionReportsController::class, 'create'],
                                                            [
                                                                'id' => $section->id,
                                                ...
                                                <div class="menu-item px-3  ">
                                                    ...
                                                    <a data-ids-delete="{{ $section->id }}"
                                                        href="{{ action(
                                                            [App\Http\Controllers\Student\SectionReportsController::class, 'edit'],
                                                            [
                                                                'id' => $section->id,
                                                                'contact_id' => $student->student->id,
                                                            ],
                                                ...
                                                <div class="menu-item px-3  ">
                                                    ...
                                                    <a data-ids-delete="{{ $section->id }}"
                                                        ...
                                                        href="{{ action(
                                                            [App\Http\Controllers\Student\SectionReportsController::class, 'destroy'],
