                            ...
                            <div class="d-flex ">
                                <div class="card-header py-0">
                                    <div class="card-title d-flex flex-column ">
                                        <div class="d-flex align-items-top">
                                            <div>
                                                <span
                                                    class="fs-1 fw-semibold text-info">{{ App\Helpers\Functions::formatNumber($paymentRemindersReachingDueDateSumAmount) }}₫</span>
                                                <span
                                ...
                                <div class="d-flex pe-3">
                                    <div class=" me-0 mb-0 ps-5">
                                        <span class="fs-5 fw-semibold"> {{ $paymentRemindersReachingDueDateCount }}
                                            khoản</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-header pt-3 border-0 ps-5">
                        <div class="card-title d-flex flex-column">
                            <div class="d-flex ">
                                <div class="card-header py-0">
                                    <div class="card-title d-flex flex-column ">
                                        <div class="d-flex align-items-top">
                                            <div>
                                                <span
                                                    class="fs-1 fw-semibold text-info">{{ App\Helpers\Functions::formatNumber($paymentRemindersPaidSumAmount) }}₫</span>
                                                <span
                                ...
                                <div class="d-flex pe-3">
                                    <div class=" me-0 mb-0 ps-5">
                                        <span class="fs-5 fw-semibold"> {{ $paymentRemindersPaidCount }} khoản</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-title d-flex flex-column">
                            <div class="d-flex ">
                                <div class="card-header py-0">
                                    <div class="card-title d-flex flex-column ">
                                        <div class="d-flex align-items-top">
                                            <div>
                                                <span
                                                    class="fs-1 fw-semibold text-info">{{ App\Helpers\Functions::formatNumber($paymentRemindersOutDueDateSumAmount) }}₫</span>
                                                <span
                                ...
                                <div class="d-flex pe-3 align-items-top">
                                    <div class=" me-0 mb-0 ps-5">
                                        <span class="fs-5 fw-semibold"> {{ $paymentRemindersOutDateCount }} khoản</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <thead>
                    ...
                    @endif
                        ...
                        @if (in_array('cache_total', $columns) || in_array('all', $columns))
                            <th list-action="sort" sort-by="cache_total"
                                sort-direction="{{ $sortColumn == 'cache_total' && $sortDirection ? $sortDirection : 'desc' }}"
                                class="min-w-100px fs-8" data-column="cache_total">
                                <span>
                                    Tổng giá trị hợp đồng
                                </span>
                                <span
                                    class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'cache_total' ? '' : 'text-muted' }}">
                                    sort
                                </span>
                            </th>
                        @endif
                        ...
                        <tr list-control="item">
                            ...
                            @if (in_array('remain_amount', $columns) || in_array('all', $columns))
                                <td data-filter="mastercard" data-column="remain_amount">
                                    {{ App\Helpers\Functions::formatNumber($paymentReminder->getReceivableAmount()) }}₫
                            ...
                            @if (in_array('status', $columns) || in_array('all', $columns))
                                <td data-filter="mastercard" data-column="status">
                                    ...
                                    <span title="{{ $paymentReminder->getStatus() }}"
                                        class="badge bg-{{ $bgs[$paymentReminder->getStatus()] ?? 'info' }}"
                                        data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click"
                                        data-bs-placement="right">
                                        {{ trans('messages.payment_reminders.status.' . $paymentReminder->getStatus()) }}
                            ...
                            <td class="text-left">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4  "
                                    ...
                                    <div class="menu-item px-3 " >
                                        <a 
                                        href="{{ action(
                                            [App\Http\Controllers\Student\OnePayController::class, 'onepayPayment'],
                                            ['amount' => $paymentReminder->getDebtAmountInProgress(), 'id' => $paymentReminder->order->id]
                                        ) }}" 
                                        data-bs-toggle="tooltip" data-bs-placement="top" 
                                             class="menu-link px-3 {{  $paymentReminder->getStatus() == App\Models\PaymentReminder::STATUS_PAID ? 'd-none' : '' }}"
                                            title="{{$paymentReminder->getStatus() == App\Models\PaymentReminder::STATUS_PAID ? 'Đã thanh toán' : '' }}"
                                            >
                                            Thanh toán (OnePay)</a>
                                    </div>
