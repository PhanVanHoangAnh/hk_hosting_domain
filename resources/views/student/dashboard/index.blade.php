        ...
        <div class="d-flex align-items-center w-100">
            <div>
                ...
                <h1 class="d-flex align-items-center my-0">
                    <span class="text-dark fw-bold fs-2">Student Dashboard</span>
                </h1>
                <!--end::Title-->
            </div>
        </div>
        ...
        <div class="card h-md-100" dir="ltr"> 
            ...
            <div class="card-body px-7 pt-5" style="height:370px!important;overflow-y:auto;">  
                ...
                {{-- @foreach (Auth::user()->notifications as $notification)
                    ...
                    @endforeach --}}
                    @foreach (Auth::user()->getStudent()->getLast20NoteLogs() as $noteLog)
                        <div class="alert alert-info d-flex align-items-center p-5 mb-5 w-100">
                            <i class="ki-duotone ki-shield-tick fs-2hx text-primary me-4"><span class="path1"></span><span class="path2"></span></i>                    <div class="d-flex flex-column w-100">
                                <div class="d-flex algin-items-center w-100">
                                    <div>
                                    ...
                                    <div class="ms-auto">
                                        <span class="d-flex align-items-center">
                                            ...
                                            <span>{{ $noteLog->created_at->diffForHumans() }}</span>
                                        </span>
                                    </div>
                                </div>
                                <div>{!! $noteLog->content !!}</div>
                            </div>
                        </div>
                    @endforeach

                    @if (!Auth::user()->getStudent()->getLast20NoteLogs()->count())
                        <div class="card-body">
                            <div class="py-5">
                            ...
                            <div class="d-flex align-items-top">
                                <div>
                                    ...
                                    <span  class="fs-1 fw-semibold">
                                        {{ App\Models\Contact::whichHasCousrse(Auth::user()->getStudent()->id) }} lớp</span>
                                    <!--end::Amount-->
                                    <span class="d-block text-gray-400 fw-semibold fs-6">Đã xếp lớp</span>
                                    <!--end::Badge-->
                                </div>
                            </div>
                            <!--end::Info-->
                        ...
                        <div class="card-title d-flex flex-column ">
                            ...
                            <div class="d-flex align-items-top">
                                <div>
                                    <!--begin::Amount-->
                                    <span class="fs-1 fw-semibold"> 
                                        {{ Auth::user()->getStudent()->whichHaDoesntCousrse(Auth::user()->getStudent()->id) }} lớp</span>
                                    <!--end::Amount-->
                        ...
                        <div class="card-title d-flex flex-column ">
                            ...
                            <div class="d-flex align-items-top">
                                <div>
                                    <!--begin::Amount-->
                                    <span class="fs-1 fw-semibold">
                                        {{ Auth::user()->getStudent()->whichCourseFinish(Auth::user()->getStudent()->id)->count() }} lớp</span>
                                    <!--end::Amount-->
                                    <span class="d-block text-gray-400 fw-semibold fs-6">Học xong</span>
                                    <!--end::Badge-->
                                </div>
                            </div>
                            <!--end::Info-->
                        ...
                        <div class="card-title d-flex flex-column ">
                            ...
                            <div class="d-flex align-items-top">
                                <div>
                                    <!--begin::Amount-->
                                    <span class="fs-1 fw-semibold">
                                        {{ Auth::user()->getStudent()->getReserveCoursesCount() }} lớp</span>
                                    <!--end::Amount-->
    ...
    <div class="row g-5 g-xl-6 mb-5 mb-xl-6" >
        ...
        <div class="col-xl-8">
            ...
            <div style="height: 300px" class="mb-6  ">
                @include('student.dashboard.module1')
            </div>
            <div class="row" >
                <!--begin::Col-->
                
                <div class="col-xl-6"  style="height: 264px">
                    @include('student.dashboard.module2')
                </div>
                <div class="col-xl-6"  style="height: 264px">
                    @include('student.dashboard.module3')
                </div>
                <!--end::Col-->
            </div>
        </div>
        ...
        <div class="col-xl-4" style="height: 583px">
            @include('student.dashboard.module4')
        </div>
