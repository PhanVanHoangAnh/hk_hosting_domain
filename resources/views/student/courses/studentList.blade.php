                        ...
                        <td data-column="action">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ action(
                                        [App\Http\Controllers\Student\StudentController::class, 'show'],
                                        [
                                ...
                                <div class="menu-item px-3 d-none">
                                    <a row-action="update"
                                        href="{{ action(
                                            [App\Http\Controllers\Student\StudentController::class, 'edit'],
                                            [
                                                'id' => $student->student->id,
                                            ],
                                        ) }}"
                                ...
                                <div class="menu-item px-3 text-start d-none">
                                    <a row-action="note-logs-customer"
                                        href="{{ action(
                                            [App\Http\Controllers\Student\StudentController::class, 'noteLogsPopup'],
                                            [
                                                'id' => $student->student->id,
                                            ],
                                        ) }}"
                                ...
                                <div class="menu-item px-3 d-none">
                                    <a row-action="delete"
                                        href="{{ action(
                                            [App\Http\Controllers\Student\StudentController::class, 'destroy'],
                                            [
                                                'id' => $student->student->id,
                                            ],
                                        ) }}"
