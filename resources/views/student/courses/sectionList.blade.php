                            ...
                            <td class="text-left">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a row-action="update"
                                            href="{{ action(
                                                [App\Http\Controllers\Student\CourseController::class, 'attendancePopup'],
                                                [
                                                    'id' => $section->id,
                                                ],
                                            ) }}"
                                    ...
                                    <div
                                        ...
                                        <a href="{{ action(
                                            [App\Http\Controllers\Student\CourseController::class, 'reschedulePopup'],
                                            [
                                                'id' => $section->id,
                                            ],
                                        ) }}"
                                    ...
                                    <div
                                        class="menu-item px-3 {{ $section->checkStatusSectionCalendar() === App\Models\Section::COMPLETED_STATUS ? 'd-none' : '' }}">
                                        <a href="{{ action(
                                            [App\Http\Controllers\Student\SectionController::class, 'changeTeacherPopup'],
                                            [
                                                'id' => $section->id,
                                            ],
                                        ) }}"
                                    ...
                                    <div
                                        ...
                                        <a data-ids-delete="{{ $section->id }}"
                                            ...
                                            href="{{ action(
                                                [App\Http\Controllers\Student\SectionController::class, 'destroy'],
                                                [
                                                    'id' => $section->id,
                                                ],
                                            ) }}"
                                    ...
                                    {{-- <div class="menu-item px-3 {{ $section->checkEndAtSection() ? '' : 'd-none' }}"> --}}
                                    <div class="menu-item px-3">
                                        <a row-action="update"
                                            href="{{ action(
                                                [App\Http\Controllers\Student\SectionController::class, 'shiftPopup'],
                                                [
                                                    'id' => $section->id,
                                                ],
                                            ) }}"
