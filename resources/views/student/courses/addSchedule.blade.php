...
@php
    ...
    $action = action([App\Http\Controllers\Student\CourseController::class, 'createScheduleItem']);

    if(isset($weekEventEdit)) {
        $action = action([App\Http\Controllers\Student\CourseController::class, 'editWeekScheduleItem']);
    }
                ...
                init: function() {
                    document.querySelector('[data-action="suggest-teacher"]').addEventListener('click', e => {
                        ...
                        suggestTeacherPopup.updateUrl(
                            "{{ action('\App\Http\Controllers\Student\CourseController@suggestTeacher') }}"
                        );
                    });
                }
            }
