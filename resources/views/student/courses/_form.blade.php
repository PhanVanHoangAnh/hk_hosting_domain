<h3 class="mt-15 mb-10">Thông tin lớp học</h3>
...
<div id="dataFillForm">
    ...
    <div class="row mb-4" data-container="subject-level">
        ...
        @includeIf('student.courses._subjects_manager')
        ...
        <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 col-12 mb-4 d-none" form-control="location">
            @include('student.courses._location')
        </div>
    ...
    <x-input-error :messages="$errors->get('time_range_validate')" class="mt-2"/>
        ...
        {{-- ZOOM --}}
        <div class="row d-none mb-4" form-control="zoom">
            ...
            <div class="col-lg-2 col-xl-2 col-md-2 col-sm-2 col-2 mb-6 d-flex align-items-end">
                <button button-action="get-link" data-link="{{ action([App\Http\Controllers\Student\CourseController::class, 'getZoomMeetingLink'], ['id' => 1]) }}" class="btn btn-info text-bold">Tạo link phòng học ZOOM</button>
            </div>
        </div>
...
<div class="form-outline d-flex justify-content-center">
    <div class="mb-10">
        ...
        <a href="{{ action('App\Http\Controllers\Student\CourseController@index') }}" id="cancelAddCourseBtn"
