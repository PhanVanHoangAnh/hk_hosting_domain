                ...
                <thead>
                    <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 bg-light text-nowrap">
                        ...
                        @if (in_array('location', $columns) || in_array('location', $columns))
                            <th list-action="sort" sort-by="location"
                                sort-direction="{{ $sortColumn == 'location' && $sortDirection ? $sortDirection : 'desc' }}"
                                ...
                                <span class="d-flex align-items-center">
                                    ...
                                    <span>
                                        <span>
                                            <span
                                                class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'location' ? '' : 'text-muted' }}">
                                                sort
                                            </span>
                                        </span>
                                    </span>
                        ...
                        <tr list-control="item">
                            ...
                            @if (in_array('total_hours', $columns) || in_array('all', $columns))
                                <td data-column="total_hours" class="text-left mb-1 text-nowrap"
                                    data-filter="mastercard">
                                    {{ number_format($course->caculateTotalMinutes(\App\Models\Section::TYPE_GENERAL) / 60, 2) }} giờ
                                </td>
                            @endif
                            ...
                            @if (in_array('test_hours', $columns) || in_array('all', $columns))
                                <td data-column="test_hours" class="text-left mb-1 text-nowrap"
                                    data-filter="mastercard">
                                    {{ number_format($course->caculateTotalMinutes(\App\Models\Section::TYPE_TEST) / 60, 2) }} giờ
                                </td>
                            @endif
                            ...
                            @if (in_array('studied_hours', $columns) || in_array('all', $columns))
                                <td data-column="studied_hours" class="text-left mb-1 text-nowrap"
                                    data-filter="mastercard">
                                    {{ number_format($course->caculateStudiedMinutes() / 60, 2) }} giờ
                                </td>
                            @endif
                            ...
                            @if (in_array('remain_hours', $columns) || in_array('all', $columns))
                                <td data-column="remain_hours" class="text-left mb-1 text-nowrap"
                                    data-filter="mastercard">
                                    {{ number_format($course->caculateUnstudiedMinutes() / 60, 2) }} giờ
                                </td>
                            @endif
                            ...
                            <td class="text-left">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ action(
                                            [App\Http\Controllers\Student\CourseController::class, 'showDetail'],
                                                [
                                                    'id' => $course->id,
                                                ],
                                            ) }}"
                                    ...
                                    <div class="menu-item px-3">
                                        <a data-course-id="{{ $course->id }}" href="{{ action([App\Http\Controllers\Student\CourseController::class, 'add'], ['courseCopyId' => $course->id]) }}"
                                    ...
                                    <div class="menu-item px-3">
                                        <a data-ids-update="{{ $course->id }}"
                                            ...
                                            @else 
                                            href="{{ action(
                                                [App\Http\Controllers\Student\CourseController::class, 'editCalendar'],
                                                [
                                                    'id' => $course->id,
                                                ],
                                            ) }}" @endif
                                    ...
                                    <div
                                        ...
                                        <a data-ids-update="{{ $course->id }}"
                                            href="{{ action(
                                                [App\Http\Controllers\Student\SectionReportsController::class, 'reportSection'],
                                                [
                                                    'id' => $course->id,
                                                ],
                                            ) }}"
                                    ...
                                    <div class="menu-item px-3 ">
                                        <a data-ids-update="{{ $course->id }}"
                                            href="{{ action(
                                                [App\Http\Controllers\Student\CourseController::class, 'courseStopped'],
                                                [
                                                    'id' => $course->id,
                                                ],
                                            ) }}"
                                    ...
                                    <div class="menu-item px-3 ">
                                        <a data-ids-update="{{ $course->id }}"
                                            href="{{ action(
                                                [App\Http\Controllers\Student\CourseController::class, 'assignStudentToClass'],
                                                [
                                                    'id' => $course->id,
                                                ],
                                            ) }}"
                                    ...
                                    <div class="menu-item px-3">
                                        <a data-ids-delete="{{ $course->id }}"
                                            href="{{ action(
                                                [App\Http\Controllers\Student\CourseController::class, 'delete'],
                                                [
                                                    'id' => $course->id,
                                                ],
                                            ) }}"
        ...
        <div class="py-15">
            ...
            <p class="text-center">
                <a list-action="create-constract"
                    href="{{ action([App\Http\Controllers\Student\CourseController::class, 'add']) }}"
