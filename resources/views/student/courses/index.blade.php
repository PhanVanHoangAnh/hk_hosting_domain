    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar" form-index-bar="{{ $uniqBarFormId }}">
        ...
        <div class="d-flex align-items-center py-1">
            @if (Auth::user()->can('create', App\Models\Contact::class))
                <!--begin::Button-->
                <a href="{{ action([App\Http\Controllers\Student\CourseController::class, 'add']) }}"
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a row-action="delete-all"
                                        href="{{ action([App\Http\Controllers\Student\CourseController::class, 'deleteAll']) }}"
    ...
    <script>
        ...
        let CoursesList = function() {
            ...
            return {
                init: () => {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Student\CourseController@list') }}",
                    ...
                    this.getDeleteAllItemsBtn().addEventListener('click', function() {
                        ...
                        ASTool.confirm({
                            ...
                            ok: function() {
                                ...
                                $.ajax({
                                    url: "{{ action('\App\Http\Controllers\Student\CourseController@deleteAll') }}",
                                    method: "DELETE",
                                    data: {
                                        _token: "{{ csrf_token() }}",
                                        items: items
