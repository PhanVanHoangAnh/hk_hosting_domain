...
@section('content')
<form method="POST" id="{{ $formId }}" action="{{ action([App\Http\Controllers\Student\SectionReportsController::class, 'saveReportSectionInCourse'], ['id' => $course->id]) }}">
    @csrf
    <!--begin::Scroll-->
                    ...
                    <script>
                        $(() => {
                            new SectionBox({
                                ...
                                url: '{{ action('\App\Http\Controllers\Student\SectionReportsController@getStudents') }}', getSectionSelectBox: function() {
                        ...
                        $('[list-action="student-select"]').on('change', function () {
                            ...
                            $.ajax({
                                url: '{{ action('\App\Http\Controllers\Student\SectionReportsController@getSectionReportData') }}',
                                type: 'GET',
                                data: {
