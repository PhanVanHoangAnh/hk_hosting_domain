...
<div class="card-body pt-0 mt-5" id="sales-order-list">
                            ...
                            @if (in_array('status', $columns) || in_array('all', $columns))
                                <td data-column="status" class="text-left" data-filter="mastercard">
                                    ...
                                    <a row-action="show" class="menu-link px-3"
                                        href="{{ action(
                                            [App\Http\Controllers\Student\OrderController::class, 'historyRejected'],
                                            [
                                                'id' => $order->id,
                                            ]
                                        ) }}">
                            ...
                            <td class="text-left">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ action(
                                            [App\Http\Controllers\Student\OrderController::class, 'showConstract'],
                                            [
                                                'id' => $order->id,
                                            ],
                                        ) }}"
                                    ...
                                    @if ($order->isApproved() && !$order->isRequestDemo())
                                        <div class="menu-item px-3">
                                            <a row-action="show"
                                                href="{{ action(
                                                    [App\Http\Controllers\Student\OrderController::class, 'showQrCode'],
                                                    [
                                                        'id' => $order->id,
                                                    ]
                                                ) }}"
                                    ...
                                    @if ($order->isApproved() && ($order->isEdu() || $order->isAbroad()))
                                        <div class="menu-item px-3">
                                            <a row-action="show"
                                                href="{{ action(
                                                    [App\Http\Controllers\Student\OnePayController::class, 'createReceipt'],
                                                    [
                                                        'id' => $order->id,
                                                    ]
                                                ) }}"
    ...
    @else
        ...
        <script>
            GENERAL_CONTROLLER_METHOD = `{{ action('\App\Http\Controllers\Student\OrderController@pickContact') }}`;
            REQUEST_DEMO_CONTROLLER_METHOD = `{{ action('\App\Http\Controllers\Student\OrderController@pickContactForRequestDemo') }}`;
