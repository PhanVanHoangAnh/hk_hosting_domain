...
<div class="row" id="{{ $staffTimesManagerContainerUniqId }}">
    <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-8 mt-8">
        ...
        <div id="{{ $trainOrderStaffTimesManagerUniqId }}" form-container="trainOrderStaffTimesManagerUniqId">
            {{-- Discount percent --}}
            <div class="mb-2">
                Giảm giá: <span class="fw-bold" data-form="discountPercent_{{ $trainOrderStaffTimesManagerUniqId }}"></span> %
                ...
                <script>
                    ...
                    document.querySelector('[data-form="discountPercent_{{ $trainOrderStaffTimesManagerUniqId }}"]').innerText = discountPercent;
            ...
            <table class="table table-bordered border-10 w-100">
                ...
                <tbody>
                    ...
                    <tr data-container="foreign-teacher">
                        ...
                        <td class="text-center"><input type="number" value="0" class="form-control border-0 text-center" data-control="hours-per-section" action-control="input" step="1"></td> {{-- Foreign hours per section --}}
                    ...
                    <tr data-container="vn-teacher">
                        ...
                        <td class="text-center"><input type="number" value="0" class="form-control border-0 text-center" data-control="hours-per-section" action-control="input" step="1"></td> {{-- VN hours per section --}}
                    ...
                    <tr data-container="tutor">
                        ...
                        <td class="text-center"><input type="number" value="0" class="form-control border-0 text-center" data-control="hours-per-section" action-control="input" step="1"></td> {{-- Tutor hours per section --}}
        ...
        <script>    
            ...
            var StaffTimesManager = class {
                ...
                getDiscountPercentInput() {
                    return this.container().querySelector('[data-form="discountPercent_{{ $trainOrderStaffTimesManagerUniqId }}"]');
                }
        
                getDiscountPercentValue() {
                    const percent = parseFloat(this.getDiscountPercentInput().innerText);
            ...
            var StaffDataRow = class {
                ...
                reverseRenderOriginalSalary() {
                    const salaryAfterDiscount = parseInt(this.getSalaryAfterDiscountValue().replace(/,/g, ''), 10);
                    const discountPercent = this.getTool().getDiscountPercentValue();
                    const originalPrice = parseInt(salaryAfterDiscount / ((100 - (isNaN(discountPercent) ? 0 : discountPercent)) / 100));

                    this.getSalaryInput().value = originalPrice;
                }

                init() {
                    this.loadSavedData();
                    // this.reverseRenderOriginalSalary();
        ...
        var RevenueToolForm = class {
            ...
            load() {
                const data = {
                    ...
                    revenueDistributions: "{{ isset($revenueData) ? $revenueData : json_encode( isset($orderItem) && $orderItem->revenueDistributions->count() > 0 ? \App\Helpers\RevenueDistribution::processRevenueDistributeList($orderItem->revenueDistributions, $defaultSaleId) : \App\Helpers\RevenueDistribution::getRevenueDataWithDefault($defaultSaleId) ) }}",
                }   
