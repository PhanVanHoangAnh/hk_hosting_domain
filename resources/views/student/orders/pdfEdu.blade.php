...
<body>
    ...
    <table class="info-table">
        ...
        <tr>
            <th>Ngày sinh</th>
            <td>
                {{ $order->student->birthday ? date('d/m/Y', strtotime($contactRequest->contact->bir)) : '--' }}
            </td>
        </tr>
        <tr>
            <th>Số điện thoại</th>
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td >
               <li style="margin-left: 8px;"> Loại hình lớp: {{$orderItem->class_type}}</li>
               <li style="margin-left: 8px;"> Hình thức học: {{$orderItem->study_type}} </li>
            </td>
        </tr>
        @endforeach
