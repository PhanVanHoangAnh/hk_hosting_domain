    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">{{ $screenType == App\Models\Order::TYPE_REQUEST_DEMO ? "Danh sách yêu cầu học thử" : "Danh sách hợp đồng" }}</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ action([App\Http\Controllers\Student\DashboardController::class, 'index']) }}" class="text-muted text-hover-primary">Trang chính</a>
                </li>
                <!--end::Item-->
                <!--begin::Item-->
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">{{ $screenType == App\Models\Order::TYPE_REQUEST_DEMO ? "yêu cầu học thử" : "Hợp đồng" }}</li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-200 w-5px h-2px"></span>
        ...
        <div class="d-flex align-items-center py-1 d-none">
            <button list-action="add-request-demo" class="btn btn-flex btn-sm btn-primary fw-bold border-0 fs-6 h-40px {{ $screenType == App\Models\Order::TYPE_REQUEST_DEMO ? "" : "d-none" }}" id="addRequestDemoBtn">
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a row-action="delete-all" href="{{ action([App\Http\Controllers\Student\OrderController::class, 'deleteAll']) }}"
                ...
                <div class="card-title" list-action="search-action-box">
                    ...
                    <div id="search-form" class="d-flex align-items-center position-relative my-1">
                        ...
                        <input list-action="keyword-input" type="text" data-kt-customer-table-filter="search"
                            class="form-control w-250px ps-12" placeholder="{{ $screenType == App\Models\Order::TYPE_REQUEST_DEMO ? "Tìm yêu cầu học thử..." : "Tìm hợp đồng..." }}" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar" list-action="tool-action-box">
                    ...
                    <div class="d-flex justify-content-end">
                        <div class="justify-content-end me-3">
                            <td class="text-end">
                                <button list-action="export-excel" type="button" class="btn btn-outline btn-outline-default me-2 d-none">
            ...
            <div class="card-header border-0 p-4 pb-0 d-none list-filter-box" list-action="filter-action-box">
                ...
                <div class="card-toolbar w-100 mb-0" list-action="tool-action-box">
                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                            ...
                            <div style="max-height: 200px; overflow-y: auto;">
                                <select list-action="type-select" class="form-select filter-select"
                                    data-control="select2" data-close-on-select="false" data-placeholder="Loại dịch vụ"
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                            <!--begin::Label-->
                            <label class="form-label fw-semibold">Tình trạng hợp đồng</label>
                            <div style="max-height: 200px; overflow-y: auto;">
                                <select list-action="payment-order-status-select" class="form-select filter-select"
                                data-control="select2" data-placeholder="Chọn tình trạng hợp đồng" data-allow-clear="true" multiple="multiple"  >
                        ...
                        <div class="col-md-3 mb-5 d-none">
                            ...
                            <div class="row" list-action="created_at-select">
                                    <div class="form-outline">
                                        <select id="order-filter-student-select" data-control="select2-ajax" data-url="{{ action('App\Http\Controllers\Student\ContactController@select2') }}" class="form-control filter-select"
                        ...
                        <div class="col-md-3 mb-5">
                            ...
                            <div style="max-height: 200px; overflow-y: auto;">
                                <select list-action="order-type-filter-select" class="form-select filter-select"
                                    data-control="select2" data-close-on-select="false" data-placeholder="Chọn loại hợp đồng"
                                    data-allow-clear="true" multiple="multiple">
                                    @foreach (App\Models\Order::getAllTypeVariable() as $type)
                                        <option value="{{ $type }}">{{ trans('messages.order.type.' . $type) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-5">
                            <label class="form-label">Ngày hợp đồng (Từ - Đến)</label>
    ...
    let OrderList = function() {
        ...
        return {
            init: () => {
                ...
                list = new DataList({
                url: `{{ action('\App\Http\Controllers\Student\OrderController@list', ['screenType' => '']) }}${screenType}`,
            ...
            init: () => {
                createOrderBtns.forEach(btn => {
                    btn.addEventListener('click', e => {
                        ...
                        pickContactPopup.updateUrl("{{ action('\App\Http\Controllers\Student\OrderController@pickContact') }}");
                    });
                });
                ...
                createContractForRequestDemoBtn.forEach(btn => {
                    btn.addEventListener('click', e => {
                        ...
                        pickContactPopup.updateUrl("{{ action('\App\Http\Controllers\Student\OrderController@pickContactForRequestDemo') }}");
                    });
                });
            }
        };
                ...
                init: () => {
                    ...
                    $('[list-action="export-excel"]').on('click', function() {
                        ...
                        const query = {
                            ...
                            order_date_from: $('[name="order_date_from"]').val(),
                            order_date_to: $('[name="order_date_to"]').val(),
                            updated_at_from: $('[name="updated_at_from"]').val(),
                            updated_at_to: $('[name="updated_at_to"]').val(),
                            screenType: screenType // Thêm screenType tại đây
                        };
                        
                        $.ajax({
                            url: "{{ action('\App\Http\Controllers\Student\OrderController@export') }}",
                            type: "GET",
                            data: query,
                            xhrFields: {
                                responseType: 'blob' 
            ...
            initContentEvents() {
                ...
                if (this.getNumberOfItems()) {
                    this.getDeleteAllItemsBtn().addEventListener('click', function(e) {
                        ...
                        ASTool.confirm({
                            message: "Bạn có chắc muốn xóa các hợp đồng này không?",
                            ok: function() {
