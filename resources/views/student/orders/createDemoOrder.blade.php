...
@section('title')
{{ !isset($orderItem) ? 'Thêm yêu cầu học thử' : 'Sửa yêu cầu học thử' }}
@endsection
...
<form id="{{ $createDemoOrderItemPopupUniqid }}" tabindex="-1">
    ...
    <div class="scroll-y px-7 py-10 px-lg-17">
        <input class="type-input" type="hidden" name="type" value="{{ App\Models\Order::TYPE_REQUEST_DEMO }}">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-4 mb-2">
                <div class="form-outline">
                    ...
                    <select id="home-room-teacher-select" class="form-select form-control" name="home_room"
                        data-control="select2" data-dropdown-parent="#{{ $createDemoOrderItemPopupUniqid }}" data-placeholder="Chọn chủ nhiệm đề xuất" data-allow-clear="true">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-6 mb-2">
                <div class="form-outline">
                    ...
                    <select id="class-type" class="form-select form-control" name="class_type" data-check-error="{{ $errors->has('class_type') ? 'error' : 'none' }}"
                        data-control="select2" data-dropdown-parent="#{{ $createDemoOrderItemPopupUniqid }}" data-placeholder="Chọn loại hình lớp" data-allow-clear="true">
        ...
        <div class="row mb-4">
            ...
            @include('student.orders._demoStaffTimesManager')
        </div>
        ...
        <div id="demo-container" class="row mb-4 d-none">
            <div id="have-studied-form" class="col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                <div class="form-outline">
                    ...
                    <select id="have-studied-select" class="form-select form-control" name="have_studied" data-control="select2" data-dropdown-parent="#{{ $createDemoOrderItemPopupUniqid }}"
                ...
                <div class="form-outline">
                    ...
                    <div class="row">
                        <div id="has-demo-hour-deduction-box-select" class="col-lg-12 col-xs-12 col-sm-12 col-md-12 col-xl-12 pe-0">
                            <select id="has-demo-hour-deduction" class="form-select form-control" name="has_demo_hour_deduction" data-control="select2" data-dropdown-parent="#{{ $createDemoOrderItemPopupUniqid }}"
                                data-placeholder="Chọn..." data-allow-clear="true">
                                <option value="">Chọn</option>
...
<script>
    $(() => {
        demoFormManage = new DemoFormManage({
            container: () => {
                return document.querySelector('#{{ $createDemoOrderItemPopupUniqid }}');
            }
        });

        if (document.querySelector('#{{ $createDemoOrderItemPopupUniqid }}')) {
