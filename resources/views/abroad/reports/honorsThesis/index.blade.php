...
@section('content')
    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Báo cáo học luận</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Học luận</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
        ...
        <div class="d-flex align-items-center py-1">
            ...
            <div class="me-3" list-action="export-contact" >
                <a type="button" 
                    ...
                    data-kt-menu-placement="bottom-end" data-action="under-construction">
    ...
    <div id="HonorsThesisReportIndexContainer" class="position-relative" id="kt_post">
        <!--begin::Card-->
        <div class="card ">
            <!--begin::Card header-->
        ...
        <!--end::Card header-->
        <div id="HonorsThesisReportIndexListContent">
        </div>
    </div>

    <script>
        $(function() {
            HonorsThesisReportIndex.init();
        });
        //
        var HonorsThesisReportIndex = function() {
            return {
                init: function() {
                    HonorsThesisReportList.init();
                    //
                    FilterData.init();
                    //
                    ExportExcel.init();
            ...
            return {
                init: () => {
                    ...
                    function applyDateFilter() {
                        ...
                        // Gửi phạm vi ngày tạo đến HonorsThesisReportList và tải lại danh sách
                        HonorsThesisReportList.getList().setCreatedAtFrom(fromDate);
                        HonorsThesisReportList.getList().setCreatedAtTo(toDate);
                        HonorsThesisReportList.getList().load();
                    };
                }
            };
        }();

        var HonorsThesisReportList = function() {
            var list;
            
            return {
                init: function() {
                    list = new DataList({
                        url: "{{ action('App\Http\Controllers\Abroad\Report\HonorsThesisReportController@list') }}",
                        container: document.querySelector('#HonorsThesisReportIndexContainer'),
                        listContent: document.querySelector('#HonorsThesisReportIndexListContent'),
                    });
                    list.load();
                },
                getList: function() {
