...
@section('content')
<form method="POST" id="{{ $formId }}" action="{{ action([App\Http\Controllers\Abroad\SectionReportsController::class, 'saveReportSection'], ['id' => $section->id, 'contact_id' => $contact->id]) }}">
    @csrf
    <!--begin::Scroll-->
