                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a row-action="delete-all" href="{{ action([App\Http\Controllers\Abroad\SectionController::class, 'deleteAll']) }}"
                ...
                <div class="card-toolbar w-100 mb-0" list-action="tool-action-box">
                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-4 mb-5">
                            ...
                            <select list-action="course-filter-select" class="form-select filter-select"
                    ...
                    <div class="row w-100">
                        ...
                        <div class="form-outline col-lg-4 col-md-4 col-sm-4 col-4 mb-5">
                            <div class="d-flex align-items-center">
                                <label for="" class="form-label fw-semibold">Học viên</label>
                            </div>
                            @include('helpers.contactSelector', [
                                'name' => 'contact_id',
                                'url' => action('App\Http\Controllers\Abroad\StudentController@select2'),
    ...
    <script>
        ...
        let SectionsList = function() {
            ...
            return {
                init: () => {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Abroad\SectionController@abroadCalendarContent') }}",
                        ...
                        this.getDeleteAllItemsBtn().addEventListener('click', function() {
                            ...
                            ASTool.confirm({
                                ...
                                ok: function() {
                                    ...
                                    $.ajax({
                                        url: "{{ action('\App\Http\Controllers\Abroad\SectionController@deleteAll') }}",
                                        method: "DELETE",
                                        data: {
                                            _token: "{{ csrf_token() }}",
                                            items: items
