...
@section('content')
    ...
    <div id="formId">
        ...
        <!-- 4. Thành phần hồ sơ-->
        @include('abroad.abroad_applications._applicationParts',['abroadApplication'=>$abroadApplication])

        <!-- 5. Các hoạt động tích chọn hoặc mang tính chất thống kê-->
        @include('abroad.abroad_applications._activities',['abroadApplication'=>$abroadApplication])
    </div>
