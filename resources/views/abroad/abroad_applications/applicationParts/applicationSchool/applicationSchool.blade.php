...
<div class="row" id="application-school-manager-container">
        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1">
                    ...
                    <span class="badge badge-{{ $abroadApplication->isDoneApplicationSchool() ? 'success' : 'primary' }}">{{ $abroadApplication->isDoneApplicationSchool() ? 'Hoàn thành' : 'Chưa hoàn thành' }}</span>
                    <button value="application_school" action-control="application_school" type="button" class="badge badge-success {{ $abroadApplication->isDoneApplicationSchool() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="extracurricular-plan-manager-container">
        ...
        <div class="row">
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <input type="date" value="{{$dayFinish->application_school ?? ''}}" name="application_school" class="form-control">
            </div>
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <button action-control="application-school-declare" data-url="{{ action([App\Http\Controllers\Abroad\AbroadController::class, 'applicationSchoolDeclaration'], ['id' => $abroadApplication->id,]) }}" class="btn {{$checkFill ? 'btn-info': 'btn-info'}} w-100">{{$checkFill ? 'Cập nhật' : 'Kê khai'}}</button>
            </div>
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
