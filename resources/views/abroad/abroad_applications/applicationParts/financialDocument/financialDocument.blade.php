<div class="row" id="financial_document">
        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1">
                    ...
                    <button value="financial_document" action-control="financial_document" type="button" class="badge badge-success {{ $abroadApplication->isDoneFinancialDocument() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="financial-document-manager-container" 
        data-upload-url="{{ action([App\Http\Controllers\Abroad\AbroadController::class, 'storeFinancialDocument'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Abroad\AbroadController::class, 'deleteFinancialDocument'], ['id' => $abroadApplication->id]) }}">
        ...
        <div class="row d-flex justify-content-around">
            {{-- Date input --}}
            <div class="col-md-4">
                <input type="date" value="{{$dayFinish->financial_document ?? ''}}" name="financial_document" class="form-control">
            </div>
            {{-- Draft form --}}
            <div class="col-md-8">
...
<script>
    ...
    var Manager = class {
        ...
        getForm() {
            return this.getContainer().find('[form-data="financial-document-manager-container"]');
        }
        ...
        getFinancialDocumentFileElements() {
            return this.getForm().find('[data-control="financial-document-file"]').toArray();
        }
        ...
        getUpLoadFinancialDocumentBtn() {
            return this.getForm().find('[action-control="upload-financial-document-btn"]');
        }

        getFinancialDocumentInput() {
            return this.getForm().find('[action-control="financial-document-input"]');
        }
