<div class="row" id="complete_file">
        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1">
                    ...
                    <button value="complete_file" action-control="complete_file" type="button" class="badge badge-success {{ $abroadApplication->isDoneCompleteFile() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="complete-file-manager-container"
        data-upload-url="{{ action([App\Http\Controllers\Abroad\AbroadController::class, 'storeCompleteFile'], ['id' => $abroadApplication->id]) }}"
        data-delete-url="{{ action([App\Http\Controllers\Abroad\AbroadController::class, 'deleteCompleteFile'], ['id' => $abroadApplication->id]) }}">
        ...
        <div class="row d-flex justify-content-around">
            {{-- Date input --}}
            <div class="col-md-4">
                <input type="date" value="{{$dayFinish->complete_file ?? ''}}" name="complete_file" class="form-control">
            </div>
            {{-- Draft form --}}
            <div class="col-md-8">
...
<script>
    ...
    var Manager = class {
        ...
        getForm() {
            return this.getContainer().find('[form-data="complete-file-manager-container"]');
        }
        ...
        getCompleteFileFileElements() {
            return this.getForm().find('[data-control="complete-file-file"]').toArray();
        }
        ...
        getUpLoadCompleteFileBtn() {
            return this.getForm().find('[action-control="upload-complete-file-btn"]');
        }

        getCompleteFileInput() {
            return this.getForm().find('[action-control="complete-file-input"]');
        }
