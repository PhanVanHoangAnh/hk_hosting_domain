...
@section('content')
    <form id="{{ $createExtracurricularSchedule }}"
        action="{{ action(
            [App\Http\Controllers\Abroad\AbroadController::class, 'doneCreateExtracurricularSchedule'],
            [
                'id' => $id,
            ],
        ) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <select list-action="abroad_status" name="extracurricularId" class="form-select filter-select" data-control="select2"
                            ...
                            <option value="" selected disabled hidden></option>
                            @foreach(\App\Models\Extracurricular::notFinished()->get()  as $extracurricular)
