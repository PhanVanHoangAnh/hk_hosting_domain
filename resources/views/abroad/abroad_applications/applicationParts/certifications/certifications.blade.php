...
<div class="row" id="certificate">
            ...
            <div class="fw-semibold">
               Chứng chỉ
                <div class="mt-1">
                    ...
                    <button value="certificate" action-control="certificate" type="button" class="badge badge-success {{ $abroadApplication->isDoneCertification() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="extracurricular-plan-manager-container">
        ...
        <div class="row">
            ...
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <button action-control="certifications-declare" data-url="{{ action([App\Http\Controllers\Abroad\AbroadController::class, 'certificationDeclaration'], ['id' => $abroadApplication->id,]) }}" class="btn {{$checkFill ? 'btn-info': 'btn-info'}} w-100">{{$checkFill ? 'Cập nhật' : 'Kê khai'}}</button>
            </div>
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
