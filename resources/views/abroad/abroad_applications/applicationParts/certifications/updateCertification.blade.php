...
@section('content')
    <form id="{{ $updateCertification }}"
        action="{{ action(
            [App\Http\Controllers\Abroad\AbroadController::class, 'doneUpdateCertification'],
            [
                'id' => $certification->id,
            ],
        ) }}">
    ...
    <script>
        ...
        var updateCertification = function() {
            ...
            submit = () => {
                ...
                const certificationId = document.querySelector('input[name="certificationId"]').value;
