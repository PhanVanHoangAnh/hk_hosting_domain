...
<div class="row" id="essayResultScreenId" >
        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1">
                    ...
                    <button value="essay_results" action-control="essay_results" type="button" class="badge badge-success {{ $abroadApplication->isDoneEssayResult() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="manager-container" >
        ...
        <div class="row"  >
            ...
            {{-- Date input --}}
            <div class="col-md-4">
                <input type="date" value="{{$dayFinish->essay_results ?? ''}}" name="essay_results" class="form-control">
            </div>
                        ...
                        @if (isset($essayResult->path))
                            <div data-file-name="{{ basename($essayResult->getPath()) }}" data-control="file" class="row my-0">
                                ...
                                <div class="col-md-3 ps-0 d-flex justify-content-start align-items-center ">
                                    <button data-delete-url="{{ action([App\Http\Controllers\Abroad\AbroadController::class, 'deleteEssayResultFile'], ['id' => $essayResult->id]) }}"
            ...
            <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 ">
                ...
                href="{{ action(
                    [App\Http\Controllers\Abroad\AbroadController::class, 'createEssayResult'],
                    [
            ...
            <div class="col-2 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                ...
                href="{{ action(
                    [App\Http\Controllers\Abroad\AbroadController::class, 'showEssayResult'],
                    [
                        'id' => $abroadApplication->id,
                    ],
                ) }}">Xem</a>
