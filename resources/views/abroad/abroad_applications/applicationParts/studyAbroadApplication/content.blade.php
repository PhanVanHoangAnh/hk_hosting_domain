...
<div class="row" id="studyAbroadApplicationScreenId">
        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1">
                    ...
                    <button value="study_abroad_applications" action-control="study_abroad_applications" type="button" class="badge badge-success {{ $abroadApplication->isDoneStudyAbroadApplication() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="manager-container" >
        ...
        <div class="row">
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <input type="date" value="{{$dayFinish->study_abroad_applications ?? ''}}" name="study_abroad_applications" class="form-control">
            </div>
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <a row-action="show-study-abroad-application"
                class="fs-6 fw-bold btn {{$checkFill ? 'btn-secondary': 'btn-info'}} btn-sm fs-4 w-100"
                href="{{ action(
                    [App\Http\Controllers\Abroad\AbroadController::class, 'createStudyAbroadApplication'],
                    [
