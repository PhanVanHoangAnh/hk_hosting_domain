...
@endsection
@php
    $showIelts = 'showIelts_' . uniqid();
@endphp
@section('content')
    <!--begin::Card body-->
    <form id="{{ $showIelts }}" tabindex="-1">
        @csrf
        <div class="card-body pt-0 mt-5">
                        ...
                        <tbody class="text-gray-600">
                            @foreach ($ielts as $ielt)
                                <tr list-control="item">
                                    <td class="text-left mb-1 text-nowrap">{{ $ielt->exam_times }}</td>
                                    <td class="text-left mb-1 text-nowrap">{{ $ielt->ielts_score }}</td>
                                    <td class="text-left mb-1 text-nowrap">{{ $ielt->test_day }}</td>
                                    ...
                                    <td class="text-left">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a row-action="update-ielts-score"
                                                    class="menu-link px-3"
                                                    href="{{ action(
                                                        [App\Http\Controllers\Abroad\LoTrinhChienLuocController::class, 'editIeltsScore'],
                                                        [
                                                            'id' => $ielt->id,
                                                        ],
                                                    ) }}">
            ...
            <div class="d-flex flex-row-reverse bd-highlight">
                <div class="p-2 bd-highlight">
                    <a href="{{ action(
                        [App\Http\Controllers\Abroad\LoTrinhChienLuocController::class, 'createIeltsScore'],
                        [
                            'abroadApplicationId' => $abroadApplicationId,
                        ],
                    ) }}"
                    class="btn btn-flex btn-sm btn-primary fw-bold border-0 fs-6 h-40px" row-action="creat-ielts-score">
            ...
            <script>
                $(() => {
                    ...
                    IeltsScorePopup.init();
                });
        
                var IeltsScore = function() {
                    ...
                    function getCreateBtn() {
                        return document.querySelectorAll('[row-action="creat-ielts-score"]');
                    }
                    function getUpdateBtn() {
                        return document.querySelectorAll('[row-action="update-ielts-score"]');
                    }
                        ...
                        init: function() {
                            ...
                            getCreateBtn().forEach(function(btn) {
                                btn.addEventListener('click', function(e) {
                                    ...
                                    IeltsScorePopup.updateUrl(btnUrl);
                                });
                            });
