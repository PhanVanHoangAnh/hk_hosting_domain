...
<div>
    ...
    action="{{ action([App\Http\Controllers\Abroad\LoTrinhChienLuocController::class, 'doneEditIeltsScore'], ['id' => $ielts->id]) }}">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-6 mb-2">
                        <div class="form-outline">
                            ...
                            <input name="exam_times" type="number" value="{{$ielts->exam_times ?? ''}}" class="form-control" placeholder="Nhập lần thi thứ...">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-6 mb-2">
                        <div class="form-outline">
                            ...
                            <input name="score" type="text" value="{{$ielts->ielts_score ?? ''}}" class="form-control" placeholder="Điểm thi Ielts...">
                            <x-input-error :messages="$errors->get('name')" class="mt-2"/>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-6 mb-2">
                        <div class="form-outline">
                            ...
                            <input name="date" type="date" value="{{$ielts->test_day}}" class="form-control" placeholder="Ngày thi...">
...
<script>
    var editIeltsScoreManager;

    $(() => {
        editIeltsScoreManager = new editIeltsScoreManager({
            container: $('#{{ $createIeltsCorePopup }}')
        })
    })

    var editIeltsScoreManager = class {
        constructor(options) {
