<div class="row" id="strategicLearningCurriculumContainer">
        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1">
                    ...
                    <button action-control="lo-trinh-ht-cl" value="lo_trinh_ht_cl" type="button" class="badge badge-success {{ $abroadApplication->isDoneLoTrinhHTCL() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="strategic-learning-curriculum-container">
        ...
        <div class="row">
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <input type="date" value="{{$dayFinish->lo_trinh_ht_cl ?? ''}}" name="lo_trinh_ht_cl"class="form-control">
            </div>
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <button action-control="declare" value="lo_trinh_ht_cl" data-url="{{ action([App\Http\Controllers\Abroad\AbroadController::class, 'declareStrategicLearningCurriculum'], ['id' => $abroadApplication->id]) }}" class="btn {{$checkFill ? 'btn-info': 'btn-info'}} w-100">{{$checkFill ? 'Cập nhật' : 'Kê khai'}}</button>
            </div>
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
