...
<div class="row" id="extracurricular-plan-manager-container">
        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1">
                    ...
                    <button value="lo_trinh_hd_nk" action-control="lo-trinh-hd-nk" type="button" class="badge badge-success {{ $abroadApplication->isDoneLoTrinhHDNK() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="extracurricular-plan-manager-container">
        ...
        <div class="row">
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <input type="date" value="{{$dayFinish->lo_trinh_hd_nk ?? ''}}" name="lo_trinh_hd_nk" class="form-control">
            </div>
            <div class="col-3 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-none">
                <button action-control="declare" data-url="{{ action([App\Http\Controllers\Abroad\AbroadController::class, 'declareExtracurricularPlan'], ['id' => $abroadApplication->id]) }}" class="btn {{$checkFill ? 'btn-info': 'btn-info'}} w-100">{{$checkFill ? 'Cập nhật' : 'Kê khai'}}</button>
            </div>
           
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <button action-control="view-declaration" data-url="{{ action([App\Http\Controllers\Abroad\AbroadController::class, 'viewExtracurricularPlanDeclaration'], ['id' => $abroadApplication->id]) }}" class="btn btn-secondary w-100">Xem</button>
            </div>
        </div>
