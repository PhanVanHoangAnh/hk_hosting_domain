...
<div class="row" id="applicationFeesId">
        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1"> 
                    ...
                    <button value="application_fees" action-control="application_fees" type="button" class="badge badge-success {{ $abroadApplication->isDoneApplicationFee() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
    ...
    <div class="col-md-9" form-data="extracurricular-plan-manager-container">
        ...
        <div class="row">
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <input type="date" value="{{$dayFinish->application_fees ?? ''}}" name="application_fees" class="form-control">
            </div>
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-center">
                <a href="{{ action(
                    [App\Http\Controllers\Abroad\AbroadController::class, 'payAndConfirm'],
                    [
            ...
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 text-center">
                <a href="{{ action(
                    [App\Http\Controllers\Abroad\AbroadController::class, 'showPayAndConfirm'],
                    [
                        'id' => $abroadApplication->id,
                    ],
                ) }}"
            ...
            <form id="tableApplicationFee" tabindex="-1">
                ...
                <div class="table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td class="min-w-125px text-left">
                                        <div class="col-md-3 ps-0 d-flex justify-content-start align-items-center">
                                            ...
                                            href="{{ action(
                                                [App\Http\Controllers\Abroad\AbroadController::class, 'editApplicationFee'],
                                                [
                    ...
                    <div class="d-flex justify-content-end align-items-center mt-3">
                        <!--begin::Button-->
                        <a href="{{ action(
                            [App\Http\Controllers\Abroad\AbroadController::class, 'createApplicationFee'],
                            [
                                'id' => $abroadApplication->id,
                            ],
                        ) }}"
