            ...
            <form id="tableApplicationAdmittedSchool" tabindex="-1">
                ...
                <div class="table-responsive">
                        ...
                        <tbody class="text-gray-600">
                            ...
                            <tr>
                                ...
                                {{-- <td  list-control="school-selected-edit"
                                    data-url="{{ action('\App\Http\Controllers\Abroad\AbroadController@saveSchoolSelected', [
                                ...
                                <td class="min-w-125px text-left">
                                    <div class="col-md-3 ps-0 d-flex justify-content-start align-items-center">
                                        ...
                                        href="{{ action(
                                            [App\Http\Controllers\Abroad\AbroadController::class, 'editApplicationAdmittedSchool'],
                                            [
                                                'id' => $applicationAdmittedSchool->id,
                                            ],
                                        ) }}">Chỉnh sửa</a>
                    ...
                    {{-- <div class="d-flex justify-content-end align-items-center mt-3">
                        <!--begin::Button-->
                        <a href="{{ action(
                            [App\Http\Controllers\Abroad\AbroadController::class, 'createApplicationAdmittedSchool'],
                            [
