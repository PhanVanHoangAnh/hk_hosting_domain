        ...
        <div class="d-flex">
            ...
            <div class="fw-semibold">
                ...
                <div class="mt-1"> 
                    ...
                    <button value="support_activity" action-control="support_activity" type="button" class="badge badge-success {{ $abroadApplication->isDoneSupportActivity() ? 'd-none' : '' }}" data-bs-toggle="tooltip" data-bs-placement="right" title="Bấm vào đây nếu đã hoàn thành">
                        &#10004;
                    </button>
                </div>
            </div>
            ...
            <form id="tableSupportActivity" tabindex="-1">
                ...
                <div class="table-responsive">
                                    ...
                                    <td class="text-left">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                href="{{ action(
                                                    [App\Http\Controllers\Abroad\AbroadController::class, 'updateSupportActivity'],
                                                    [
                    ...
                    <div class="d-flex justify-content-end align-items-center mt-3">
                        <!--begin::Button-->
                        <a href="{{ action(
                            [App\Http\Controllers\Abroad\AbroadController::class, 'createSupportActivity'],
                            [
