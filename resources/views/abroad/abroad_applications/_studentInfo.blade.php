                ...
                <div class="col-7 col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7">
                    ...
                    <div class="fv-row my-3 d-flex border-bottom">
                        ...
                        <div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                            ...
                            {{ $abroadApplication->student->birthday ?   date('d/m/Y', strtotime($abroadApplication->student->birthday)) : '--' }}
                            </div>
            ...
            <div class="row d-flex justify-content-between">
                <div class="col-5 col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xl-5">
                    <div class="fv-row my-3 d-flex border-bottom">
                        ...
                        <label class="fs-6 fw-semibold mb-2">
                            <span class="fw-bold">BỐ:</span>
                        </label>
                    </div>
                    <div class="fv-row my-3 d-flex "> 
                        <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 d-flex align-items-center">
                            <label class="fs-6  mb-2">
                                <span class="fw-bold">Phụ huynh (Dad):</span>
                            </label>
                        </div>
                        <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <span class="">{{ $abroadApplication->student->getFather() ? $abroadApplication->student->getFather()->name : '--' }}</span>
                        </div>
                    ...
                    <div class="fv-row my-3 d-flex ">
                        <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 d-flex align-items-center">
                            <label class="fs-6 mb-2">
                                <span class="fw-bold">Số điện thoại Dad:</span>
                                <span class=""></span>
                            </label>
                        </div>
                        <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <span class="">{{ optional($abroadApplication->student->getFather())->phone ?? '--' }}</span>
                        </div>
                    </div>
                    <div class="fv-row my-3 d-flex ">
                        <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 d-flex align-items-center">
                        ...
                        <div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
                            <span class="">{{ optional($abroadApplication->student->getFather())->email ?? '--' }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-7 col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7">
                    <div class="fv-row my-3 d-flex border-bottom">
                        ...
                        <label class="fs-6 fw-semibold mb-2">
                            <span class="fw-bold">MẸ:</span>
                        </label>
                    </div>
                    <div class="fv-row my-3 d-flex "> 
                        <div class="col-4 col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 d-flex align-items-center">
                            <label class="fs-6  mb-2">
                                <span class="fw-bold">Phụ huynh (Mom):</span>
                            </label>
                        </div>
                        <div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                            <span class="">{{ optional($abroadApplication->student->getMother())->name ?? '--' }}</span>
                        </div>
                    ...
                    <div class="fv-row my-3 d-flex ">
                        <div class="col-4 col-xs-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 d-flex align-items-center">
                            <label class="fs-6 mb-2">
                                <span class="fw-bold">Số điện thoại Mom:</span>
                            </label>
                        </div>
                        <div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                            <span class="">{{ optional($abroadApplication->student->getMother())->phone ?? '--' }}</span>
                        </div>
                    ...
                    <div class="fv-row my-3 d-flex ">
                        ...
                        <div class="col-8 col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                            <span class="">{{ optional($abroadApplication->student->getMother())->email ?? '--' }}</span>
                        </div>
                    </div>
                </div>
