                ...
                <div class="col-3 col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                    <div class="fv-row my-3 d-flex border-bottom">
                        ...
                        <div class="col-7 col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7">
                            <div>
                               {{ trans('messages.branch.' . $abroadApplication->orderItem->order->salesperson->branch) }}
                    ...
                    <div class="fv-row my-3 d-flex border-bottom">
                        <div class="col-5 col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xl-5 d-flex align-items-center">
                            <label class="fs-6 fw-semibold mb-2">
                                <span class="fw-bold">Quản lý sales:</span>
                            </label>
                        </div>
                        <div class="col-7 col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7">
                            <div>
                                {{ optional(optional($abroadApplication->orderItem->orders->salesperson->accountGroup)->manager)->name ?? '--' }}
                    ...
                    <div class="fv-row my-3 d-flex border-bottom">
                        <div class="col-5 col-xs-5 col-sm-5 col-md-5 col-lg-5 col-xl-5 d-flex align-items-center">
                            <label class="fs-6 fw-semibold mb-2">
                                <span class="fw-bold">Nhân viên sales:</span>
                            </label>
                        </div>
                        <div class="col-7 col-xs-7 col-sm-7 col-md-7 col-lg-7 col-xl-7">
                            <div>

                                {{ $abroadApplication->orderItem->orders->salesperson->name  ? $abroadApplication->orderItem->orders->salesperson->name : '--' }}
                            </div>
                        </div>
                    </div>
