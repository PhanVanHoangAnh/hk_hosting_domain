...
<div class="row" id="extracurricular-plan-manager-container">
    ...
    <div class="col-md-9" form-data="extracurricular-plan-manager-container">
        ...
        <div class="row">
            ...
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                <button action-control="declare" data-url="{{ action([App\Http\Controllers\Abroad\AbroadController::class, 'declareExtracurricularPlan'], ['id' => $abroadApplication->id]) }}"  class="btn btn-info w-100">Kê khai</button>
            </div>
