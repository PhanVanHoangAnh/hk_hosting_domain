...
@section('content')
    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Lịch Sử Ghi Chú</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ action([App\Http\Controllers\Abroad\DashboardController::class, 'index']) }}" class="text-muted text-hover-primary">Trang chính</a>
                </li>
                <!--end::Item-->
                <!--begin::Item-->
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Lịch sử ghi chú</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
        ...
        <div class="d-flex align-items-center py-1">
            <!--begin::Button-->
            <a href="#" class="btn btn-flex btn-sm btn-primary fw-bold border-0 fs-6 h-40px" id="buttonCreateNoteLog">
    ...
    <!--begin::Post-->
    <div id="NoteLogsIndexContainer" class="position-relative" id="kt_post">
        <!--begin::Card-->
        <div class="card">
            <!--begin::Card header-->
            <div class="card-header border-0 px-4">
                ...
                <div list-action="top-action-box" class="menu d-flex justify-content-end align-items-center d-none"
                    data-kt-menu="true">
                    <div class="menu-item py-3" data-kt-menu-trigger="hover" data-kt-menu-placement="bottom-start">
                        <!--begin::Menu link-->
        ...
        <div id="NoteLogsIndexListContent">
        </div>
    </div>
    ...
    <script>
            ...
            return {
                init: () => {
                    ...
                    noteList = new DataList({
                        url: "{{ action('App\Http\Controllers\Abroad\NoteLogController@list') }}",
        ...
        let createNotlogHandle = function() {
            return {
                init: () => {
            ...
            deleteAllItems() {
                ...
                tool.confirm({
                    ...
                    ok: () => {
                        ...
                        $.ajax({
                            url: "{{ action('\App\Http\Controllers\Abroad\NoteLogController@destroyAll') }}",
                            method: 'DELETE',
                            data: {
                                _token: "{{ csrf_token() }}",
