            ...
            return {
                init: () => {
                    ...
                    noteList = new DataList({
                        ...
                        url: "{{ action('App\Http\Controllers\Abroad\ContactController@noteLogList', ['id' => $contact->id]) }}",
                ...
                init: () => {
                    document.querySelector('#buttonCreateNoteLog').addEventListener('click', e => {
                        ...
                        CreateNotePopup.updateUrl(
                            "{{ action('\App\Http\Controllers\Abroad\NoteLogController@addNoteLog', ['id' => $contact->id]) }}"
                        );
                    });
                }
            };
