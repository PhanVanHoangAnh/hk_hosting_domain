...
@section('content')
<form id="filterContactForm" action="{{ action('App\Http\Controllers\Abroad\ContactController@exportRun') }}" method="POST">
...
<script>
   ...
   $(document).ready(function() {
        ...
        $('#exportContactButton').click(function(event) {
            ...
            $.ajax({
                url: "{{ action('App\Http\Controllers\Abroad\ContactController@exportRun') }}",
                type: 'POST',
                data: formData,
                beforeSend: function() {
                ...
                success: function(response) {
                    ...
                    // Download the file
                    window.location = "{{ action('App\Http\Controllers\Abroad\ContactController@exportDownload') }}?file=" + response.file;
