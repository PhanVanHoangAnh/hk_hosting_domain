                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4 w-250px"
                        ...
                        <div class="menu-item px-3">
                            <a  row-action="update-contact" 
                                href="{{ action('App\Http\Controllers\Abroad\ContactController@edit', ['id' => $contact->id]) }}"
            ...
            <div class="d-flex flex-column flex-grow-1 pe-8">
                ...
                <div class="d-flex flex-nowrap">
                    ...
                    <a class="border border-gray-300 border-dashed rounded min-w-125px py-3 me-3 mb-3 profile-stat-box"
                        ...
                        href="{{ action([App\Http\Controllers\Abroad\ContactController::class, 'education'], ['id' => $contact->id]) }}">
                        <!--begin::Header-->
                    ...
                    <a class="border border-gray-300 border-dashed rounded min-w-125px py-3 me-3 mb-3 profile-stat-box"
                        data-action="under-construction"
                        href="{{ action([App\Http\Controllers\Abroad\ContactController::class, 'studyAbroad'], ['id' => $contact->id]) }}">
                        <!--begin::Header-->
                        <div class="card-header pt-5 border-0">
                            <!--begin::Title-->
                            <div class="card-title d-flex flex-column">
                    ...
                    <a class="border border-gray-300 border-dashed rounded min-w-125px py-3 me-3 mb-3 profile-stat-box"
                        data-action="under-construction"
                        href="{{ action([App\Http\Controllers\Abroad\ContactController::class, 'debt'], ['id' => $contact->id]) }}">
                        <!--begin::Header-->
                        <div class="card-header pt-5 border-0">
                            <!--begin::Title-->
                            <div class="card-title d-flex flex-column">
