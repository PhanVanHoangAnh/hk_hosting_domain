                    ...
                    <div class="menu-item py-2" data-kt-menu-trigger="hover" data-kt-menu-placement="bottom-start">
                        ...
                        <div class="menu-sub menu-sub-dropdown p-3 w-200px">
                            ...
                            <div class="menu-item px-3">
                                <a row-action="delete-all" href="{{ action([App\Http\Controllers\Abroad\ContactController::class, 'deleteAll']) }}"
    ...
    <script>
            ...
            return {
                init: function() {
                    ...
                    popupExportContact = new Popup({
                        url: "{{ action('\App\Http\Controllers\Abroad\ContactController@showFilterForm') }}",
                    });
            ...
            return {
                init: function() {
                    popupEditTags = new Popup({
                        url: "{{ action('\App\Http\Controllers\Abroad\ContactController@addTagsBulk') }}",
                    });
            ...
            return {
                init: function() {
                    popupDeleteTags = new Popup({
                        url: "{{ action('\App\Http\Controllers\Abroad\ContactController@deleteTags') }}",
                    });
            ...
            return {
                init: function() {
                    ...
                    popupCreateContact = new Popup({
                        url: "{{ action('\App\Http\Controllers\Abroad\ContactController@create') }}",
        ...
        var ContactsList = function() {
            ...
            return {
                init: function() {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Abroad\ContactController@list') }}",
