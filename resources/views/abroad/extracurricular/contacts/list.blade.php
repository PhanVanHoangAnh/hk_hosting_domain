                ...
                <tbody class="text-gray-600">
                    @foreach ($contacts as $contact)
                        <tr list-control="item">
                                ...
                                <td data-column="name" data-control="freeze-column">
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex flex-column">
                                            <a row-action="update"
                                                href="{{ action(
                                                    [App\Http\Controllers\Abroad\ContactController::class, 'edit'],
                                                    [
                                                        'id' => $contact->id,
                                                    ],
                                                ) }}"
                            ...
                            @endif
                            @if (in_array('phone', $columns) || in_array('all', $columns))
                                {{-- <td data-column="phone">{{ $contact->phone }}</td> --}}
                                <td data-column="phone" list-control="phone-inline-edit"
                                    data-url="{{ action('\App\Http\Controllers\Abroad\ContactController@save', [
                                        'id' => $contact->id,
                                    ]) }}"
                                    class="text-nowrap">
                            ...
                            @if (in_array('father', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="father">
                                    {{ $contact->getFather() ? $contact->getFather()->name : '' }}</td>
                            @endif
                            @if (in_array('mother', $columns) || in_array('all', $columns))
                                <td class="text-nowrap" data-column="mother">
                                    {{ $contact->getMother() ? $contact->getMother()->name : '' }}</td>
                            @endif
                            @if (in_array('address', $columns) || in_array('all', $columns))
                                ...
                                <td class="text-nowrap" style="width: auto" data-column="note_log">
                                    <div class="d-flex">
                                        ...
                                        <a row-action="note-logs-contact"
                                            href="{{ action(
                                                [App\Http\Controllers\Abroad\NoteLogController::class, 'noteLogsPopup'],
                                                [
                                                    'id' => $contact->id,
                                                ],
                                            ) }}">
                            ...
                            <td data-column="action">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3 d-none">
                                        <a href="{{ action(
                                            [App\Http\Controllers\Abroad\ContactController::class, 'show'],
                                            [
                                                'id' => $contact->id,
                                            ],
                                        ) }}"
                                    ...
                                    <div class="menu-item px-3">
                                        <a list-action="add-order"
                                            href="{{ action(
                                                [App\Http\Controllers\Abroad\OrderController::class, 'pickContact'],
                                                [
                                    ...
                                    <div class="menu-item px-3 ">
                                        <a row-action="update"
                                            href="{{ action(
                                                [App\Http\Controllers\Abroad\ContactRequestController::class, 'showFreeTimeSchedule'],
                                                [
                                                    'id' => $contact->id,
                                                ],
                                            ) }}"
                                    ...
                                    @if (Auth()->user()->can('delete', $contact))
                                        <div class="menu-item px-3">
                                            <a row-action="delete"
                                                href="{{ action(
                                                    [App\Http\Controllers\Abroad\ContactController::class, 'destroy'],
                                                    [
                                                        'id' => $contact->id,
                                                    ],
                                                ) }}"
...
<script>
    $(function() {
        ...
        if (document.getElementById('addSalesContactSearch') !== null) {
            AddContact.init();
        }
    ...
    var AddContact = function() {
        return {
            init: function() {
                btnSubmit = document.getElementById('addSalesContactSearch');
