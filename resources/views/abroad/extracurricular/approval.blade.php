...
@section('content')
    ...
    <div id="CoursesIndexContainer" class="position-relative" id="kt_post">
        ...
        <div id="ExtracurricularApprovalList">
        </div>
        <!--begin::Modals-->
        ...
        let abroadApplicationsList = function() {
            ...
            return {
                init: () => {
                    ...
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Abroad\ExtracurricularController@approvalList') }}",
                        container: document.querySelector("#CoursesIndexContainer"),
                        listContent: document.querySelector("#ExtracurricularApprovalList"),
