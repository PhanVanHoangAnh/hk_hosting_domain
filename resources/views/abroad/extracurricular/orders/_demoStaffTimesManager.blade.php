...
<div class="row" id="{{ $staffTimesManagerContainerUniqId }}">
                    ...
                    <tr data-container="vn-teacher">
                        ...
                        <td class="text-center">
                            <input type="text" class="form-control border-0 cursor-pointer text-center" placeholder="--" 
                                    {{-- data-bs-toggle="tooltip" data-bs-placement="top" title="Trường này sẽ được tự động tính toán khi nhập đủ thông tin!" --}}
        ...
        <script>    
            ...
            var StaffTimesManager = class {
                ...
                setSumSalaryDiscountedValue(sum) {
                    ...
                    this.parent.revenueDistribution.reset();
                }
            ...
            var StaffDataRow = class {
                ...
                events() {
                    ...
                    $(_this.getNumOfSectionsInput()).on('change', function() {
                        _this.changeNumOfSectionsHandle();
                    })
                    
                    $(_this.getHoursPerSectionInput()).on('change', function() {
                        _this.changeHoursPerSectionHandle();
                    })
        
                    $(_this.getMinutesPerSectionInput()).on('change', function() {
                    ...
                    $(_this.getSalaryInput()).on('change', function(e) {
    ...
    @endphp
    @include('abroad.extracurricular.orders._revenue_sharing', [
        'trainOrderRevenueSharingUniqId' => $trainOrderRevenueSharingUniqId
    ])
</div>
    ...
    $(() => {
        salaryManager = new SalaryManager({
            ...
            revenueDistribution: new RevenueDistribution({
                container: () => {
                    return document.querySelector('#{{ $trainOrderRevenueSharingUniqId }}')
                }
            })
        })
    })
