...
<form id="{{ $createTrainOrderItemPopupUniqid }}" tabindex="-1">
    ...
    <div class="scroll-y px-7 py-10 px-lg-17">
        ...
        {{-- @include('generals.subjects._subject_selection', [
            'parentId' => $createTrainOrderItemPopupUniqid,
            'originLevel' => isset($orderItem->level) ? $orderItem->level : null
        ]) --}}
        ...
        <div class="row mb-4">
            ...
            @include('abroad.extracurricular.orders._eduStaffTimesManager')
        </div>
        ...
        <div class="row mb-4">
            {{-- Demo studied form --}}
            @include('abroad.extracurricular.orders._demoStudied')
        </div>
...
<script>
    ...
    var EduFormManage = class {
        ...
        // loadSavedSubjectValues() {
        //     subjectsManager.setTypeSavedValue(this.getTypeSavedValue());
        //     subjectsManager.setSubjectSavedValue(this.getSubjectIdSavedValue());
        //     subjectsManager.loadSavedValues();
        // };
