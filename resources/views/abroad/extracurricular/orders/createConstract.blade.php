    ...
    <div id="create-constract-content">
        ...
        <div class="card-header border-0 mb-10" id="create-constract-container">
            <form id="create-constract-form">
                        ...
                        <script>
                            $(function() {
                                new ContactInfoBox({
                                    ...
                                    url: '{{ action('\App\Http\Controllers\Abroad\ContactController@infoBox', 'CONTACT_ID') }}',
                                });
                            });
                        </script>
                    </div>
                        ...
                        <div class="col-6">
                            <div class="form-outline">
                                ...
                                @include('helpers.contactSelector', [
                                    ...
                                    'createUrl' => action('\App\Http\Controllers\Abroad\ContactController@create'),
                                    'editUrl' => action(
                                        '\App\Http\Controllers\Abroad\ContactController@edit',
                                        'CONTACT_ID'),
                                    'editOnly' => true,
                                ])
                ...
                {{-- SALES MANAGER --}}
                @include('abroad.extracurricular.orders._salesManager')
                ...
                @if ($order->type != \App\Models\Order::TYPE_REQUEST_DEMO)
                    <div class="form-outline mt-5 d-flex justify-content-start" section-control>
                        ...
                        <button id="addExtraOrder" data-href="{{ action([App\Http\Controllers\Abroad\OrderController::class, 'showCreateExtraPopup'], ['orderId' => $order->id]) }}"
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                                        ...
                                        <thead>
                                            <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 bg-light text-nowrap">
                                                ...
                                                {{-- <th class="min-w-125px text-left">loại hình giáo viên</th>
                                        ...
                                        ?>
                                                <tr list-control="train-order-item">
                                                    ...
                                                    {{-- <td class="text-left">
                                                        {{ $orderItem->teacher == 1 ? 'Giáo viên Việt Nam' : 'Giáo viên nước ngoài' }}
                                                    </td>
                                                    <td class="text-left">
                                                        {{ App\Helpers\Functions::formatNumber($orderItem->target) }} 
                                                    </td>
                                                    <td class="text-left"
                                                        {{ isset($orderItem->home_room) ? '' : 'style="font-style: italic"' }}>
                                                        {{ isset($orderItem->home_room) ? \App\Models\Teacher::find($orderItem->home_room)->name : 'Chưa chọn chủ nhiệm' }}
                                                    </td> --}}
                                                    <td class="text-left">
                                                    ...
                                                    <td class="text-left">
                                                        ...
                                                        {{-- {{  $orderItem->getSubtractedDemoItems()->count() }} dịch vụ --}}
                                                    </td>
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a data-order-item-id="{{ $orderItem->id }}"
                                                                    ...
                                                                    data-link="{{ action(
                                                                        [App\Http\Controllers\Abroad\OrderItemController::class, 'copy'],
                                                                        [
                                                                            'id' => $orderItem->id,
                                                                        ],
                                                                    ) }}"
                                                            ...
                                                            <div class="menu-item px-3">
                                                                <a data-order-item-id="{{ $orderItem->id }}"
                                                                    href="{{ action(
                                                                        [App\Http\Controllers\Abroad\OrderItemController::class, 'delete'],
                                                                        [
                                                                            'id' => $orderItem->id,
                                                                        ],
                                                                    ) }}"
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                                        ...
                                        <thead>
                                            <tr
                                                ...
                                                <th class="min-w-125px text-left">Hình thức học</th>
                                                <th class="min-w-125px text-left">Địa điểm đào tạo</th>
                                                <th class="min-w-125px text-left">Giáo viên</th>
                                                <th class="min-w-125px text-left">Thao tác</th>
                                            </tr>
                                        </thead>
                                        <tbody id="listTrainOrderItemContent" class="text-gray-600">
                                        ...
                                        ?>
                                                <tr list-control="train-order-item">
                                                    <td class="text-left">{{ trans('messages.order_item.' . $orderItem->type) }}</td>
                                                    <td class="text-left">{{ $orderItem->subject->name ?? '--' }}</td>
                                                    <td class="text-left">{{ $orderItem->level }}</td>
                                                    <td class="text-left">{{ trans('messages.courses.class_type.' . $orderItem->class_type) }}</td>
                                                    <td class="text-left">{{ $orderItem->study_type }}</td>
                                                    <td class="text-left">{{ $orderItem->getTrainingLocationName() }} - <span class="fw-bold">{{ trans('messages.training_locations.'. $orderItem->getTrainingLocationBranch()) }}</span></td>
                ...
                @if ($order->isEdu())
                    @include('abroad.extracurricular.orders._eduPriceManager')
                @endif

                {{-- ABROAD ORDER PRICE MANAGER--}}
                @if ($order->isAbroad())
                    @include('abroad.extracurricular.orders._abroadPriceManager')
                @endif

                {{-- ABROAD ORDER PRICE MANAGER--}}
                @if ($order->isExtra())
                    @include('abroad.extracurricular.orders._extraPriceManager')
                @endif
            ...
            <div class="form-outline mt-10 d-flex justify-content-center">
                <div class="mt-5">
                    ...
                    <input type="submit" class="btn btn-primary me-1" name="save_and_request"
                        value="Xác nhận và yêu cầu duyệt" id="comfirmAndRequestApproveBtn">
                    <a href="{{ action([App\Http\Controllers\Abroad\OrderController::class, 'index'], ['type' => App\Models\Order::TYPE_GENERAL]) }}"
        ...
        <script>
            ...
            var Constract = class {
                ...
                showCreateTraiOrderPopup() {
                    AddTrainOrderPopup.updateUrl(
                        "{!! action('App\Http\Controllers\Abroad\OrderController@createTrainOrder', ['contactId' => $order->contact_id, 'orderId' => $order->id,]) !!}"
                    );
                };

                showCreateExtraItemPopup(url) {
                    AddExtraItemPopup.updateUrl(
                        "{!! action([App\Http\Controllers\Abroad\OrderController::class, 'showCreateExtraPopup'], ['orderId' => $order->id]) !!}"
                    );
                };

                showCreateDemoOrderPopup() {
                    AddDemoOrderPopup.updateUrl(
                        "{!! action([App\Http\Controllers\Abroad\OrderController::class, 'createDemoOrder'], ['orderId' => $order->id]) !!}"
                    );
                };

                showCreateAbroadOrderPopup() {
                    AddAbroadOrderPopup.updateUrl(
                        "{!! action([App\Http\Controllers\Abroad\OrderController::class, 'createAbroadOrder'], ['orderId' => $order->id]) !!}"
                    );
                };
                ...
                saveConstractData() {
                    ...
                    $.ajax({
                        url: "{{ action('App\Http\Controllers\Abroad\OrderController@saveConstractData') }}",
                        method: "POST",
                        data: formData
                    }).done(response => {
                ...
                confirmAndRequestApproveConstractData() {
                    ...
                    $.ajax({
                        url: "{{ action('App\Http\Controllers\Abroad\OrderController@doneCreateConstractData') }}",
                        method: "POST",
                        data: formData
                    }).done(response => {
                        this.removeSubmitEffect();
                        ...
                        ASTool.alert({
                            ...
                            ok: () => {
                                ...
                                window.location.href =
                                    `{{ action('App\Http\Controllers\Abroad\OrderController@index', ['type' => '']) }}${screenType}`;
                            }
                        });
                    }).fail(response => {
                        this.removeSubmitEffect();
                    ...
                    if (this.getUpdateTrainOrderBtns()) {
                        this.getUpdateTrainOrderBtns().forEach(button => {
                            $(button).on('click', function(e) {
                                ...
                                const url = " {!! action('App\Http\Controllers\Abroad\OrderController@createTrainOrder', ['orderItemId' => 'PLACEHOLDER', 'contactId' => $order->contact_id, 'orderId' => $order->id]) !!} ";
                    ...
                    if (this.getUpdateDemoOrderBtns()) {
                        this.getUpdateDemoOrderBtns().forEach(button => {
                            button.addEventListener('click', function(e) {
                                ...
                                const orderItemId = this.getAttribute('data-order-item-id');
                                const url = " {!! action('App\Http\Controllers\Abroad\OrderController@createDemoOrder', ['orderItemId' => 'PLACEHOLDER', 'contactId' => $order->contact_id, 'orderId' => $order->id]) !!} ";
                                const updatedUrl = url.replace('PLACEHOLDER', orderItemId);
                    ...
                    if (this.getUpdateAbroadOrderBtns()) {
                        this.getUpdateAbroadOrderBtns().forEach(button => {
                            ...
                            button.addEventListener('click', function(e) {
                                ...
                                const orderItemId = this.getAttribute('data-order-item-id');
                                const url = " {!! action('App\Http\Controllers\Abroad\OrderController@createAbroadOrder', ['orderItemId' => 'PLACEHOLDER', 'contactId' => $order->contact_id, 'orderId' => $order->id]) !!} ";
                                const updatedUrl = url.replace('PLACEHOLDER', orderItemId);
                    ...
                    if (this.getUpdateExtraOrderBtns()) {
                        this.getUpdateExtraOrderBtns().forEach(button => {
                            ...
                            button.addEventListener('click', function(e) {
                                ...
                                const orderItemId = this.getAttribute('data-order-item-id');
                                const url = " {!! action('App\Http\Controllers\Abroad\OrderController@showCreateExtraPopup', ['orderItemId' => 'PLACEHOLDER', 'contactId' => $order->contact_id, 'orderId' => $order->id]) !!} ";
                                const updatedUrl = url.replace('PLACEHOLDER', orderItemId);
                ...
                setPopup(type) {
                    switch (type) {
                        case EDU_TYPE:
                            ...
                            this.popupLink = "{!! action('App\Http\Controllers\Abroad\OrderController@createTrainOrder', ['orderItemId' => 'PLACEHOLDER', 'currOrderItemId' => 'CURR_ID']) !!}";
                            break;
                        case ABROAD_TYPE:
                            this.editPopup = AddAbroadOrderPopup;
                            this.popupLink = "{!! action('App\Http\Controllers\Abroad\OrderController@createAbroadOrder', ['orderItemId' => 'PLACEHOLDER', 'currOrderItemId' => 'CURR_ID']) !!}";
                            break;
                        case DEMO_TYPE:
                            this.editPopup = AddDemoOrderPopup;
                            this.popupLink = "{!! action('App\Http\Controllers\Abroad\OrderController@createDemoOrder', ['orderItemId' => 'PLACEHOLDER', 'currOrderItemId' => 'CURR_ID']) !!}";
                            break;
                        case EXTRA_TYPE:
                            this.editPopup = AddExtraItemPopup;
                            this.popupLink = "{!! action('App\Http\Controllers\Abroad\OrderController@showCreateExtraPopup', ['orderItemId' => 'PLACEHOLDER', 'currOrderItemId' => 'CURR_ID']) !!}";
                            break;
                        default:
                            this.editPopup = AddTrainOrderPopup;
                            this.popupLink = "{!! action('App\Http\Controllers\Abroad\OrderController@createTrainOrder', ['orderItemId' => 'PLACEHOLDER', 'currOrderItemId' => 'CURR_ID']) !!}";
            ...
            var OrderForm = class {
                #url = "{{ action('App\Http\Controllers\Abroad\OrderController@saveOrderItemData') }}";
                #orderId = "{{ $orderId }}";
            ...
            var PriceManager = class {
                ...
                loadOrderPrice() {
                    ...
                    $.ajax({
                        url: '{{ action('App\Http\Controllers\Abroad\OrderController@getTotalPriceOfItems') }}',
                        data: {
                            _token: "{{ csrf_token() }}",
                            id: _this.getOrderId()
                        },
