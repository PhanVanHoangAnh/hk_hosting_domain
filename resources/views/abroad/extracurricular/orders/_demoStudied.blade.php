    ...
    @else
        <div>
            <span class="d-flex align-items-start">
                ...
                <span>Khách hàng/Người ký dịch vụ/Học viên này chưa ký dịch vụ học thử nào hoặc đã trừ hết giờ học demo!</span>
            </span>
        </div>
    @endif
    ...
    @else
        <div>
            <span class="d-flex align-items-start">
                ...
                <span>Khách hàng/Người ký dịch vụ/Học viên này chưa ký dịch vụ học thử nào hoặc đã trừ hết giờ demo!</span>
            </span>
        </div>
    @endif
@endif