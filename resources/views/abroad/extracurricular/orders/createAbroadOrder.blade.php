...
<div>
    <form tabindex="-1" id="{{ $popupCreateAbroadUniqId }}">
        ...
        <div class="scroll-y px-7 py-10 px-lg-17">
            ...
            <div class="row mb-4">
                {{-- HIDE THIS - temporary not using - maybe remove --}}
                <div class="col-lg-4 col-md-4 col-sm-12 col-12 mb-2 d-none">
                    <div class="form-outline">
                        <label class="required fs-6 fw-semibold mb-2" for="abroad-product-package">Gói du học</label>
                        <select data-type="package" id="abroad-product-package" class="form-select form-control" name="package"
                                data-control="select2" data-placeholder="Chọn gói..." data-allow-clear="true" data-dropdown-parent="#{{ $popupCreateAbroadUniqId }}">
                ...
                {{-- Select the abroad service by abroad type --}}
                {{-- @include('abroad.extracurricular.orders._abroadServices') --}}
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12 d-flex justify-content-center align-items-center d-none">
                    <div>
                        <input data-action="check-included-in-package-contract" type="checkbox" name="is_by_more" {{ $orderItem && $orderItem->is_by_more ? 'checked' : '' }} class="ms-2" id="included-in-abroad-package-contract-checkbox">&nbsp;&nbsp;&nbsp;Mua thêm dịch vụ
                    </div>
                </div>
            </div>
    
            <div data-control="order-item-price-form" id="abroad-order-price-form">
                <h3 class="mt-15 mb-10">Giá dịch vụ</h3>
                <div class="row mb-4">
                    <div class="col-lg-2 col-md-2 col-sm-10 col-10 mb-2">
                        <div class="form-outline">
                            <label class="required fs-6 fw-semibold mb-2" for="price-create-input">Giá bán</label>
                            <input data-control="price-form-item" id="price-create-input" type="text" class="form-control"
                                placeholder="Nhập giá bán..." name="price" value="{{ !isset($orderItem) ? '' : "$orderItem->price" }}">
                                <x-input-error :messages="$errors->get('price')" class="mt-2"/>
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-2 mt-8">
                        <div class="form-outline">
                                <select id="currency-select" class="form-select form-control" name="currency_code"
                                    data-control="select" data-dropdown-parent="#{{ $popupCreateAbroadUniqId }}">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-10 col-10 mb-2">
                        <div class="form-outline">
                            ...
                            <input data-control="price-form-item" id="discount-create-input" class="form-control" name="discount_code" type="number" min="0" max="100"
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseGpa" class="accordion-collapse collapse" aria-labelledby="headingGpa" data-bs-parent="#gpa_accordian">
                                <div class="accordion-body">
                                    @include('abroad.extracurricular.orders._gpas')
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion" id="academic_award_accordian">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#academic_award_accordian">
                                <div class="accordion-body">
                                    @include('abroad.extracurricular.orders._academicAwards')
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion" id="extra_activity_accordian">
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#extra_activity_accordian">
                                <div class="accordion-body">
                                    @include('abroad.extracurricular.orders._extraActivities')
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <script>
                ...
                //         container: () => {
                //             return document.querySelector('[data-container="{{ $abroadSharingRevenueContainerUniq }}"]');
                //         }
                //     })
                // })
            </script>
...
<script>
    ...
    $(() => {
        ...
        $('[data-control="price-input"]').on('change', e => {
            e.preventDefault();

            tool.updateTotalPrice($(e.target).val());
        })
    });
