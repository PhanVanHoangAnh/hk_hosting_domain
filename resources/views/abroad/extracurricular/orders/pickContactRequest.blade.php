@if (isset(request()->contact_ids))
                        ...
                        @if (Auth::user()->can('create', App\Models\ContactRequest::class))
                            ...
                            <script>
                                ...
                                var AddContactRequestBtn = class {
                                    ...
                                    getUrl() {
                                        return "{!! action([\App\Http\Controllers\Abroad\ContactRequestController::class, 'create'], ['contact_id' => isset($contactIds) && $contactIds ? $contactIds[0] : null, 'orderType' => isset($orderType) ? $orderType : null]) !!}";
                                    }
    ...
    @if ($newContactRequests->count())
        ...
        <div class="">
            ...
            <p>
                ...
                <strong>{{ $newContactRequests->count() }}</strong> đơn hàng chưa phát sinh dịch vụ.
                Vui lòng chọn đơn hàng cho dịch vụ này.
            </p>
                    ...
                    <tbody>
                        @foreach ($newContactRequests->get() as $request)
                            <tr request-control="row" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                ...
                                data-bs-original-title="Nhấn để chọn đơn hàng cho dịch vụ"
                            ...
                            >
                                ...
                                <td>
                                    ...
                                    @else
                                        <div><a
                                            data-bs-toggle="tooltip" data-bs-trigger="hover" title="Nhấn để chỉnh sửa dịch vụ này"
    ...
    @if ($contactRequests->count())
        ...
        <div class="">
            ...
            <p>
                Liên hệ/Khách hàng đang có
                <strong>{{ $contactRequests->count() }}</strong> đơn hàng đã phát sinh dịch vụ đang soạn.
            </p>
            <div class="table-responsive">
                <table class="table table-row-bordered table-hover table-bordered">
                    <thead>
                    ...
                    <tbody>
                        @foreach ($contactRequests->get() as $request)
                            <tr request-control="row" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                data-bs-placement="left" data-bs-dismiss="click"
                                data-bs-original-title="Không thể chọn request này do đã có dịch vụ!"
