...
@section('sidebar')
    @include('abroad.modules.sidebar', [
        ...
        'sidebar' => 'approval-extracurricular',
    ])
@endsection
                        ...
                        <div class="menu-sub menu-sub-dropdown p-3 w-200px">
                            ...
                            <div class="menu-item">
                                <a row-action="delete-all"
                                    href="{{ action([App\Http\Controllers\Abroad\ContactRequestController::class, 'deleteAll']) }}"
            ...
            <div class="card-header border-0 p-4 d-none list-filter-box pt-0 pb-0" list-action="filter-action-box">
                ...
                <div class="card-toolbar mb-0" list-action="tool-action-box">
                    ...
                    <div class="row">
                        ...
                        @if (false && Auth::user()->hasPermission(App\Library\Permission::SALES_DASHBOARD_ALL))
                            <div class="col-md-3 mb-5">
                                <!--begin::Label-->
    ...
    <script>
            ...
            return {
                init: function() {
                    ...
                    popupExportContactRequests = new Popup({
                        url: "{{ action('\App\Http\Controllers\Abroad\ContactRequestController@exportContactRequestSelected') }}",
                    });
            ...
            return {
                init: function() {
                    ...
                    popupExportContactRequest = new Popup({
                        url: "{{ action('\App\Http\Controllers\Abroad\ContactRequestController@showFilterForm') }}",
                    });
            ...
            return {
                init: function() {
                    popupEditTags = new Popup({
                        url: "{{ action('\App\Http\Controllers\Abroad\ContactRequestController@addTagsBulk') }}",
                    });
            ...
            return {
                init: function() {
                    popupDeleteTags = new Popup({
                        url: "{{ action('\App\Http\Controllers\Abroad\ContactRequestController@deleteTags') }}",
                    });
                    ...
                    if (document.querySelector('#buttonExcel')) {
                        ...
                        buttonExcelImport.addEventListener('click', e => {
                            ...
                            ExcelPopup.updateUrl(
                                "{{ action('\App\Http\Controllers\Abroad\ContactRequestController@importExcel') }}"
                            );
                        });
                    }
        ...
        var ContactRequestsList = function() {
            ...
            return {
                init: function() {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Abroad\ContactRequestController@list') }}",
