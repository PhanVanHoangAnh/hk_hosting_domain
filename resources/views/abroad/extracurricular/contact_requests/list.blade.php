                ...
                <tbody class="text-gray-600">
                    @foreach ($contactRequests as $contactRequest)
                        <tr list-control="item">
                            ...
                            @endif
                            @if (in_array('account_id', $columns) || in_array('all', $columns))
                                <td data-column="account_id" class="text-nowrap">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    @if (!$contactRequest->hasOrders())
                                        ...
                                        <div class="menu-item px-3">
                                            <a list-action="add-order"
                                                ...
                                                class="menu-link px-3">Thêm dịch vụ ngoại khoá</a>
                                        </div>
                                        <!--end::Menu item-->
                                    ...
                                    @if (Auth::user()->can('update', $contactRequest))
                                        ...
                                        <div class="menu-item px-3">
                                            <a row-action="update"
                                                href="{{ action(
                                                    [App\Http\Controllers\Abroad\ContactRequestController::class, 'edit'],
                                                    [
                                    ...
                                    @if (Auth()->user()->can('delete', $contactRequest))
                                        <div class="menu-item px-3">
                                            <a row-action="delete"
                                                href="{{ action(
                                                    [App\Http\Controllers\Abroad\ContactRequestController::class, 'destroy'],
                                                    [
                                                        'id' => $contactRequest->id,
                                                    ],
                                                ) }}"
