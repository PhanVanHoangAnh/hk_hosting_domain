...
<script script-control="calendar-script">
    ...
    var EventBox = class {
        ...
        clickAddEventButtonHandle(studyDate) {
            const url = "{{ action('App\Http\Controllers\Abroad\CalendarController@addEventInCalendar', ['study_date' => 'PLACEHOLDER']) }}";
        ...
        clickEditEventButtonHandle(code) {
            ...
            const url = "{{ action('App\Http\Controllers\Abroad\CalendarController@editEventInCalendar', ['code' => 'PLACEHOLDER']) }}";
