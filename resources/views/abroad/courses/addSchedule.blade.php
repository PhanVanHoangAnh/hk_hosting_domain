...
@php
    ...
    $action = action([App\Http\Controllers\Abroad\CourseController::class, 'createScheduleItem']);

    if(isset($weekEventEdit)) {
        $action = action([App\Http\Controllers\Abroad\CourseController::class, 'editWeekScheduleItem']);
    }

    if(isset($isAddEventInCalendar)) {
        $action = action([App\Http\Controllers\Abroad\CalendarController::class, 'createEventInCalendar'], ['isAbroad' => '1']);
    }

    if(isset($weekEventEditInCalendar)) {
        $action = action([App\Http\Controllers\Abroad\CalendarController::class, 'updateEventInCalendar']);
    }
@endphp
            ...
            <div class="row mb-8">
                ...
                <div class="card p-7 mb-4">
                    ...
                    <div class="row mb-4 py-3 d-flex align-items-start" row-control="vn-teacher">
                        ...
                        <input type="hidden" name="isAbroad" value="1">
                        <div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 col-12">
                            <div class="form-outline">
                                <select data-dropdown-parent="#{{ $popupUnidId }}" class="form-select form-control " name="vn_teacher_id"
                                    ...
                                    @foreach( App\Models\Teacher::isVietNam()->get() as $teacher) {{-- App\Models\Teacher::isVietNam()->hasPayrateBySubject($subject_id)->get() --}}
                        ...
                        <div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 col-12">
                            <div class="form-outline">
                                <select data-dropdown-parent="#{{ $popupUnidId }}" class="form-select form-control " name="foreign_teacher_id"
                                    data-control="select2" data-placeholder="Chọn giảng viên" data-allow-clear="true">
                                    <option value="">Chọn giảng viên</option>
                                    @foreach( App\Models\Teacher::isForeign()->get() as $teacher) {{-- App\Models\Teacher::isForeign()->hasPayrateBySubject($subject_id)->get() --}}
                                        <option value="{{ $teacher->id }}" 
                                        @if (isset($weekEventEdit))
                    ...
                    <label class="fs-6 fw-semibold mb-2 d-none" for="start-at">Gia sư</label>
                    <div class="row mb-4 py-3 d-flex align-items-start d-none" row-control="tutor">
                        <div class="col-lg-1 col-xl-1 col-md-1 col-sm-1 col-1 d-flex align-items-center justify-content-center" style="padding-top: 1%">
                            <div class="form-outline">
                                <input class="form-check-input" style="border: 1px solid #000;" type="checkbox" value="checked" 
                                @if (isset($weekEventEdit))
                        ...
                        <div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 col-12">
                            <div class="form-outline">
                                <select data-dropdown-parent="#{{ $popupUnidId }}" class="form-select form-control " name="tutor_id"
                                    ...
                                    @foreach( App\Models\Teacher::isTutor()->get() as $teacher) {{-- App\Models\Teacher::isTutor()->hasPayrateBySubject($subject_id)->get() --}}
                                    <option value="{{ $teacher->id }}" 
                                    @if (isset($weekEventEdit))
                    ...
                    <div class="row mb-4 py-3 d-flex align-items-start d-none" row-control="assistant">
                        <div class="col-lg-1 col-xl-1 col-md-1 col-sm-1 col-1 d-flex align-items-center justify-content-center" style="padding-top: 1%">
                            <div class="form-outline">
                                <input class="form-check-input" style="border: 1px solid #000;" type="checkbox" value="checked" 
                                @if (isset($weekEventEdit))
                        ...
                        <div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 col-12">
                            <div class="form-outline">
                                <select data-dropdown-parent="#{{ $popupUnidId }}" class="form-select form-control" name="assistant_id"
                                    ...
                                    @foreach( App\Models\Teacher::isAssistantAndAssistantKid()->get() as $teacher) {{-- App\Models\Teacher::isAssistant()->hasPayrateBySubject($subject_id)->get() --}}
                                    <option value="{{ $teacher->id }}" 
                                    @if (isset($weekEventEdit))
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-2 col-md-2 col-sm-2 col-2 mb-2">
                        <button type="button" popup-control="save"  data-action="add-schedule-btn" data-is-edit="false" class="btn btn-primary w-100">
    ...
    <script>
                ...
                init: function() {
                    document.querySelector('[data-action="suggest-teacher"]').addEventListener('click', e => {
                        ...
                        suggestTeacherPopup.updateUrl(
                            "{{ action('\App\Http\Controllers\Abroad\CourseController@suggestTeacher') }}"
                        );
                    });
                }
            }
        ...
        var AddScheduleManager = class {
            ...
            beforeSend() {
                ...
                $(this.getSaveDateBtn()).find('.indicator-label').hide();
                $(this.getSaveDateBtn()).find('.indicator-progress').show();
                $(this.getSaveDateBtn()).addClass('pe-none');
            }
