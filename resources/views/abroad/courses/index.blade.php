    ...
    <script>
        ...
        let CoursesList = function() {
            ...
            return {
                init: () => {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Abroad\CourseController@list') }}",
        ...
        let DataList = class {
            ...
            getUpdateShiftBtns() {
                return this.listContent.querySelectorAll('[row-action="update-shift"]');
            };
            ...
            initContentEvents() {
                ...
                if (this.getNumberOfItems()) {
                    ...
                    this.getUpdateShiftBtns().forEach(button => {
                    ...
                    this.getDeleteAllItemsBtn().addEventListener('click', function() {
                        ...
                        ASTool.confirm({
                            ...
                            ok: function() {
                                ...
                                $.ajax({
                                    url: "{{ action('\App\Http\Controllers\Abroad\CourseController@deleteAll') }}",
                                    method: "DELETE",
                                    data: {
                                        _token: "{{ csrf_token() }}",
                                        items: items
