...
<script>
        ...
        return {
            init: function() {
                manager = new ColumnsDisplayManagerClass({
                    ...
                    getList: function() {
                        return RefundRequestList.getList();
                    }
    ...
    var RefundRequestList = function() {
        ...
        return {
            init: () => {
                ...
                refundRequestList = new DataList({
                    url: "{{ action('App\Http\Controllers\Accounting\RefundRequestController@list') }}",
        ...
        return {
            init: () => {
                ...
                $('[list-action="order-select"]').on('change', function() {
                    ...
                    RefundRequestList.getList().setOrderId(selectedValues);
                ...
                $('[list-action="account-select"]').on('change', function() {
                    ...
                    RefundRequestList.getList().setAccountId(selectedValues);
                ...
                $('[list-action="contact-select"]').on('change', function() {
                    ...
                    RefundRequestList.getList().setContactIds(selectedValues);
                ...
                $('[list-action="refund_date-select"]').on('change', function() {
                    ...
                    // Gửi phạm vi ngày tạo đến RefundRequestList và tải lại danh sách
                    RefundRequestList.getList().setRefundateFrom(fromDate);
                    RefundRequestList.getList().setRefunđateTo(toDate);
                    RefundRequestList.getList().load();
                });
                ...
                $('[list-action="created_at-select"]').on('change', function() {
                    ...
                    // Gửi phạm vi ngày tạo đến RefundRequestList và tải lại danh sách
                    RefundRequestList.getList().setCreatedAtFrom(fromDate);
                    RefundRequestList.getList().setCreatedAtTo(toDate);
                    RefundRequestList.getList().load();
                });
                ...
                $('[list-action="updated_at-select"]').on('change', function() {
                    ...
                    RefundRequestList.getList().setUpdatedAtFrom(fromDate);
                    RefundRequestList.getList().setUpdatedAtTo(toDate);
                    RefundRequestList.getList().load();
                });
            }
        };
