    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Danh sách nhóm và tài khoản</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Quản lý nhóm và tài khoản</li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-200 w-5px h-2px"></span>
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Danh sách nhóm và tài khoản</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
                ...
                <div class="card-title" list-action="search-action-box">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input list-action="keyword-input" type="text" data-kt-customer-table-filter="search"
                            class="form-control w-250px ps-12" placeholder="Nhập để tìm nhóm và tài khoản" />
                    </div>
                    <!--end::Search-->
                </div>
    ...
    <script>
            ...
            return {
                init: function() {
                    popupDeleteAccountGroups = new Popup({
                        url: "{{ action('\App\Http\Controllers\Accounting\AccountGroupController@deleteAccountGroups') }}",
                    });
            ...
            return {
                init: function() {
                    ...
                    popupCreateAccountGroup = new Popup({
                        url: "{{ action('\App\Http\Controllers\Accounting\AccountGroupController@create') }}",
                    });
        ...
        var AccountGroupsList = function() {
            ...
            return {
                init: function() {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Accounting\AccountGroupController@list') }}",
