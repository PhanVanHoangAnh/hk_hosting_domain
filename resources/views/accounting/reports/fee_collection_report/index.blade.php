...
@section('content')
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Báo cáo thu phí</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Thu phí</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
        ...
        <div class="d-flex align-items-center py-1">
            ...
            <div class="me-3" list-action="export-contact" >
                <a type="button" data-action="under-construction"
                    href="{{ action([\App\Http\Controllers\Accounting\Report\FeeCollectionReportController::class, 'showFilterForm']) }}"
    ...
    <div id="FeeCollectionReportIndexContainer" class="position-relative" id="kt_post">
        <!--begin::Card-->
        <div class="card ">
            <!--begin::Card header-->
                    ...
                    <div class="row w-100 mb-1 list-filter-box" list-action="created_at-select">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-outline">
                                <div data-control="date-with-clear-button"
                                    ...
                                    <input data-control="input" name="payment_date_from" placeholder="=asas" type="date"
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-outline">
                                <div data-control="date-with-clear-button"
                                    class="d-flex align-items-center date-with-clear-button">
                                    <input data-control="input" name="payment_date_to" placeholder="=asas" type="date"
                                        class="form-control" placeholder="" />
                                    <span data-control="clear" class="material-symbols-rounded clear-button"
                                        style="display:none;">close</span>
                                </div>
                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-md-6 mb-5">
                            ...
                            <div class="row" list-action="updated_at-select">
                                <div class="col-md-6">
                                    <div class="form-outline">
                                        <input name="payment_date_from" type="date" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-outline">
                                        <input name="payment_date_to" type="date" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>
                            </div>
        ...
        <!--end::Card header-->
        <div id="FeeCollectionReportIndexListContent">
        </div>
    </div>
    <script>
        $(function() {
            //list
            FeeCollectionReportList.init();
            //
            ExportExcel.init();
        });
        //
        var ExportExcel = function() {
            var popupExcelFeeCollectionReport;

            // show campaign modal
            var showExportModal = function() {
                popupExcelFeeCollectionReport.load();
            };

            return {
                init: function() {
                    // create campaign popup
                    popupExcelFeeCollectionReport = new Popup({
                        url: "{{ action('\App\Http\Controllers\Accounting\Report\FeeCollectionReportController@showFilterForm') }}",
                    });
                ...
                getPopup: function() {
                    return popupExcelFeeCollectionReport;
                }
            };
        }();
        var FeeCollectionReportList = function() {
            var list;
            ...
            return {
                init: function() {
                    ...
                    // list
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Accounting\Report\FeeCollectionReportController@list') }}",
                        container: document.querySelector('#FeeCollectionReportIndexContainer'),
                    });
        ...
        var DataList = class {
            constructor(options) {
                ...
                this.listContent = this.getContainer().querySelector('#FeeCollectionReportIndexListContent');
        ...
        var FilterData = class {
            constructor(options) {
                ...
                this.list.processData = (data) => {
                    ...
                    if (updateAtFromElement && updateAtFromElement.value) {
                        data.payment_date_from = updateAtFromElement.value;
                    }

                    if (updateAtToElement && updateAtToElement.value) {
                        data.payment_date_to = updateAtToElement.value;
                    }
            ...
            getUpdateAtFrom() {
                return this.list.getContainer().querySelector('[name="payment_date_from"]');
            }

            getUpdateAtTo() {
                return this.list.getContainer().querySelector('[name="payment_date_to"]');
            }
