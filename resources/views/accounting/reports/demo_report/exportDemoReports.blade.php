...
@section('title')
    Cấu hình dữ liệu báo cáo demo
@endsection

@section('content')
    <form id="filterContactForm" action="{{ action('App\Http\Controllers\Accounting\Report\DemoReportController@exportRun') }}"
        method="POST">
        @csrf
    ...
    <script>
        ...
        $(document).ready(function() {
             ...
             $('#exportContactFilterButton').click(function(event) {
                 ...
                 $.ajax({
                     url: "{{ action('App\Http\Controllers\Accounting\Report\DemoReportController@exportRun') }}",
                     type: 'POST',
                     data: formData,
                     beforeSend: function() {
                     ...
                     success: function(response) {
                         // Download the file
                         window.location = "{{ action('App\Http\Controllers\Accounting\Report\DemoReportController@exportDownload') }}?file=" + response.file;
