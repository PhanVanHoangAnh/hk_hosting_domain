...
@section('sidebar')
    @include('accounting.modules.sidebar', [
        'menu' => 'reporting',
        'sidebar' => 'daily-sales-kpi-report',
    ])
@endsection
...
@section('content')
    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Báo cáo KPI của Sales theo ngày</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">KPI của Sales theo ngáy</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
        ...
        <div class="d-flex align-items-center py-1">
            ...
            <div class="me-3" list-action="export-contact" >
                <a type="button"
                    href="{{ action([\App\Http\Controllers\Accounting\Report\KPIReportController::class, 'showFilterForm']) }}"
    ...
    <div id="DailyKPIReportIndexContainer" class="position-relative" id="kt_post">
        <!--begin::Card-->
        <div class="card ">
            <!--begin::Card header-->
                    ...
                    <div class="row w-100 mb-1 list-filter-box" list-action="created_at-select">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-outline">
                                <div data-control="date-with-clear-button"
                                    ...
                                    <input data-control="input" name="start_at" placeholder="=asas" type="date"
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-outline">
                                <div data-control="date-with-clear-button"
                                    class="d-flex align-items-center date-with-clear-button">
                                    <input data-control="input" name="end_at" placeholder="=asas" type="date"
                                        class="form-control" placeholder="" />
                                    <span data-control="clear" class="material-symbols-rounded clear-button"
                                        style="display:none;">close</span>
                                </div>
        ...
        <!--end::Card header-->
        <div id="DailyKPIReportIndexListContent">
        </div>
    </div>
    <script>
        $(function() {
            //list
            DailyKPIReportList.init();
            //
            ExportExcel.init();
        });
        //
            ...
            return {
                init: function() {
                    ...
                    popupExcelDebtReport = new Popup({
                        url: "{{ action('\App\Http\Controllers\Accounting\Report\KPIReportController@showFilterForm') }}",
                    });
        ...
        var DailyKPIReportList = function() {
            var list;
            ...
            return {
                init: function() {
                    ...
                    // list
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Accounting\Report\KPIReportController@listDailyKPIReport') }}",
                        container: document.querySelector('#DailyKPIReportIndexContainer'),
                    });
        ...
        var DataList = class {
            constructor(options) {
                ...
                this.listContent = this.getContainer().querySelector('#DailyKPIReportIndexListContent');
        ...
        var KpiTargetFilter = class {
            ...
            applyFilter() {
                const startAtValue = this.getStartAtInput().value;
                const endAtValue = this.getEndAtInput().value;

                if (!startAtValue || !endAtValue) {
                    ASTool.warning({
                        message: 'Chọn ngày để tính KPI',
                        ok: function() {
                            // reload list
                            this.list.load();
                        }
