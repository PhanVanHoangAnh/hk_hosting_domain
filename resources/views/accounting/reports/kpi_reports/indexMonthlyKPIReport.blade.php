...
@section('content')
    ...
    <div id="MonthlyKPIReportIndexContainer" class="position-relative" id="kt_post">
        <!--begin::Card-->
        <div class="card ">
            <!--begin::Card header-->
        ...
        <!--end::Card header-->
        <div id="MonthlyKPIReportIndexListContent">
        </div>
    </div>
    <script>
        $(function() {
            //list
            MonthlyKPIReportList.init();
        });

        var MonthlyKPIReportList = function() {
            var list;
            ...
            return {
                init: function() {
                    ...
                    // list
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Accounting\Report\KPIReportController@listMonthlyKPIReport') }}",
                        container: document.querySelector('#MonthlyKPIReportIndexContainer'),
                    });
        ...
        var DataList = class {
            constructor(options) {
                ...
                this.listContent = this.getContainer().querySelector('#MonthlyKPIReportIndexListContent');
            }
