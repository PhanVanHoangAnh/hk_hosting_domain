...
@section('content')
    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Báo cáo hoàn phí</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Hoàn phí</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
        ...
        <div class="d-flex align-items-center py-1">
            ...
            <div class="me-3" list-action="export-contact">
                <a type="button"
                    href="{{ action([\App\Http\Controllers\Accounting\Report\RefundReportController::class, 'showFilterForm']) }}"
    ...
    <div id="RefundReportIndexContainer" class="position-relative" id="kt_post">
        <!--begin::Card-->
        <div class="card ">
            <!--begin::Card header-->
        ...
        <!--end::Card header-->
        <div id="RefundReportIndexListContent">
        </div>
    </div>
    <script>
        $(function() {
            //list
            RefundReportList.init();
            PopupRefuntDetailReport.init();
            //
            ExportExcel.init();
            ...
            return {
                init: function() {
                    ...
                    popupExcelContactStatusReport = new Popup({
                        url: "{{ action('\App\Http\Controllers\Accounting\Report\RefundReportController@showFilterForm') }}",
                    });
        ...
        var RefundReportList = function() {
            ...
            return {
                init: function() {
                    ...
                    // list
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Accounting\Report\RefundReportController@list') }}",
                        container: document.querySelector('#RefundReportIndexContainer'),
                    });
        ...
        var DataList = class {
            constructor(options) {
                ...
                this.listContent = this.getContainer().querySelector('#RefundReportIndexListContent');
                //
                this.perpage;
                this.page;
                this.accountIds = [];
            ...
            getDetailHourButtons() {
                return this.listContent.querySelectorAll('[row-action="detail-refund"]');
            }
            //tạo sự kiện
            initContentEvents() {
                ...
                if (this.getListItemsCount()) {
                    ...
                    this.getDetailHourButtons().forEach(button => {
                        button.addEventListener('click', (e) => {
                            ...
                            PopupRefuntDetailReport.load(url);
                        });
                    });
                }
            }
        ...
        var FilterData = class {
            constructor(options) {
                ...
                this.list.processData = (data) => {
                    ...
                    if (accountIdSelectBox && accountIdSelectBox.value) {
                        data.account_ids = $(accountIdSelectBox).select2('val');
                    }
        ...
        //
        var PopupRefuntDetailReport = function() {
            var updatePopup;
            return {
