...
@section('title')
    Cấu hình dữ liệu báo cáo hoàn phí
@endsection

@section('content')
    <form id="filterContactForm"
        action="{{ action('App\Http\Controllers\Accounting\Report\RefundReportController@exportRun') }}" method="POST">
        @csrf
    ...
    <script>
        ...
        function exportPayrateFilter() {
            ...
            $.ajax({
                url: "{{ action('App\Http\Controllers\Accounting\Report\RefundReportController@exportRun') }}",
                type: 'POST',
                data: formData,
                beforeSend: function() {
                ...
                success: function(response) {
                    // Download the file
                    window.location =
                        "{{ action('App\Http\Controllers\Accounting\Report\RefundReportController@exportDownload') }}?file=" +
                        response.file;
