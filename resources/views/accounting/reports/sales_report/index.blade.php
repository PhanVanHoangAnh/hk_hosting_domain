    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="d-flex align-items-center py-1">
            ...
            <div class="me-3" list-action="export-contact">
                <a type="button"
                    href="{{ action([\App\Http\Controllers\Accounting\Report\SalesReportController::class, 'showFilterForm']) }}"
    ...
    <script>
            ...
            return {
                init: function() {
                    ...
                    popupExcelContactStatusReport = new Popup({
                        url: "{{ action('\App\Http\Controllers\Accounting\Report\SalesReportController@showFilterForm') }}",
                    });
        ...
        var SalesReportList = function() {
            ...
            return {
                init: function() {
                    ...
                    // list
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Accounting\Report\SalesReportController@list') }}",
        ...
        var DataList = class {
            constructor(options) {
                ...
                this.listContent = this.getContainer().querySelector('#SalesReportIndexListContent');
