...
@section('content')
    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Lịch Sử Thu/Chi</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Lịch sử thu/chi</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
                ...
                <div class="card-title" list-action="search-action-box">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input list-action="keyword-input" type="text" data-kt-note-log-table-filter="search"
                            class="form-control w-250px ps-12" placeholder="Nhập để tìm phiếu thu/chi" />
                    </div>
                    <!--end::Search-->
                </div>
            ...
            <div class=" border-0 p-4 d-none list-filter-box pt-0 pb-0" list-action="filter-action-box">
                ...
                <div class="card-toolbar mb-0" list-action="tool-action-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-5 ">
                            ...
                            <div>
                                <select list-action="contact-select" class="form-select" data-control="select2"
                                    ...
                                    @php
                                        $contactIds = App\Models\PaymentRecord::pluck('contact_id')->unique();
                                    @endphp
                        ...
                        <!--end::Input-->
                        <div class="col-md-4 mb-5">
                            <label class="form-label">Ngày thanh toán (Từ - Đến)</label>
                            <div class="row" list-action="payment_date-select">
                                <div class="col-md-6">
                                    <div class="form-outline">
                                        <div data-control="date-with-clear-button"
                                            class="d-flex align-items-center date-with-clear-button">
                                            <input data-control="input" name="payment_date_from" placeholder="=asas"
                                ...
                                <div class="col-md-6">
                                    <div class="form-outline">
                                        <div data-control="date-with-clear-button"
                                            class="d-flex align-items-center date-with-clear-button">
                                            <input data-control="input" name="payment_date_to" placeholder="=asas"
                                                type="date" class="form-control" placeholder="" />
                                            <span data-control="clear" class="material-symbols-rounded clear-button"
                                                style="display:none;">close</span>
                                        </div>
    ...
    <script>
        ...
        var UpdateReceiptPopup = function() {
            var updatePopup;
        ...
        var ReceiptList = function() {
            ...
            return {
                init: () => {
                    ...
                    receiptList = new DataList({
                        url: "{{ action('App\Http\Controllers\Accounting\PaymentRecordController@list') }}",
            ...
            return {
                init: () => {
                    $('[list-action="order-select"]').on('change', function() {
                        ...
                        ReceiptList.getList().setOrderId(selectedValues);
                    ...
                    $('[list-action="account-select"]').on('change', function() {
                        ...
                        ReceiptList.getList().setAccountId(selectedValues);
                    ...
                    $('[list-action="contact-select"]').on('change', function() {
                        ...
                        ReceiptList.getList().setContactIds(selectedValues);

                        // load list
                        ReceiptList.getList().load();
                    });

                    $('[list-action="payment_date-select"]').on('change', function() {
                        // Lấy giá trị từ cả hai trường input
                        var fromDate = $('[name="payment_date_from"]').val();
                        var toDate = $('[name="payment_date_to"]').val();

                        // Gửi phạm vi ngày tạo đến ReceiptList và tải lại danh sách
                        ReceiptList.getList().setPaymentDateFrom(fromDate);
                        ReceiptList.getList().setPaymentDateTo(toDate);
                        ReceiptList.getList().load();
                    });
                    ...
                    $('[list-action="created_at-select"]').on('change', function() {
                        ...
                        // Gửi phạm vi ngày tạo đến ReceiptList và tải lại danh sách
                        ReceiptList.getList().setCreatedAtFrom(fromDate);
                        ReceiptList.getList().setCreatedAtTo(toDate);
                        ReceiptList.getList().load();
                    });
                    ...
                    $('[list-action="updated_at-select"]').on('change', function() {
                        ...
                        ReceiptList.getList().setUpdatedAtFrom(fromDate);
                        ReceiptList.getList().setUpdatedAtTo(toDate);
                        ReceiptList.getList().load();
                    });
                }
            };
        ...
        var DataList = class {
            ...
            getPaymentDateFrom() {
                return this.payment_date_from;
            };
            //payment_date_to
            setPaymentDateTo(paymentDateTo) {
                this.payment_date_to = paymentDateTo;
            }
            getPaymentDateTo() {
                return this.payment_date_to;
            };
                ...
                if (this.getNumberOfItems()) {
                    ...
                    this.getUpdateBtn().forEach(btn => {
                        btn.addEventListener('click', e => {
                            ...
                            UpdateReceiptPopup.updateUrl(btnUrl);
                        })
                    });
            ...
            load() {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        payment_date_from: this.getPaymentDateFrom(),
                        payment_date_to: this.getPaymentDateTo(),
