            ...
            <div class="fs-6">
                ...
                <span class="position-relative d-inline-block">
                    <a href="/metronic8/demo50/../demo50/pages/user-profile/projects.html"
                        class="link-white  fw-bold d-block mb-1">{{$newOrderThisMonth}}</a>
                    <!--begin::Separator-->
                    <span class="position-absolute  bottom-0 start-0 border-2 border-body border-bottom w-100"></span>
                    <!--end::Separator-->
                </span>

                <span class="">hợp đồng trong tháng</span>
            </div>
        </h3>
        <!--end::Title-->
                        ...
                        <a href="{{ action(
                            ...
                            <div class="m-0 d-flex align-items-center">
                                ...
                                <div>
                                    <!--begin::Number-->
                                        <span
                                        class="text-gray-700 fw-bolder fs-2 lh-1 ls-n1 mb-1 me-5">{{$orderPaid->count()}}</span>
                                    <!--end::Number-->
                                    <br>
                                    <!--begin::Desc-->
                ...
                <div class="col-6">
                    ...
                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-4 py-3">
                        ...
                        <a  href="{{ action(
                            ...
                            <div class="m-0 d-flex align-items-center">
                                <span class="menu-icon symbol symbol-30px me-5 mt-2" style="width: 30px;">
                                    <span class="material-symbols-rounded fs-2hx">request_quote</span>
                                </span>
                                <div>
                                    <!--begin::Number-->
                                        <span
                                        class="text-gray-700 fw-bolder fs-2 lh-1 ls-n1 mb-1 me-5">{{$orderDebt->count()}}</span>
                                    <!--end::Number-->
                                    <br>
                                    <!--begin::Desc-->
                                    <span class="text-gray-500">Quá hạn</span>
                                    <!--end::Desc-->
                                </div>
                            </div>
                        </a>
