    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Danh sách quản lý bậc lương</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Quản lý bảng lương</li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-200 w-5px h-2px"></span>
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-dark">Danh sách quản lý bậc lương</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
        ...
        <div class="d-flex align-items-center py-1">
            <div class="me-3" list-action="export-payrate">
                <a type="button"
                    href="{{ action([\App\Http\Controllers\Accounting\PayrateController::class, 'export']) }}"
    ...
    <script>
        ...
        var SalariesIndex = function() {
            return {
                init: function() {
                    ...
                    ExportPayrateHandle.init();
                }
            };
        }();

        var ExportPayrateHandle = function() {
            ...
            return {
                init: function() {
                    ...
                    popupExportContactRequest = new Popup({
                        url: "{{ action('\App\Http\Controllers\Accounting\PayrateController@export') }}",
                    });

                    // create campaign button
                    var buttonCreateExportList = document.querySelectorAll('[list-action="export-payrate"]');
            ...
            return {
                init: function() {
                    popupCreatePayrate = new Popup({
                        url: "{{ action('\App\Http\Controllers\Accounting\PayrateController@create') }}",
                    });
        ...
        var PayrateList = function() {
            ...
            return {
                init: function() {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\Accounting\PayrateController@list') }}",
