                        ...
                        <div class="w-lg-50 d-flex justify-content-center">
                            ...
                            <div class="w-sm-500px ps-10 ps-lg-15 py-20 py-lg-0">
                                ...
                                <div class="text-start mb-11">
                                    <!--begin::Title-->
                                    <h1 class="fw-bolder mb-3 text-uppercase text-dark">Khôi phục mật khẩu</h1>
                                    <!--end::Title-->
                                    <!--begin::Subtitle-->
                                ...
                                <form method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <div class="fv-row mb-8">
                                        <label for="" class="form-label fw-bold fs-5">Nhập email người dùng của bạn</label>
                                        <!--begin::Email-->
                                    ...
                                    <div class="flex items-center justify-end mt-4">
                                        <button type="submit" id="kt_sign_in_submit" class="btn btn-primary py-4">
                                            ...
                                            <span class="indicator-label fs-5">{{ __('Gửi đường dẫn khôi phục mật khẩu qua email') }}</span>
                                            <!--end::Indicator label-->
                                    ...
                                    <div class="mt-20">
                                        <a href="{{ route('login') }}" class="fw-bold link-primary">Quay về trang Đăng Nhập</a>
                                    </div>
