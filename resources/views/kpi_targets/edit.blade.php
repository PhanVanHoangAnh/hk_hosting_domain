...
@section('content')
    <form id="{{ $formId }}" action="{{ action([App\Http\Controllers\KpiTargetController::class, 'update'], [
        'id' => $kpiTarget->id,
    ]) }}" method="post">
        @csrf
        ...
        var KpiUpdateForm = function() {
            ...
            submit = () => {
                ...
                $.ajax({
                    ...
                    UpdateKpiTarget.getPopup().setContent(response.responseText);
