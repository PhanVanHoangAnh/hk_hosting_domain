    ...
    <script>
            ...
            return {
                init: function() {
                    popupDeleteAccounts = new Popup({
                        url: "{{ action('\App\Http\Controllers\System\AccountController@deleteAccounts') }}",
                    });
            ...
            return {
                init: function() {
                    ...
                    popupCreateAccount = new Popup({
                        url: "{{ action('\App\Http\Controllers\System\AccountController@create') }}",
                    });
        ...
        var AccountsList = function() {
            ...
            return {
                init: function() {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\System\AccountController@list') }}",
