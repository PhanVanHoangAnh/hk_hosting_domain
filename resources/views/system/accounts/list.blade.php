...
<div class="card-body pt-0 mt-5">
                ...
                <tbody class="text-gray-600">
                    @foreach ($accounts as $account)
                        <tr list-control="item">
                            ...
                            @if (in_array('code', $columns) || in_array('all', $columns))
                                <td data-column="code" class="text-left" data-filter="mastercard">
                                    {{ $account->code }}
                                </td>
                            @endif
                            @if (in_array('name', $columns) || in_array('all', $columns))
                            ...
                            <td data-column="action">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a row-action="update"
                                            href="{{ action(
                                                [App\Http\Controllers\System\AccountController::class, 'edit'],
                                                [
                                                    'id' => $account->id,
                                                ],
                                            ) }}"
                                    ...
                                    <div class="menu-item px-3">
                                        <a row-action="delete"
                                            href="{{ action([App\Http\Controllers\System\AccountController::class, 'destroy'], ['id' => $account->id]) }}"
    ...
    @else
        <div class="py-15">
            ...
            <p class="text-center">
                <a row-action="create" id="buttonCreateAccountList" class="btn btn-outline btn-outline-default">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#buttonCreateAccountList").on('click', function(e) {
