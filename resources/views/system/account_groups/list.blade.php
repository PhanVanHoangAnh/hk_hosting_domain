                ...
                <thead>
                    <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 text-nowrap">
                        ...
                        @if (in_array('manager', $columns) || in_array('all', $columns))
                            <th 
                                class="min-w-100px" data-column="manager">
                                <span>
                                    Quản lý
                                </span>
                            </th>
                        ...
                        @if (in_array('members', $columns) || in_array('all', $columns))
                            <th 
                                class="min-w-100px" data-column="members">
                                <span>
                                    Thành viên
                                </span>
                            </th>
                ...
                <tbody class="text-gray-600">
                    @foreach ($accountGroups as $accountGroup)
                        <tr list-control="item">
                            ...
                            @if (in_array('manager', $columns) || in_array('all', $columns))
                                <td data-column="manager" class="text-left" data-filter="mastercard">
                                    {{ $accountGroup->manager ? $accountGroup->manager->name : '--' }}
                                </td>
                            @endif

                            @if (in_array('members', $columns) || in_array('all', $columns))
                                <td data-column="members" class="text-left" data-filter="mastercard">
                                    <ul class="mb-0">
                            ...
                            <td data-column="action">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a row-action="update"
                                            href="{{ action(
                                                [App\Http\Controllers\System\AccountGroupController::class, 'edit'],
                                                [
                                                    'id' => $accountGroup->id,
                                                ],
                                            ) }}"
                                    ...
                                    <div class="menu-item px-3 ">
                                        <a row-action="delete"
                                            href="{{ action([App\Http\Controllers\System\AccountGroupController::class, 'destroy'], ['id' => $accountGroup->id]) }}"
