                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a row-action="delete-all" href="{{ action([App\Http\Controllers\System\TeacherController::class, 'deleteAll']) }}"
    ...
    <script>
                    ...
                    createBtns.forEach(button => {
                        button.addEventListener('click', e => {
                            ...
                            CreateStaffPopup.updateUrl(
                                "{{ action('\App\Http\Controllers\System\TeacherController@create') }}");
                        });
                    })
                }
            }
        ...
        let StaffsList = function() {
            ...
            return {
                init: () => {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\System\TeacherController@list') }}",
                        ...
                        this.getDeleteAllItemsBtn().addEventListener('click', function() {
                            ...
                            ASTool.confirm({
                                ...
                                ok: function() {
                                    ...
                                    $.ajax({
                                        url: "{{ action('\App\Http\Controllers\System\TeacherController@deleteAll') }}",
                                        method: "DELETE",
                                        data: {
                                            _token: "{{ csrf_token() }}",
                                            items: items
