    ...
    <div class="scroll-y pe-7 py-10 px-lg-17"  data-kt-scroll-offset="300px">
        ...
        <div class="table-responsive">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="dtHorizontalVerticalOrder">
                ...
                <tbody class="text-gray-600">
                    @foreach($teacher->freetimes as $freetime)
                        <tr>
                            <td>
                            ...
                            <td class="text-left">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        href="{{ action(
                                            [App\Http\Controllers\System\TeacherController::class, 'deleteFreeTime'],
                                            [
                                                'id' => $freetime->id,
                                            ],
                                        ) }}">Xóa</a>
                                    ...
                                    <div class="menu-item px-3">
                                        ...
                                        class="fs-6 fw-bold btn btn-info btn-outline-secondary btn-sm fs-4"
                                        href="{{ action(
                                            [App\Http\Controllers\System\TeacherController::class, 'editBusySchedule'],
                                            [
                                                'id' => $freetime->id,
                                            ],
                                        ) }}">Chỉnh sửa</a>
        ...
        @endif
            ...
            <div class="p-2 flex-grow-1 bd-highlight">
                <a href="{{ action(
                    [App\Http\Controllers\System\TeacherController::class, 'busySchedule'],
                    [
                        'id' => $teacher->id,
                    ],
                ) }}"
                    ...
                    ok: function() {
                        $.ajax({
                            ...
                            ASTool.alert({
                                ...
                                ok: () => {
                                    BusySchedulePopup.getPopup().load();
                                }
                            });
                        }).fail(function() {
