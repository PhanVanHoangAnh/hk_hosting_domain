...
@endphp
@section('content')
<form id="{{ $formId}}" tabindex="-1" enctype="multipart/form-data" method="post" action="{{ action( [App\Http\Controllers\System\TeacherController::class, 'saveBusySchedule'],
    [
        'id' => $teacher->id,
    ],
) }}">
        ...
        <div class="card p-5">
            ...
            <script>
                $(function () {
                    ...
                    if (container) {
                        var events = {!! json_encode($teacher->busy_schedule ?: []) !!};
