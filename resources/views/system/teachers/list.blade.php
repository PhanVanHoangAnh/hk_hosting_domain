...
<div class="card-body pt-0 mt-5">
    @if($staffs->count())
    <div id="staffs-table-box" class="table-responsive scrollable-orders-table freeze-column">
        <!--begin::Table-->
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="dtHorizontalVerticalOrder">
            <thead>
                <tr class="text-start bg-info text-light fw-bold fs-7 text-uppercase gs-0 bg-light text-nowrap">
                    ...
                    @if(in_array('id', $columns) || in_array('id', $columns))
                    <th list-action="sort" sort-by="id" sort-direction="{{ $sortColumn == 'id' && $sortDirection ? $sortDirection : 'desc' }}" class="text-left" data-column="id">
                        <span class="d-flex align-items-center">
                            ...
                            <span>
                                <span>
                                    <span class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'id' ? '' : 'text-muted' }}">
                                        sort
                                    </span>
                                </span>
                            </span>
                    ...
                    <th list-action="sort" sort-by="name" sort-direction="{{ $sortColumn == 'name' && $sortDirection ? $sortDirection : 'desc' }}"
                        class="min-w-125px text-left bg-info" data-control="freeze-column" data-column="name">
                        <span class="d-flex align-items-center">
                            <span>
                                Tên nhân viên
                            </span>
                            <span>
                                <span>
                                    <span class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'name' ? '' : 'text-muted' }}">
                                        sort
                                    </span>
                                </span>
                            </span>
                    ...
                    <th list-action="sort" sort-by="type" sort-direction="{{ $sortColumn == 'type' && $sortDirection ? $sortDirection : 'desc' }}" class="min-w-125px text-left" data-column="type">
                        <span class="d-flex align-items-center">
                            <span>
                                Loại hình nhân viên
                            </span>
                            <span>
                                <span>
                                    <span class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'type' ? '' : 'text-muted' }}">
                                        sort
                                    </span>
                                </span>
                            </span>
                    ...
                    <th list-action="sort" sort-by="status" sort-direction="{{ $sortColumn == 'status' && $sortDirection ? $sortDirection : 'desc' }}" class="min-w-125px text-left" data-column="status">
                        <span class="d-flex align-items-center">
                            <span>
                            ...
                            <span>
                                <span>
                                    <span class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'status' ? '' : 'text-muted' }}">
                                        sort
                                    </span>
                                </span>
                            </span>
                    ...
                    <th list-action="sort" sort-by="email" sort-direction="{{ $sortColumn == 'email' && $sortDirection ? $sortDirection : 'desc' }}" class="min-w-125px text-left" data-column="email">
                        <span class="d-flex align-items-center">
                            <span>
                                Email
                            </span>
                            <span>
                                <span>
                                    <span class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'email' ? '' : 'text-muted' }}">
                                        sort
                                    </span>
                                </span>
                            </span>
                    ...
                    <th list-action="sort" sort-by="phone" sort-direction="{{ $sortColumn == 'phone' && $sortDirection ? $sortDirection : 'desc' }}" class="min-w-125px text-left" data-column="phone">
                        <span class="d-flex align-items-center">
                            <span>
                                Điện thoại
                            </span>
                            <span>
                                <span>
                                    <span class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'phone' ? '' : 'text-muted' }}">
                                        sort
                                    </span>
                                </span>
                            </span>
                    ...
                    <th list-action="sort" sort-by="birthday" sort-direction="{{ $sortColumn == 'birthday' && $sortDirection ? $sortDirection : 'desc' }}" class="min-w-125px text-left" data-column="birthday">
                        <span class="d-flex align-items-center">
                            <span>
                                Ngày sinh
                            </span>
                            <span>
                                <span>
                                    <span class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'birthday' ? '' : 'text-muted' }}">
                                        sort
                                    </span>
                                </span>
                            </span>
                    ...
                    <th list-action="sort" sort-by="created_at" sort-direction="{{ $sortColumn == 'created_at' && $sortDirection ? $sortDirection : 'desc' }}" class="min-w-125px text-left" data-column="created_at">
                        <span class="d-flex align-items-center">
                            <span>
                            ...
                            <span>
                                <span>
                                    <span class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'created_at' ? '' : 'text-muted' }}">
                                        sort
                                    </span>
                                </span>
                            </span>
                    ...
                    <th list-action="sort" sort-by="updated_at" sort-direction="{{ $sortColumn == 'updated_at' && $sortDirection ? $sortDirection : 'desc' }}" class="min-w-125px text-left" data-column="updated_at">
                        <span class="d-flex align-items-center">
                            <span>
                                Ngày cập nhật
                            </span>
                            <span>
                                <span>
                                    <span class="material-symbols-rounded ms-2 sort-icon {{ $sortColumn == 'updated_at' ? '' : 'text-muted' }}">
                                        sort
                                    </span>
                                </span>
                            </span>
                ...
                <tr list-control="item">
                    <td class="text-left ps-1">
                        <div class="form-check form-check-sm form-check-custom">
                            <input data-item-id="{{ $staff->id }}" list-action="check-item" class="form-check-input" type="checkbox" value="1" />
                        </div>
                    </td>
                    @if(in_array('id', $columns) || in_array('all', $columns))
                    <td data-column="id" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                        {{ $staff->code }}
                    </td>
                    @endif
                    ...
                    <td data-column="type" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                        {{ trans('messages.role.' . $staff->type) }}
                    </td>
                    @endif
                    ...
                    <td data-column="status" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                        {{-- {{ trans('messages.staffs.status.' . $staff->status) }} --}}
                    ...
                    <td data-column="birthday" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                        {{ $staff->birthday ? date('d/m/Y', strtotime($staff->birthday)) : '--' }}
                    </td>
                    @endif

                    @if(in_array('created_at', $columns) || in_array('all', $columns))
                    <td data-column="created_at" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                    ...
                    <td data-column="updated_at" class="text-left mb-1 text-nowrap" data-filter="mastercard">
                        {{ $staff->updated_at ? date('d/m/Y', strtotime($staff->updated_at)) : '--' }}
                    </td>
                    @endif
                    ...
                    <td class="text-left">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a row-action="show" href="{{ action(
                                    [App\Http\Controllers\System\TeacherController::class, 'edit'],
                                    [
                                        'id' => $staff->id,
                                    ],
                                ) }}"
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ action(
                                    [App\Http\Controllers\System\TeacherController::class, 'class'],
                                    [
                                        'id' => $staff->id,
                                    ],
                                ) }}"
                            ...
                            <div class="menu-item px-3">
                                <a row-action="show"
                                    href="{{ action([App\Http\Controllers\System\TeacherController::class, 'showSchedule'],
                                        [
                                            'id' => $staff->id,
                                        ],
                                    ) }}"
                                    class="menu-link px-3">Lịch rảnh</a>
                            </div>
                            @if (Auth::user()->can('userAccount', $staff))
                                <div class="menu-item px-3 ">
                                    <a row-action="account"
                                        href="{{ action(
                                            [App\Http\Controllers\TeacherController::class, 'account'],
                                            [
                                                'id' => $staff->id,
                                            ],
                                        ) }}"
                                        class="menu-link px-3">Tài khoản người dùng</a>
                                </div>
                            @endif
                            <div class="menu-item px-3">
                                <a row-action="delete"
                                    href="{{ action([App\Http\Controllers\System\TeacherController::class, 'destroy'],
                                        [
                                            'id' => $staff->id,
                                        ],
                                    ) }}"
    ...
    <div class="py-15">
                    ...
                    <g id="Layer_2" data-name="Layer 2">
                        <g id="layer1">
                            ...
                            <path d="M157.5,12.8A5.4,5.4,0,0,0,152,7.3H28.8a5.5,5.5,0,0,0-5.5,5.5v9.9H157.5Z"
                                style="fill:#dbdbdb" />
                            <path d="M147.7,15a3.4,3.4,0,1,1,3.3,3.3A3.4,3.4,0,0,1,147.7,15Z" style="fill:#f5f5f5" />
        ...
        <p class="text-center">
            <a list-action="create-constract" href="javascript:;" id="buttonCreateNewCourse" class="btn btn-outline btn-outline-default">
    ...
    @endif
        <script>
            $(() => {
                ...
                // Teacher Account
                window.teacherAccount = new TeacherAccount({
                    buttons: $(StaffsList.getList().container).find('[row-action="account"]'),
                });
            });

            var TeacherAccount = class {
                constructor(options) {
            ...
            var HorizonScrollFix = function() {
                let staffsBox = $('#staffs-table-box');
                ...
                let applyScroll = () => {
                    staffsBox.scrollLeft(window.ordersListScrollFromLeft);
                }
                ...
                return {
                    init: function() {
                        ...
                        staffsBox.on('scroll', () => {
                            setScroll(staffsBox.scrollLeft());
                        });
                    }
                }
            }();
