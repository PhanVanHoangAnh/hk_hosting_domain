    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Nhân sự</li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-200 w-5px h-2px"></span>
                    ...
                    <div class="card-toolbar" list-action="tool-action-box">
                        ...
                        <div class="d-flex justify-content-end">
                            <div class="justify-content-end me-3">
                                <td class="text-end">
                                    <button data-action="under-construction" type="button" class="btn btn-outline btn-outline-default d-none"
                                        data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                        ...
                        <div class="row w-100">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-6 mb-5">
                                ...
                                <label class="form-label fw-semibold">Chủ nhiệm</label>
                                    ...
                                    @foreach($sectionCourses as $sectionCourse)
                                        <option value="{{ $sectionCourse->course->teacher_id }}">{{ $sectionCourse->course->teacher->name }}</option>
                                    @endforeach
                                    </select>
                            </div>
        ...
        <script>
            ...
            let SectionList = function() {
                ...
                return {
                    init: () => {
                        list = new DataList({
                            url: "{{ action('App\Http\Controllers\Edu\StaffController@teachingScheduleList', ['id' => $teacher->id]) }}",
                ...
                return {
                    init: () => {
                        ...
                        $('[list-action="start_at-select"]').on('change', function() {
                            ...
                            SectionList.getList().setStartAtFrom(fromDate);
                            SectionList.getList().setStartAtTo(toDate);
                            SectionList.getList().load();
                        });
