...
@section('content')
    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">Danh sách nhóm nhân sự</span>
            </h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">Nhóm nhân sự</li>
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-200 w-5px h-2px"></span>
        ...
        <div class="d-flex align-items-center py-1">
            <!--begin::Button-->
            <a list-action="add-staff-group" href="javascript:;" class="btn btn-flex btn-sm btn-primary fw-bold border-0 fs-6 h-45px"
    ...
    <div id="StaffIndexContainer" class="position-relative" id="kt_post">
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4"
                                ...
                                <div class="menu-item px-3">
                                    <a row-action="delete-all" href="{{ action([App\Http\Controllers\System\StaffGroupController::class, 'deleteAll']) }}"
        ...
        <div id="StaffGroupsIndexListContent">
        </div>
        <!--begin::Modals-->
    ...
    <script>
        ...
        const OrdersFeatureIndex = function() {
            ...
            return {
                init: () => {
                    ...
                    StaffGroupsList.init();
                    FilterData.init();
                    CreateStaffGroupPopup.init();
                    EditStaffGroupPopup.init();
                    CreateStaffGroupHandle.init();
                }
            }
        }();

        var CreateStaffGroupPopup = function() {
            var createPopup;
        ...
        var EditStaffGroupPopup = function() {
            var editPopup;

            return {
                init: () => {
                    editPopup = new Popup();
                    editPopup.method = 'post';
                },
                updateUrl: newUrl => {
                    editPopup.url = newUrl;
                    editPopup.load();
                },
                getPopup: () => {
                    return editPopup;
        ...
        let CreateStaffGroupHandle = function() {
            let createBtns = document.querySelectorAll('[list-action="add-staff-group"]');
                ...
                init: () => {
                    createBtns.forEach(button => {
                        button.addEventListener('click', e => {
                            e.preventDefault();
                            CreateStaffGroupPopup.updateUrl(
                                "{{ action('\App\Http\Controllers\System\StaffGroupController@create') }}");
                        });
                    })
                }
            }
            ...
            return {
                init: function() {
                    manager = new ColumnsDisplayManagerClass({
                        ...
                        getList: function() {
                                return StaffGroupsList.getList();
                        }
                    });
                },
        ...
        let StaffGroupsList = function() {
            let list;
    
            return {
                init: () => {
                    list = new DataList({
                        url: "{{ action('\App\Http\Controllers\System\StaffGroupController@list') }}",
                        container: document.querySelector("#StaffIndexContainer"),
                        listContent: document.querySelector("#StaffGroupsIndexListContent"),
            ...
            const FilterData = function() {
                ...
                const getStaffGroupTypeValues = () => {
                    staffGroupTypes = Array.from(document.querySelector('[list-action="staff-type-filter-select"]').selectedOptions)
                ...
                return {
                    init: () => {
                        ...
                        $('.filter-select').on('change', () => {
                            getStaffGroupTypeValues();
                            getStatusValues();
    
                            StaffGroupsList.getList().setStaffGroupTypes(staffGroupTypes);
                            StaffGroupsList.getList().setStatuses(statuses);
                        ...
                        $('[list-action="created_at-select"]').on('change', function() {
                            ...
                            StaffGroupsList.getList().setCreatedAtFrom(fromDate);
                            StaffGroupsList.getList().setCreatedAtTo(toDate);
                            StaffGroupsList.getList().load();
                        });
                        ...
                        $('[list-action="updated_at-select"]').on('change', function() {
                            ...
                            StaffGroupsList.getList().setUpdatedAtFrom(fromDate);
                            StaffGroupsList.getList().setUpdatedAtTo(toDate);
                            StaffGroupsList.getList().load();
                        });
                    }
                };
            ...
            let DataList = class {
                ...
                setStaffGroupTypes(staffGroupTypes) {
                    this.staffGroupTypes = staffGroupTypes;
                };
                    ...
                    if (this.getNumberOfItems()) {
                        ...
                        this.getUpdateBtns().forEach(button => {
                            button.addEventListener("click", function(e) {
                                e.preventDefault();
                                EditStaffGroupPopup.updateUrl(button.getAttribute('href'));
                            })
                        });
                        ...
                        this.getDeleteAllItemsBtn().addEventListener('click', function() {
                            ...
                            ASTool.confirm({
                                ...
                                ok: function() {
                                    ...
                                    $.ajax({
                                        url: "{{ action('\App\Http\Controllers\System\StaffGroupController@deleteAll') }}",
                                        method: "DELETE",
                                        data: {
                                            _token: "{{ csrf_token() }}",
                                            items: items
                ...
                load() {
                    ...
                    this.listXhr = $.ajax({
                        ...
                        data: {
                            ...
                            type: this.getType(),
                            staffGroupTypes: this.getStaffGroupTypes(),
