...
@section('title')
    Thêm mới nhóm nhân sự
@endsection

@section('content')
<form id="CreateStaffGroupForm" tabindex="-1" method="post"
action="javascript:;">
@csrf

@php
    $createNewStaffGroupPopupUniqId = 'createNewStaffGroupPopupUniqId_' . uniqid()
@endphp

<!--begin::Scroll-->
<div id="{{ $createNewStaffGroupPopupUniqId }}" class="scroll-y pe-7 py-20 px-lg-17">
    <!--begin::Input group-->
        ...
        <div class="col-lg-5 col-xl-5 col-md-5 col-sm-10 col-10">
            <div class="form-outline">
                ...
                <select id="staff-group-type-select" class="form-select form-control " name="type"
                    data-dropdown-parent="#{{ $createNewStaffGroupPopupUniqId }}" data-allow-clear="true"
    ...
    <div class="modal-footer flex-center">
        <!--begin::Button-->
        <button id="CreateStaffGroupSubmitButton" type="submit" class="btn btn-primary">
...
<script>
    ...
    var CreateStaffGroup = function() {
        ...
        submit = () => {
            ...
            $.ajax({
                url: "{{ action([App\Http\Controllers\System\StaffGroupController::class, 'store']) }}",
                method: 'POST',
                data: data
            }).done(response => {
        ...
        return {
            init: () => {
                form = document.querySelector("#CreateStaffGroupForm");
                submitDataBtn = document.querySelector("#CreateStaffGroupSubmitButton");
