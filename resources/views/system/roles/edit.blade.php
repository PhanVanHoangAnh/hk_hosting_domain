    ...
    <form id="UpdateRoleForm"
        ...
        <div class="scroll-y pe-7  py-10 px-lg-17">
            ...
            <ul class="nav nav-tabs nav-line-tabs mb-5 fs-6">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-active-primary btn-color-gray-600 btn-active-color-primary rounded-bottom-0 {{ $role->module == 'teacher' || $role->module == 'teaching_assistant' ? 'active' : '' }}" data-bs-toggle="tab" href="#kt_tab_pane_teacher">Giảng viên / Trợ giảng</a>
                </li>
                <li class="nav-item">
