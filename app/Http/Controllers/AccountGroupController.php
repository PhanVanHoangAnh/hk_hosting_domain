...
class AccountGroupController extends Controller
{
    ...
    {
        return view('account_groups.index', [
            'columns' => [
    ...
    public function list(Request $request)
    {
        ...
        //pagination
        $accountGroups = $accountGroups->paginate($request->perpage ?? 5);

        return view('account_groups.list', [
    ...
    public function store(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('account_groups.create', [
                'accountGroup' => $accountGroup,
                'errors' => $errors,
            ], 400);
        }
    ...
    {
        $accountGroup = AccountGroup::find($id);
        return view('account_groups.edit', [
            'accountGroup' => $accountGroup,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('account_groups.edit', [
                'accountGroup' => $accountGroup,
                'errors' => $errors,
            ], 400);
        }
    ...
    public function deleteAccountGroups(Request $request)
    {
        ...
        return view('account_groups.deleteAccountGroups', [
            'accountGroups' => $accountGroups,
        ]);
    }
