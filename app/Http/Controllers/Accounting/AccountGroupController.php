...
class AccountGroupController extends Controller
{
    ...
    {
        $listViewName = 'accounting.account_groups';
        $columns = [
            ...
            ['id' => 'manager_id', 'title' => trans('messages.account_groups.manager_id'), 'checked' => true],
        ...
        return view('accounting.account_groups.index', [
            'columns' => $columns,
    ...
    public function list(Request $request)
    {
        ...
        return view('accounting.account_groups.list', [
    ...
    public function create(Request $request)
    {
        ...
        return view('accounting.account_groups.create', [
    ...
    public function store(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('accounting.account_groups.create', [
                'accountGroup' => $accountGroup,
                'errors' => $errors,
            ], 400);
        }
    ...
    {
        $accountGroup = AccountGroup::find($id);
        return view('accounting.account_groups.edit', [
            'accountGroup' => $accountGroup,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('accounting.account_groups.edit', [
                'accountGroup' => $accountGroup,
                'errors' => $errors,
            ], 400);
        }
    ...
    public function deleteAccountGroups(Request $request)
    {
        ...
        return view('accounting.account_groups.deleteAccountGroups', [
            'accountGroups' => $accountGroups,
        ]);
    }
