...
class StudentHourReportController extends Controller
{
    ...
    {
        return view('accounting.reports.student_hour_report.index');
    }
    ...
    public function list(Request $request)
    {
        ...
        return view('accounting.reports.student_hour_report.list',[
    ...
    public function listDetailStudent(Request $request, $id,)
    {
        ...
        return view('accounting.reports.student_hour_report.listDetailStudent',[
            'orderItem' => $orderItem,
