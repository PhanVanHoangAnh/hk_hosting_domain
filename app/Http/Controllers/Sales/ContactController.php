...
class ContactController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        //     $contacts = Contact::byBranch(\App\Library\Branch::getCurrentBranch())->isNotCustomer()->where(function ($q) use ($accountIds) {
        ...
        return view('sales.contacts.list', [
            'contacts' => $contacts,
    ...
    public function create(Request $request)
    {
        ...
        //
        return view('sales.contacts.create', [
            'contact' => $contact,
            'tags' => $tags,
            'accounts' => $accounts,
        ]);
    ...
    public function store(Request $request)
    {
        ...
        // error
        if (!$errors->isEmpty()) {
            return response()->view('sales.contacts.create', [
                'contact' => $contact,
                'errors' => $errors,
                'tags' => $tags,
                'accounts' => $accounts,
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('sales.contacts.edit', [
                'contact' => $contact,
                'errors' => $errors,
                'tags' => $tags,
                'accounts' => $accounts,
    ...
    public function noteLogList(Request $request, $id)
    {
        ...
        return view('sales.contacts.note-logs-list', [
            'notes' => $notes,
            'contact' => $contact,
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    {
        return view('sales.contacts.importHubspot');
    }
    ...
    {
        return view('sales.contacts.importExcel');
    }
    ...
    public function importExcelShow(Request $request)
    {
        ...
        if ($request->file('file')) {
            ...
            return view('sales.contacts.showExcelData', [
                'datas' => $datas
            ]);
        }
    ...
    public function importExcelRunning(Request $request)
    {
        ...
        return view('sales.contacts.importExcelDone', [
            "status" => $importStatus
        ]);
    }
    ...
    public function education(Request $request, $id)
    {
        ...
        //
        return view('sales.contacts.education', [
            'contact' => $contact,
        ]);
    }
    ...
    public function contract(Request $request, $id)
    {
        ...
        $accounts = Account::sales()->get();
        //
        return view('sales.contacts.contract', [
            'contact' => $contact,
            'accounts' => $accounts,
        ]);
    }
    public function debt(Request $request, $id)
    {
        ...
        //
        return view('sales.contacts.debt', [
            'contact' => $contact,
        ]);
    }
    public function studyAbroad(Request $request, $id)
    {
        ...
        //
        return view('sales.contacts.study-abroad', [
            'contact' => $contact,
        ]);
    }
    public function extraActivity(Request $request, $id)
    {
        ...
        //
        return view('sales.contacts.extra-activity', [
            'contact' => $contact,
        ]);
    }
    public function kidTech(Request $request, $id)
    {
        ...
        //
        return view('sales.contacts.kid-tech', [
            'contact' => $contact,
        ]);
    }
    public function noteLog(Request $request, $id)
    {
        ...
        //
        return view('sales.contacts.note-logs', [
            'contact' => $contact,
            'accounts' => $accounts,
        ]);
    }
    ...
    public function updateHistory(Request $request, $id)
    {
        ...
        //
        return view('sales.contacts.update-history', [
            'contact' => $contact,
        ]);
    }
    ...
    {
        $tags = Tag::all();
        return view('sales.contacts.add-tags', [
            'tags' => $tags,
        ]);
    }
    ...
    public function deleteTags(Request $request)
    {
        ...
        return view('sales.contacts.deleteTags', [
            'contacts' => $contacts
        ]);
    }
    ...
    public function addTagsBulk(Request $request)
    {
        ...
        return view('sales.contacts.addTagsBulk', [
            'tags' => $tags,
            'contacts' => $contacts
        ]);
    }
    ...
    public function select2(Request $request)
    {
        ...
        if ($request->user()->hasPermission(Permission::SALES_DASHBOARD_ALL)) {
            $contacts = Contact::byBranch(\App\Library\Branch::getCurrentBranch());
        }  
        elseif ( $request->user()->hasPermission(Permission::SALES_ACCOUNT_GROUP_MANAGE)) {
            $accountIds = $request->user()->account->accountGroup->getAllAccountAndManagerIds();
            $contacts = Contact::byBranch(\App\Library\Branch::getCurrentBranch())->where(function ($q) use ($accountIds) {
                $q->whereIn('account_id', $accountIds)
                    ->orWhereHas('contactRequests', function ($q) use ($accountIds) {
                        $q->whereIn('account_id', $accountIds);
                    });
            ...
            $contacts = $request->user()->account->contactsOrHasContactRequests();
        }
    ...
    public function showFilterForm(Request $request)
    {
        ...
        return view('sales.contacts.export', [
    ...
    public function infoBox(Request $request, $id)
    {
        ...
        return view('sales.contacts.infoBox', [
            'contact' => $contact,
        ]);
    }
    ...
    public function relatedContactsBox(Request $request)
    {
        ...
        return view('sales.contacts.relatedContactsBox', [
            'contacts' => $contacts,
        ]);
    }
