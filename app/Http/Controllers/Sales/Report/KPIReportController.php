...
{
    public function indexDailyKPIReportIndex(Request $request)
    {
        return view('sales.report.kpi_report.indexDailyKPIReport');
    }

    public function listDailyKPIReport(Request $request)
    {
        if ($request->user()->hasPermission(Permission::SALES_REPORT_ALL)) {
            $accounts = Account::byBranch(\App\Library\Branch::getCurrentBranch());
        ...
        return view('sales.report.kpi_report.listDailyKPIReport', [
            'accounts' => $accounts,
            'request' => $request,
    ...
    public function showFilterForm(Request $request)
    {
        ...
        return view('sales.report.kpi_report.exportListDailyKPIReport', [
    ...
    {
        $templatePath = public_path('templates/sales-kpi-report.xlsx');
