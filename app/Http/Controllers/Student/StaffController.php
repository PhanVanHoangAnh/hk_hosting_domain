...
class StaffController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('student.staffs.index', [
            'columns' => $columns,
    ...
    public function list(Request $request)
    {
        ...
        return view('student.staffs.list', [
            'staffs' => $staffs,
    ...
    {
        return view('student.staffs.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('student.staffs.create', [
                'errors' => $errors,
                'staff' => $staff
            ], 400);
        }
    ...
    public function show(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('student.staffs.show', [
            'teacher' => $teacher,
            'courses' => $courses,
    ...
    public function busySchedule(Request $request, $id)
    {
       $teacher = Teacher::find($id);
        ...
        return view('student.staffs.busy-schedule', [
            'teacher' => $teacher,
        ]);
    }
    ...
    public function showFreeTimeSchedule(Request $request)
    {
        ...
        return view('student.staffs.busySchedule', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses,
    ...
    public function showSchedule(Request $request)
    {
        ...
        return view('student.staffs.show-busy-schedule', [
            'teacher' => $teacher,
        ]);
    }
    ...
    public function editBusySchedule(Request $request)
    {
        ...
        return view('student.staffs.edit-busy-schedule', [
            'freeTime' => $freeTime,
    ...
    public function class(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('student.staffs.class', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses,
            'columns' => [
    ...
    public function classList(Request $request, $id)
    {
        ...
        //
        return view('student.staffs.classList', [
            'courses' => $courses,
            'teacher' => $teacher,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function calendar(Request $request, $id)
    {
        ...
        return view('student.staffs.calendar', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses,
    ...
    public function teachingSchedule(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('student.staffs.teachingSchedule', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses
        ]);
    ...
    public function teachingScheduleList(Request $request, $id)
    {
        ...
        return view('student.staffs.teachingScheduleList', [
            'sections' => $sections,
            'students' => $students,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function salarySheet(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('student.staffs.salarySheet', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses
        ]);
    ...
    public function salarySheetList(Request $request, $id)
    {
        ...
        return view('student.staffs.salarySheetList', [
    ...
    public function expenseHistory(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('student.staffs.expenseHistory', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses
        ]);
