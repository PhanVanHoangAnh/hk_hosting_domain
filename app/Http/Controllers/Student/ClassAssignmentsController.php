...
class ClassAssignmentsController extends Controller
{
    ...
    {
        $listViewName = 'student.class_assignments';
        $columns = [
        ...
        return view('student.class_assignments.index', [
            'columns' => $columns,
    ...
    public function list(Request $request)
    {
        ...
        return view('student.class_assignments.list', [
            'classes' => $classes,
    ...
    {
        $classes = OrderItem::byBranch(\App\Library\Branch::getCurrentBranch());
