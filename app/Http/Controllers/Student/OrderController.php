...
class OrderController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $query = $contact->signedOrStudentOfOrders()->approved();
        ...
        return view('student.orders.list', [
            'orders' => $orders,
    ...
    public function createConstract(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('student.orders.' . $viewReturn, [
                'errors' => $errors,
                'order' => $order,
                'type' => $request->type,
    ...
    {
        return view('student.orders.deleteOrder', [
            "orderId" => $orderId
        ]);
    }
    ...
    public function showFormCreateConstract(Request $request)
    {
        ...
        return view('student.orders.createConstract', [
            "orderId" => $orderId,
            "order" => $order,
    ...
    public function showCreateExtraPopup(Request $request)
    {
        ...
        return view('student.orders.createExtraItem', [
            'abroadApplications' => $abroadApplications,
            'order' => $order,
    ...
    public function createTrainOrder(Request $request)
    {
        ...
        return view('student.orders.createTrainOrder', [
            'orderId' => $request->orderId,
            'orderItemId' => isset($orderItemId) ? $orderItemId : null,
            'copyOrderItemId' => isset($request->currOrderItemId) ? $request->currOrderItemId : null,
            'raw_sales_revenued_list' => $sales_revenued_list,
    ...
    public function createAbroadOrder(Request $request)
    {
        ...
        return view('student.orders.createAbroadOrder', [
            'orderId' => $request->orderId,
            'orderItemId' => isset($orderItemId) ? $orderItemId : null,
            'orderItem' => $orderItem,
            'copyOrderItemId' => isset($request->currOrderItemId) ? $request->currOrderItemId : null,
    ...
    public function createDemoOrder(Request $request)
    {
        ...
        return view('student.orders.createDemoOrder', [
            'orderId' => $request->orderId,
    ...
    public function pickContact(Request $request)
    {
        ...
        return view('student.orders.pickContact', [
            'order' => $order,
    ...
    public function pickContactForRequestDemo(Request $request)
    {
        ...
        return view('student.orders.pickContactForRequestDemo', [
            'order' => $order,
            'copyFromOrder' => $copyFromOrder,
        ]);
    }
    ...
    public function showConstract(Request $request)
    {
        ...
        return view('student.orders.showConstract', [
            'order' => $order,
    ...
    public function pickContactRequest(Request $request)
    {
        ...
        return view('student.orders.pickContactRequest', [
    ...
    public function relationshipForm(Request $request)
    {
        ...
        return view('student.orders.relationshipForm', [
            'contact' => $contact,
            'toContact' => $toContact,
        ]);
    }
    ...
    public function showQrCode(Request $request, $id)
    {
        ...
        return view('student.orders.qrCode', [
           'order' => $order,
    ...
    public function historyRejected(Request $request, $id)
    {
        ...
        return view('student.orders.historyRejected', [
           'order' => $order,
