...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('student.students.create', [
                'contact' => $contact,
                'errors' => $errors,
                'tags' => $tags,
                'accounts' => $accounts,
    ...
    public function noteLogsPopup(Request $request, $id)
    {
        ...
        return view('student.students.note-logs-popup', [
            'notes' => $notes,
            'contact' => $contact,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('student.students.edit', [
                'contact' => $contact,
                'errors' => $errors,
                'tags' => $tags,
                'accounts' => $accounts,
    ...
    public function class(Request $request, $id)
    {
        ...
        return view('student.students.class', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function classList(Request $request, $id)
    {
        ...
        //
        return view('student.students.classList', [
            'courseStudents' => $courseStudents,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function calendar(Request $request, $id)
    {
        ...
        return view('student.students.calendar', [
            'contact' => $contact,
            'courseStudents' => $courseStudents,
    ...
    public function section(Request $request, $id)
    {
        ...
        $courseStudents = CourseStudent::where('student_id', $id)->get();
        //
        return view('student.students.section', [
            'contact' => $contact,
            'orderItems' => $orderItems,
            'courseStudents' => $courseStudents
        ]);
    ...
    public function sectionList(Request $request, $id)
    {
        ...
        return view('student.students.sectionList', [
            'contact' => $contact,
            'sections' => $sections,
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    public function schedule(Request $request, $id)
    {
        ...
        return view('student.students.schedule', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
    ...
    public function contract(Request $request, $id)
    {
        ...
        //
        return view('student.students.contract', [
            'courseStudents' => $courseStudents,
            'contact' => $contact,
            'accounts' => $accounts,
    ...
    public function contractList(Request $request, $id)
    {
        ...
        return view('student.students.contract-list', [
            'contact' => $contact,
            'accounts' => $accounts,
            'orders' => $orders,
    ...
    public function noteLog(Request $request, $id)
    {
        ...
        return view('student.students.note-logs', [
            'courseStudents' => $courseStudents,
            'contact' => $contact,
            'accounts' => $accounts,
        ]);
    ...
    public function noteLogList(Request $request, $id)
    {
        ...
        return view('student.students.note-logs-list', [
            'notes' => $notes,
            'contact' => $contact,
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    public function extraActivity(Request $request, $id)
    {
        ...
        $courseStudents = CourseStudent::where('student_id', $id)->get();
        //
        return view('student.students.extra-activity', [
            'contact' => $contact,
            'courseStudents' => $courseStudents
        ]);
    }
    ...
    public function kidTech(Request $request, $id)
    {
        $contact = Contact::find($id);
        $courseStudents = CourseStudent::where('student_id', $id)->get();
        return view('student.students.kid-tech', [
            'contact' => $contact,
            'courseStudents' => $courseStudents
        ]);
    }
    ...
    public function assignToClass(Request $request)
    {
        ...
        return view('student.students.assignToClass', [
            'student' => $student,
        ]);
    }
    ...
    public function orderForm(Request $request)
    {
        ...
        return view('student.students.order_form', [
            'orders' => $orders
        ]);
    }
    ...
    public function eduItemsForm(Request $request)
    {
        ...
        return view('student.students.orderItemForm', [
            'orderItems' => $orderItems,
            'student' => $student
        ]);
    }
    ...
    public function courseForm(Request $request)
    {
        ...
        return view('student.students.course_form', [
            'courses' => $courses
        ]);
    }
    ...
    public function studyPartner(Request $request)
    {
        ...
        return view('student.students.studyPartner', [
            'section' => $section,
            'studentId' => $studentId
        ]);
    }
    ...
    public function sectionForm(Request $request)
    {
        ...
        return view('student.students.section_form', [
            'sections' => $sections
        ]);
    }
    ...
    public function courseStudentForm(Request $request)
    {
        ...
        return view('student.students.course_student_form', [
            'courseStudents' => $courseStudents,
            'studentId' => $studentId
        ]);
    }
    ...
    public function sectionStudent(Request $request)
    {
        ...
        return view('student.students.section_student_form', [
            'sections' => $sections
        ]);
    }
    ...
    public function coursePartner(Request $request)
    {
        ...
        return view('student.students.course_partner_form', [
    ...
    public function transferClass(Request $request)
    {
        ...
        return view('student.students.transferClass', [
            'student' => $student,
    ...
    public function courseTransferStudentForm(Request $request)
    {
        ...
        return view('student.students.course_transfer_student_form', [
    ...
    public function courseTransfer(Request $request)
    {
        ...
        return view('student.students.course_transfer_form', [
    ...
    public function reserveClass(Request $request)
    {
        ...
        return view('student.students.reserveClass', [
            'student' => $student,
            'currentCourse' => $currentCourse
        ]);
    }
    ...
    public function courseReserveStudentForm(Request $request)
    {
        ...
        return view('student.students.course_reserve_student_form', [
            'currentCourses' => $currentCourses,
            'currentCourseStudentId' => $currentCourseStudentId,
        ]);
    }
    ...
    public function refundRequest(Request $request)
    {
        ...
        return view('student.students.refundRequest', [
            'student' => $student,
            'currentCourse' => $currentCourse
        ]);
    }
    ...
    public function courseRefundRequestForm(Request $request)
    {
        ...
        return view('student.students.course_refund_request_form', [
            'currentCourses' => $currentCourses,
            'studentId' => $studentId,
        ]);
    }
    ...
    public function orderItemRefundRequestForm(Request $request)
    {
        ...
        return view('student.students.order_item_refund_request_form', [
            'orderItems' => $orderItems,
    ...
    public function assignToClassRequestDemo(Request $request)
    {
        ...
        return view('student.students.assignToClassRequestDemo', [
            'student' => $student,
        ]);
    }
    ...
    public function orderFormRequestDemo(Request $request)
    {
        ...
        return view('student.students.order_form_request_demo', [
            'orders' => $orders
        ]);
    }
    ...
    public function orderItemFormRequestDemo(Request $request)
    {
        ...
        return view('student.students.orderItemFormRequestDemo', [
            'orderItems' => $orderItems
        ]);
    }
    ...
    public function courseFormRequestDemo(Request $request)
    {
        ...
        return view('student.students.course_form_request_demo', [
            'courses' => $courses
        ]);
    }
    ...
    public function sectionFormRequestDemo(Request $request)
    {
        ...
        return view('student.students.section_form_request_demo', [
            'sections' => $sections
        ]);
    }
    ...
    public function refund(Request $request, $id)
    {
        ...
        return view('student.students.refund', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function refundList(Request $request, $id)
    {
        ...
        return view('student.students.refundList', [
            'requests' => $requests,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function reserve(Request $request)
    {
        ...
        return view('student.reserve.reserve', [
            'student' => $student,
            'currentCourse' => $currentCourse
        ]);
    }
    ...
    public function orderItemReserveForm(Request $request)
    {
        ...
        return view('student.reserve.orderItemReserveForm', [
            'orderItems' => $orderItems,
            'studentId' => $studentId,
        ]);
    }
    ...
    public function courseReserveForm(Request $request)
    {
        ...
        return view('student.reserve.courseReserveForm', [
            'currentCourses' => $currentCourses,
            'studentId' => $studentId,
        ]);
    }
    ...
    public function transfer(Request $request)
    {
        ...
        return view('student.students.transfer', [
            'student' => $student,
            'currentCourse' => $currentCourse
        ]);
    }
    ...
    public function transferOrderItemSelect(Request $request)
    {
        ...
        return view('student.students.transferOrderItemSelect', [
            'orderItems' => $orderItems,
            'studentId' => $studentId,
        ]);
    }
    ...
    public function transferFormDetail(Request $request)
    {
        ...
        return view('student.students.transferFormDetail', [
            'currentCourses' => $currentCourses,
            'studentId' => $studentId,
            'orderItem' => $orderItem
        ]);
    ...
    public function reserveStudentDetail(Request $request, $id)
    {
        ...
        return view('student.students.reserveStudentDetail', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function reserveList(Request $request, $id)
    {
        ...
        return view('student.students.reserveList', [
            'reserves' => $reserves,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function transferStudentDetail(Request $request, $id)
    {
        ...
        return view('student.students.transferStudentDetail', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function transferList(Request $request, $id)
    {
        ...
        return view('student.students.transferList', [
            'transfers' => $transfers,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function exitClass(Request $request)
    {
        ...
        return view('student.students.exitClass', [
            'student' => $student,
            'course' => $course
        ]);
    }
    ...
    public function showFreeTimeSchedule(Request $request)
    {
        ...
        return view('student.students.busySchedule', [
            'student' => $student,
            'contact' => $student,
            'orderItems' => $orderItems,
            'courseStudents' => $courseStudents
    ...
    public function showFreeTimeScheduleOfStudent(Request $request)
    {
        ...
        return view('student.students.show-freetime-schedule', [
            'contact' => $contact,
        ]);
    }
    ...
    public function createFreetimeSchedule(Request $request)
    {
        ...
        return view('student.students.create-freetime-schedule', [
            'contact' => $contact,
        ]);
    }
    ...
    public function editFreetimeSchedule(Request $request)
    {
        ...
        return view('student.students.edit-freetime-schedule', [
            'freeTime' => $freeTime,
