...
class TeacherHourReportController extends Controller
{
    ...
    {
        return view('student.reports.teacher_hour_report.index');
    }
    ...
    public function list(Request $request)
    {
        ...
        return view('student.reports.teacher_hour_report.list',[
            'teachers' => $teachers,
    ...
    public function listDetailTeacher(Request $request, $id)
    {
        ...
        return view('student.reports.teacher_hour_report.listDetailTeacher',[
            'teacher' => $teacher,
