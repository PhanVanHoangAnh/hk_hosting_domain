...
class SectionController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('student.sections.list', [
            'sections' => $sections,
    ...
    {
        return view('student.sections.calendar', [
            'columns' => [
                ['id' => 'course_id', 'title' => trans('messages.section.course_id'), 'title' => trans('messages.section.course_id'), 'checked' => true],
                ['id' => 'study_date', 'title' => trans('messages.section.study_date'), 'checked' => true],
                ['id' => 'start_at', 'title' => trans('messages.section.start_at'), 'checked' => true],
    ...
    public function eduCalendarContent(Request $request)
    {
        ...
        return view('student.sections.calendarContent', [
            'sections' => $sections,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    public function changeTeacherPopup(Request $request, $id)
    {
        ...
        return view('student.sections.changeTeacherPopup', [
            'students' =>   $students,
            'section' => $section
        ]);
    }
    ...
    public function saveChangeTeacherPopup(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('student.sections.changeTeacherPopup', [
                'section' => $section,
                'errors' => $errors,
            ], 400);
        }
    ...
    public function shiftPopup(Request $request)
    {
        ...
        return view('student.sections.shiftPopup', [
            'students' =>   $students,
            'section' => $section
        ]);
    }
    ...
    {
        return response()->view('student.courses.show_start_links_popup', [
    ...
    public function showZoomJoinLinks(Request $request)
    {
        ...
        return response()->view('student.courses.show_join_links_popup', [
            'section' => $section,
    ...
    public function updateZoomLinksPopup(Request $request, $id)
    {
        ...
        return view('student.courses.updateZoomLinksPopup', [
            'section' => $section,
    ...
    public function createZoomLinksForOfflineSectionPopup(Request $request, $id)
    {
        ...
        return view('student.courses.createZoomLinksForOfflineSectionPopup', [
            'section' => $section,
            'zoomUsers' => $zoomUsers->toArray(),
        ]);
    }
    ...
    public function updateZoomLinks(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            ...
            return response()->view('student.courses.updateZoomLinksPopup', [
                'section' => $section,
                'errors' => $errors,
                'zoomUsers' => $zoomUsers->toArray(),  
    ...
    public function createZoomLinksForOfflineSection(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            ...
            return response()->view('student.courses.createZoomLinksForOfflineSectionPopup', [
                'section' => $section,
                'errors' => $errors,
                'zoomUsers' => $zoomUsers->toArray(),  
                'switch' => isset($request->zoom_switch) && $request->zoom_switch == "on" ? true : false,
