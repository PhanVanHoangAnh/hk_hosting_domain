...
class ContactController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('student.contacts.index', [
            'accounts' => $accounts,
            'tags' => $tags,
    ...
    {
        // init
        $contacts = $request->user()->account->onlyContacts();
        ...
        return view('student.contacts.list', [
            'contacts' => $contacts,
    ...
    public function create(Request $request)
    {
        ...
        //
        return view('student.contacts.create', [
            'contact' => $contact,
            'tags' => $tags,
            'accounts' => $accounts,
        ]);
    ...
    public function store(Request $request)
    {
        ...
        // error
        if (!$errors->isEmpty()) {
            return response()->view('student.contacts.create', [
                'contact' => $contact,
                'errors' => $errors,
                'tags' => $tags,
                'accounts' => $accounts,
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('student.contacts.edit', [
                'contact' => $contact,
                'errors' => $errors,
                'tags' => $tags,
                'accounts' => $accounts,
    ...
    public function edit(Request $request, $id)
    {
        ...
        // 
        return view('student.contacts.edit', [
            'contact' => $contact,
            'tags' => $tags,
            'accounts' => $accounts,
        ]);
    ...
    public function noteLogList(Request $request, $id)
    {
        ...
        return view('student.contacts.note-logs-list', [
            'notes' => $notes,
            'contact' => $contact,
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    {
        return view('student.contacts.importHubspot');
    }
    ...
    {
        return view('student.contacts.importExcel');
    }
    ...
    public function importExcelShow(Request $request)
    {
        ...
        if ($request->file('file')) {
            ...
            return view('student.contacts.showExcelData', [
                'datas' => $datas
            ]);
        }
    ...
    public function importExcelRunning(Request $request)
    {
        ...
        return view('student.contacts.importExcelDone', [
            "status" => $importStatus
        ]);
    }

    // public function importExcelAllRunning(Request $request)
    // {
    //     // $datas = json_decode($request->getContent(), true);
    //     $datas = // xử lý từ file excel. Đọc qua file để thay vì $request->getContent(), thì là map từ file để chạy chung 1 hàm saveExcelDatas
    ...
    //     $importStatus = Contact::saveExcelDatas($excelDatas, $accountId); // ==> job ==> ghi vô trong session or file. queue:work, ImportWorker...
    ...
    // public function importExcelAllProccess(Request $request) // js request mỗi 2 giấy
    // {
    //     $progress = 50; // đọc progress từ session/file
    //     return view('student.contacts.importExcelAllProccess', [
    //         "progress" => 50,
    //     ]);
    // }
    ...
    public function show(Request $request, $id)
    {
        ...
        //
        return view('student.contacts.show', [
            'contact' => $contact,
            'accounts' => $accounts,
        ]);
    }
    ...
    public function education(Request $request, $id)
    {
        ...
        //
        return view('student.contacts.education', [
            'contact' => $contact,
        ]);
    }
    ...
    public function contract(Request $request, $id)
    {
        ...
        $accounts = Account::sales()->get();
        //
        return view('student.contacts.contract', [
            'contact' => $contact,
            'accounts' => $accounts,
        ]);
    }
    public function debt(Request $request, $id)
    {
        ...
        //
        return view('student.contacts.debt', [
            'contact' => $contact,
        ]);
    }
    public function studyAbroad(Request $request, $id)
    {
        ...
        //
        return view('student.contacts.study-abroad', [
            'contact' => $contact,
        ]);
    }
    public function extraActivity(Request $request, $id)
    {
        ...
        //
        return view('student.contacts.extra-activity', [
            'contact' => $contact,
        ]);
    }
    public function kidTech(Request $request, $id)
    {
        ...
        //
        return view('student.contacts.kid-tech', [
            'contact' => $contact,
        ]);
    }
    public function noteLog(Request $request, $id)
    {
        ...
        //
        return view('student.contacts.note-logs', [
            'contact' => $contact,
            'accounts' => $accounts,
        ]);
    }
    ...
    public function updateHistory(Request $request, $id)
    {
        ...
        //
        return view('student.contacts.update-history', [
            'contact' => $contact,
        ]);
    }
    ...
    {
        $tags = Tag::all();
        return view('student.contacts.add-tags', [
            'tags' => $tags,
        ]);
    }
    ...
    public function deleteTags(Request $request)
    {
        ...
        return view('student.contacts.deleteTags', [
            'contacts' => $contacts
        ]);
    }
    ...
    public function addTagsBulk(Request $request)
    {
        ...
        return view('student.contacts.addTagsBulk', [
            'tags' => $tags,
            'contacts' => $contacts
        ]);
    }
    ...
    public function showFilterForm(Request $request)
    {
        ...
        return view('student.contacts.export', [
    ...
    {
        $query = $request->user()->account->onlyContacts();
    ...
    public function infoBox(Request $request, $id)
    {
        ...
        return view('student.contacts.infoBox', [
            'contact' => $contact,
        ]);
    }
    ...
    public function relatedContactsBox(Request $request)
    {
        ...
        return view('student.contacts.relatedContactsBox', [
            'contacts' => $contacts,
        ]);
    }
