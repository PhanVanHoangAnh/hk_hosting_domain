...
class CourseController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            ...
            return response()->view('edu.courses._form', [
                'errors' => $errors,
                'course' => $course,
                'action' => 'add',
    ...
    public function editCalendar(Request $request)
    {
        ...
        return view('edu.courses.editCalendar', [
            'action' => 'edit',
            'course' => $course,
            'sections' => $sections,
            'zoomUsers' => $zoomUsers->toArray(),
    ...
    public function updateCalendar(Request $request)
    {
        ...
        $errors = $course->editFromRequest($request);
        ...
        if (!$errors->isEmpty()) {
            ...
            return response()->view('edu.courses._form_edit_calendar', [
                'action' => 'edit',
                'errors' => $errors,
                'course' => $course,
    ...
    public function update(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('edu.courses.edit', [
                'errors' => $errors,
                'course' => $course,
                'action' => 'edit'
            ], 400);
    ...
    public function showDetail(Request $request, $id)
    {
        ...
        return view('edu.courses.showDetail', [
            'course' => $course,
        ]);
    }
    ...
    public function students(Request $request, $id)
    {
        ...
        return view('edu.courses.students', [
            'course' => $course,
            'students' => $students,
        ]);
    }
    ...
    public function studentList(Request $request, $id)
    {
        ...
        return view('edu.courses.studentList', [
            'course' => $course,
            'students' => $students,
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    public function schedule(Request $request, $id)
    {
        ...
        return view('edu.courses.schedule', [
            'course' => $course,
            'sections' => $sections
        ]);
    }
    ...
    public function sections(Request $request, $id)
    {
        ...
        return view('edu.courses.sections', [
            'course' => $course,
            'sections' => $sections
        ]);
    }
    ...
    public function sectionList(Request $request, $id)
    {
        ...
        //
        return view('edu.courses.sectionList', [
            'sections' => $sections,
            'students' => $students,
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    public function reschedulePopup(Request $request, $id)
    {
        ...
        return view('edu.courses.reschedulePopup', [
    ...
    public function updateSchedulePopup(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            ...
            return response()->view('edu.courses.reschedulePopup', [
                'section' => $section,
                'errors' => $errors,
                'sectionAll' => $sectionAll,
                'students' => $students,  
    ...
    public function attendancePopup(Request $request, $id)
    {
        ...
        return view('edu.courses.attendancePopup', [
            'students' =>   $students,
            'section' => $section
        ]);
    }
    ...
    public function courseStopped(Request $request)
    {
        ...
        return view('edu.courses.courseStopped', [
            'course' => $course
        ]);
    }
    ...
    public function suggestTeacher(Request $request)
    {
        ...
        return view('edu.courses.suggest_teacher', [
            'subjects' => $subjects
        ]);
    }
    ...
    public function assignStudentToClass(Request $request)
    {
        ...
        return view('edu.courses.assignStudentToClass', [
