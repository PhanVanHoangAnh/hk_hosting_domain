...
class SectionReportsController extends Controller
{
    public function reportSection(Request $request, $id)
    {
        ...
        return view('edu.courses.reportSection', [
            'course' => $course,
            'sections' => $sections
        ]);
    }
    ...
    public function getSectionReportData(Request $request)
{
    ...
    public function saveReportSectionInCourse(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('edu.courses.reportSection', [
    ...
    public function saveReportSection(Request $request, $id, $contact_id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('edu.report_sections.create', [
                'sectionReport'=> $sectionReport,
                'contact' => $contact,
                'section' => $section,
                'errors' => $errors,
    ...
    public function updateReportSection(Request $request, $id, $contact_id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('edu.report_sections.edit', [
                'sectionReport'=> $sectionReport,
                'contact' => $contact,
                'section' => $section,
                'errors' => $errors,
    ...
    public function saveReportSectionPopup(Request $request, $id, $contact_id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('edu.report_sections.create-report-section-popup', [
                'sectionReport'=> $sectionReport,
                'contact' => $contact,
               'section' => $section,
                'errors' => $errors,
    ...
    public function create(Request $request, $id, $contact_id)
    {
        ...
        return view('edu.report_sections.create', [
            'contact' => $contact,
            'section' => $section
        ]);
    }
    ...
    public function edit(Request $request, $id, $contact_id)
    {
        ...
        return view('edu.report_sections.edit', [
            'sectionReport' => $sectionReport,
            'contact' => $contact,
            'section' => $section
    ...
    public function reportSectionPopup(Request $request, $id, $course_id)
    {
        ...
        return view('edu.report_sections.report-section-popup', [
            'student' => $student,
            'course' => $course,
    ...
    public function createReportSectionPopup(Request $request, $id, $course_id)
    {
        ...
        return view('edu.report_sections.create-report-section-popup', [
            'student' => $student,
            'course' => $course,
            'sections' => $sections,
            'sectionReports' => $sectionReports
