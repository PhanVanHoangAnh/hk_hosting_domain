...
class OrderController extends Controller
{
    ...
    {
        // List view & Columns
        $listViewName = 'abroad.extracurricular.orders';
        $columns = [
            ...
            ['id' => 'parent_note', 'title' => trans('messages.order.parent_note'), 'checked' => false],
        ...
        return view('abroad.extracurricular.orders.index', [
    ...
    public function list(Request $request)
    {
        ...
        return view('abroad.extracurricular.orders.list', [
            'orders' => $orders,
    ...
    public function createConstract(Request $request)
    {
        ...
        if ($request->copy_from_order_id) {
            if (!isset($request->contact_id)) {
                ...
                return response()->view('abroad.extracurricular.orders.' . $viewReturn, [
                    'errors' => $errors,
                    'order' => $order,
                    'type' => $request->type,
    ...
    {
        return view('abroad.extracurricular.orders.deleteOrder', [
            "orderId" => $orderId
        ]);
    }
    ...
    public function showFormCreateConstract(Request $request)
    {
        ...
        return view('abroad.extracurricular.orders.createConstract', [
            "orderId" => $orderId,
            "order" => $order,
    ...
    // public function saveExtraItem(Request $request)
    // {
    //     $order = Order::find($request->order_id);
    ...
    //     if (!$errors->isEmpty()) {
    //         return view('abroad.extracurricular.orders.createExtraItem', [
    //             "errors" => $errors,
    ...
    public function saveOrderItemData(Request $request)
    {
        ...
        $viewName;
        $prefix = 'abroad.extracurricular.orders.';
    ...
    public function createTrainOrder(Request $request)
    {
        ...
        return view('abroad.extracurricular.orders.createTrainOrder', [
            'orderId' => $request->orderId,
            'orderItemId' => isset($orderItemId) ? $orderItemId : null,
            'copyOrderItemId' => isset($request->currOrderItemId) ? $request->currOrderItemId : null,
            'raw_sales_revenued_list' => $sales_revenued_list,
    ...
    public function createAbroadOrder(Request $request)
    {
        ...
        return view('abroad.extracurricular.orders.createAbroadOrder', [
            'orderId' => $request->orderId,
            'orderItemId' => isset($orderItemId) ? $orderItemId : null,
            'orderItem' => $orderItem,
            'copyOrderItemId' => isset($request->currOrderItemId) ? $request->currOrderItemId : null,
    ...
    public function createDemoOrder(Request $request)
    {
        ...
        return view('abroad.extracurricular.orders.createDemoOrder', [
            'orderId' => $request->orderId,
    ...
    public function pickContact(Request $request)
    {
        ...
        return view('abroad.extracurricular.orders.pickContact', [
            'order' => $order,
    ...
    public function pickContactForRequestDemo(Request $request)
    {
        ...
        return view('abroad.extracurricular.orders.pickContactForRequestDemo', [
            'order' => $order,
            'copyFromOrder' => $copyFromOrder,
        ]);
    }
    ...
    public function showConstract(Request $request)
    {
        ...
        return view('abroad.extracurricular.orders.showConstract', [
            'order' => $order,
    ...
    public function pickContactRequest(Request $request)
    {
        ...
        $newContactRequests = ContactRequest::whereIn('contact_id', $request->contact_ids)
            ->doesntHaveNewOrder()->where('account_id', $userId);

        $contactRequests = ContactRequest::whereIn('contact_id', $request->contact_ids)
            ->haveOrderIsDraft();

        return view('abroad.extracurricular.orders.pickContactRequest', [
    ...
    public function relationshipForm(Request $request)
    {
        ...
        return view('abroad.extracurricular.orders.relationshipForm', [
            'contact' => $contact,
            'toContact' => $toContact,
        ]);
    }
    ...
    {
        $order = Order::find($id);
        $paymentAccount = $order->salesperson->accountGroup ? $order->salesperson->accountGroup->paymentAccountEdu()->first() : null;
        
        return view('abroad.extracurricular.orders.qrCode', [
           'order' => $order,
    ...
    public function historyRejected(Request $request, $id)
    {
        ...
        return view('abroad.extracurricular.orders.historyRejected', [
           'order' => $order,
