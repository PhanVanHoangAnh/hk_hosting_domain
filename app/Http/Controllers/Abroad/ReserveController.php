...
class ReserveController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('abroad.reserve.index', [
            'accounts' => $accounts,
            'tags' => $tags,
    ...
    public function list(Request $request)
    {
        ...
        return view('abroad.reserve.list', [
            'reserves' => $reserves,
    ...
    public function reserveStudent(Request $request)
    {
        ...
        return view('abroad.reserve.reserveStudent', [
            'student' => $student,
        ]);
    }
    ...
    public function reserveExtend(Request $request)
    {
        ...
        return view('abroad.reserve.reserveExtend', [
            'reserve' => $reserve,
        ]);
    }
    ...
    public function reserveCancelled(Request $request)
    {
        ...
        return view('abroad.reserve.reserveCancelled', [
            'reserve' => $reserve,
