...
class StaffController extends Controller
{
    ...
    {
        return view('abroad.staffs.index', [
            'columns' => [
    ...
    public function list(Request $request)
    {
        ...
        return view('abroad.staffs.list', [
            'staffs' => $staffs,
    ...
    {
        return view('abroad.staffs.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('abroad.staffs.create', [
                'errors' => $errors,
                'staff' => $staff
            ], 400);
        }
    ...
    public function show(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('abroad.staffs.show', [
            'teacher' => $teacher,
            'courses' => $courses,
    ...
    public function busySchedule(Request $request, $id)
    {
       $teacher = Teacher::find($id);
        ...
        return view('abroad.staffs.busy-schedule', [
            'teacher' => $teacher,
        ]);
    }
    ...
    {
        $teacher = Teacher::find($id);
        $errors = $teacher->saveBusyScheduleFromRequest($request);

        if (!$errors->isEmpty()) {
            return response()->view('abroad.staffs.busy-schedule', [
                'errors' => $errors,
                'teacher' => $teacher
            ], 400);
        }
    ...
    public function class(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('abroad.staffs.class', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses,
            'columns' => [
    ...
    public function classList(Request $request, $id)
    {
        ...
        //
        return view('abroad.staffs.classList', [
            'courses' => $courses,
            'teacher' => $teacher,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function calendar(Request $request, $id)
    {
        ...
        //
        return view('abroad.staffs.calendar', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses
        ]);
    ...
    public function teachingSchedule(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('abroad.staffs.teachingSchedule', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses
        ]);
    ...
    public function teachingScheduleList(Request $request, $id)
    {
        ...
        //
        return view('abroad.staffs.teachingScheduleList', [
            'sections' => $sections,
            'students' => $students,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function salarySheet(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('abroad.staffs.salarySheet', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses
        ]);
    ...
    public function salarySheetList(Request $request, $id)
    {
        ...
        return view('abroad.staffs.salarySheetList', [
    ...
    public function expenseHistory(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('abroad.staffs.expenseHistory', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses
        ]);
