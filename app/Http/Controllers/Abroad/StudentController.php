...
class StudentController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('abroad.students.index', [
            'accounts' => $accounts,
            'tags' => $tags,
    ...
    public function list(Request $request)
    {
        ...
        return view('abroad.students.list', [
            'students' => $students,
    ...
    public function create(Request $request)
    {
        ...
        return view('abroad.students.create', [
            'contact' => $contact,
            'tags' => $tags,
            'accounts' => $accounts,
        ]);
    ...
    public function store(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('abroad.students.create', [
                'contact' => $contact,
                'errors' => $errors,
                'tags' => $tags,
                'accounts' => $accounts,
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('abroad.students.edit', [
                'contact' => $contact,
                'errors' => $errors,
                'tags' => $tags,
                'accounts' => $accounts,
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('abroad.students.edit', [
            'contact' => $contact,
            'tags' => $tags,
            'accounts' => $accounts,
        ]);
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('abroad.students.show', [
            'contact' => $contact,
            'accounts' => $accounts,
    ...
    public function class(Request $request, $id)
    {
        ...
        return view('abroad.students.class', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function classList(Request $request, $id)
    {
        ...
        //
        return view('abroad.students.classList', [
            'courseStudents' => $courseStudents,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function calendar(Request $request, $id)
    {
        ...
        return view('abroad.students.calendar', [
            'contact' => $contact,
            'courseStudents' => $courseStudents,
    ...
    public function section(Request $request, $id)
    {
        ...
        $courseStudents = CourseStudent::where('student_id', $id)->get();
        //
        return view('abroad.students.section', [
            'contact' => $contact,
            'orderItems' => $orderItems,
            'courseStudents' => $courseStudents
        ]);
    ...
    public function sectionList(Request $request, $id)
    {
        ...
        return view('abroad.students.sectionList', [
            'contact' => $contact,
            'sections' => $sections,
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    public function schedule(Request $request, $id)
    {
        ...
        return view('abroad.students.schedule', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'sortColumn' => $sortColumn,
    ...
    public function contract(Request $request, $id)
    {
        ...
        return view('abroad.students.contract', [
            'courseStudents' => $courseStudents,
            'contact' => $contact,
            'accounts' => $accounts,
    ...
    public function contractList(Request $request, $id)
    {
        ...
        return view('abroad.students.contract-list', [
            'contact' => $contact,
            'accounts' => $accounts,
            'orders' => $orders,
            'sortColumn' => $sortColumn,
    ...
    public function noteLog(Request $request, $id)
    {
        ...
        return view('abroad.students.note-logs', [
            'courseStudents' => $courseStudents,
            'contact' => $contact,
            'accounts' => $accounts,
        ]);
    ...
    public function noteLogList(Request $request, $id)
    {
        ...
        return view('abroad.students.note-logs-list', [
            'notes' => $notes,
            'contact' => $contact,
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    public function extraActivity(Request $request, $id)
    {
        ...
        return view('abroad.students.extra-activity', [
            'contact' => $contact,
            'courseStudents' => $courseStudents
        ]);
    }
    ...
    public function kidTech(Request $request, $id)
    {
        ...
        return view('abroad.students.kid-tech', [
            'contact' => $contact,
            'courseStudents' => $courseStudents
        ]);
    }
    ...
    {
        $request->merge(['type' => 'abroad_student']);
    ...
    public function addNoteLogContact(Request $request, $id)
    {
        ...
        return view('abroad.extracurricular.contacts.add-notelog-customer', [
            'contact' => $contact
        ]);
    }
    ...
    public function storeNoteLogContact(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('abroad.extracurricular.contacts.add-notelog-customer', [
                'errors' => $errors,
                'contact' => $contact
            ], 400);
        }
    ...
    public function orderForm(Request $request)
    {
        ...
        return view('abroad.students.order_form', [
            'orders' => $orders
        ]);
    }
    ...
    public function orderItemForm(Request $request)
    {
        ...
        return view('abroad.students.orderItemForm', [
            'orderItems' => $orderItems,
            'student' => $student
        ]);
    }
    ...
    public function courseForm(Request $request)
    {
        ...
        return view('abroad.students.course_form', [
            'courses' => $courses
        ]);
    }
    ...
    public function doneAssignToClass(Request $request)
    {
        ...
        try {
            //
            $student->assignCourse($course, $orderItem); // xếp lớp phải thông qua hợp đồng
    ...
    public function studyPartner(Request $request)
    {
        ...
        return view('abroad.students.studyPartner', [
            'section' => $section,
            'studentId' => $studentId
        ]);
    }
    ...
    public function sectionForm(Request $request)
    {
        ...
        return view('abroad.students.section_form', [
            'sections' => $sections
        ]);
    }
    ...
    public function courseStudentForm(Request $request)
    {
        ...
        return view('abroad.students.course_student_form', [
            'courseStudents' => $courseStudents,
            'studentId' => $studentId
        ]);
    }
    ...
    public function sectionStudent(Request $request)
    {
        ...
        return view('abroad.students.section_student_form', [
            'sections' => $sections
        ]);
    }
    ...
    public function coursePartner(Request $request)
    {
        ...
        return view('abroad.students.course_partner_form', [
    ...
    public function transferClass(Request $request)
    {
        ...
        return view('abroad.students.transferClass', [
            'student' => $student,
    ...
    public function courseTransferStudentForm(Request $request)
    {
        ...
        return view('abroad.students.course_transfer_student_form', [
    ...
    public function courseTransfer(Request $request)
    {
        ...
        return view('abroad.students.course_transfer_form', [
    ...
    public function reserveClass(Request $request)
    {
        ...
        return view('abroad.students.reserveClass', [
            'student' => $student,
            'currentCourse' => $currentCourse
        ]);
    }
    ...
    public function courseReserveStudentForm(Request $request)
    {
        ...
        return view('abroad.students.course_reserve_student_form', [
            'currentCourses' => $currentCourses,
            'currentCourseStudentId' => $currentCourseStudentId,
        ]);
    }
    ...
    public function refundRequest(Request $request)
    {
        ...
        return view('abroad.students.refundRequest', [
            'student' => $student,
            'currentCourse' => $currentCourse
        ]);
    }
    ...
    public function courseRefundRequestForm(Request $request)
    {
        ...
        return view('abroad.students.course_refund_request_form', [
            'currentCourses' => $currentCourses,
            'studentId' => $studentId,
        ]);
    }
    ...
    public function orderItemRefundRequestForm(Request $request)
    {
        ...
        return view('abroad.students.order_item_refund_request_form', [
            'orderItems' => $orderItems,
    ...
    public function assignToClassRequestDemo(Request $request)
    {
        ...
        return view('abroad.students.assignToClassRequestDemo', [
            'student' => $student,
        ]);
    }
    ...
    public function orderFormRequestDemo(Request $request)
    {
        ...
        return view('abroad.students.order_form_request_demo', [
            'orders' => $orders
        ]);
    }
    ...
    public function orderItemFormRequestDemo(Request $request)
    {
        ...
        return view('abroad.students.orderItemFormRequestDemo', [
            'orderItems' => $orderItems
        ]);
    }
    ...
    public function courseFormRequestDemo(Request $request)
    {
        ...
        return view('abroad.students.course_form_request_demo', [
            'courses' => $courses
        ]);
    }
    ...
    public function sectionFormRequestDemo(Request $request)
    {
        ...
        return view('abroad.students.section_form_request_demo', [
            'sections' => $sections
        ]);
    }
    ...
    public function refund(Request $request, $id)
    {
        ...
        return view('abroad.students.refund', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function refundList(Request $request, $id)
    {
        ...
        //
        return view('abroad.students.refundList', [
            'requests' => $requests,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function reserve(Request $request)
    {
        ...
        return view('abroad.reserve.reserve', [
            'student' => $student,
            'currentCourse' => $currentCourse
        ]);
    }
    ...
    public function orderItemReserveForm(Request $request)
    {
        ...
        return view('abroad.reserve.orderItemReserveForm', [
            'orderItems' => $orderItems,
            'studentId' => $studentId,
        ]);
    }
    ...
    public function courseReserveForm(Request $request)
    {
        ...
        return view('abroad.reserve.courseReserveForm', [
            'currentCourses' => $currentCourses,
            'studentId' => $studentId,
        ]);
    }
    ...
    public function transfer(Request $request)
    {
        ...
        return view('abroad.students.transfer', [
            'student' => $student,
            'currentCourse' => $currentCourse
        ]);
    }
    ...
    public function transferOrderItemSelect(Request $request)
    {
        ...
        return view('abroad.students.transferOrderItemSelect', [
            'orderItems' => $orderItems,
            'studentId' => $studentId,
        ]);
    }
    ...
    public function transferFormDetail(Request $request)
    {
        ...
        return view('abroad.students.transferFormDetail', [
            'currentCourses' => $currentCourses,
            'studentId' => $studentId,
            'orderItem' => $orderItem
        ]);
    ...
    public function reserveStudentDetail(Request $request, $id)
    {
        ...
        return view('abroad.students.reserveStudentDetail', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function reserveList(Request $request, $id)
    {
        ...
        return view('abroad.students.reserveList', [
            'reserves' => $reserves,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function transferStudentDetail(Request $request, $id)
    {
        ...
        return view('abroad.students.transferStudentDetail', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function transferList(Request $request, $id)
    {
        ...
        return view('abroad.students.transferList', [
            'transfers' => $transfers,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function exitClass(Request $request)
    {
        ...
        return view('abroad.students.exitClass', [
            'student' => $student,
            'course' => $course
        ]);
    }
