...
class NoteLogController extends Controller
{
    ...
    {
        return view('abroad.note_logs.index', [
    ...
    public function list(Request $request)
    {
        ...
        return view('abroad.note_logs.list', [
            'notes' => $notes,
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('abroad.note_logs.edit', [
            'note' => $note
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('abroad.note_logs.edit', [
                'errors' => $errors,
                'note' => $note
            ], 400);
        };
    ...
    public function create(Request $request)
    {
        ...
        return view('abroad.note_logs.create', [
            'notelog' => $notelog,
        ]);
    }
    ...
    public function createNoteLogCustomer(Request $request, $id)
    {
        ...
        return view('abroad.note_logs.create-notelog-customer', [
            'contact' => $contact
        ]);
    }
    ...
    public function storeNoteLog(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('abroad.note_logs.create-notelog-customer', [
                'errors' => $errors,
                'contact' => $contact
            ], 400);
        }
    ...
    public function noteLogsPopup(Request $request, $id)
    {
        ...
        return view('abroad.note_logs.note-logs-popup', [
            'notes' => $notes,
            'contact' => $contact,
    ...
    {
        $contact = Contact::find($id);
        return view('abroad.note_logs.add-notelog', [
            'contact' => $contact
        ]);
    }
}