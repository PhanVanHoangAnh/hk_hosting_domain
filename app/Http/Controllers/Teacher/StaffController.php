...
class StaffController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('teacher.staffs.index', [
            'columns' => $columns,
    ...
    public function list(Request $request)
    {
        ...
        return view('teacher.staffs.list', [
            'staffs' => $staffs,
    ...
    {
        return view('teacher.staffs.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('teacher.staffs.create', [
                'errors' => $errors,
                'staff' => $staff
            ], 400);
        }
    ...
    public function show(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('teacher.staffs.show', [
            'teacher' => $teacher,
            'courses' => $courses,
    ...
    public function busySchedule(Request $request, $id)
    {
       $teacher = Teacher::find($id);
        ...
        return view('teacher.staffs.busy-schedule', [
            'teacher' => $teacher,
        ]);
    }
    ...
    public function showFreeTimeSchedule(Request $request)
    {
        ...
        return view('teacher.staffs.busySchedule', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses,
    ...
    public function showSchedule(Request $request)
    {
        ...
        return view('teacher.staffs.show-busy-schedule', [
            'teacher' => $teacher,
        ]);
    }
    ...
    public function editBusySchedule(Request $request)
    {
        ...
        return view('teacher.staffs.edit-busy-schedule', [
            'freeTime' => $freeTime,
    ...
    public function class(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('teacher.staffs.class', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses,
            'columns' => [
    ...
    public function classList(Request $request, $id)
    {
        ...
        //
        return view('teacher.staffs.classList', [
            'courses' => $courses,
            'teacher' => $teacher,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function calendar(Request $request, $id)
    {
        ...
        return view('teacher.staffs.calendar', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses,
    ...
    public function teachingSchedule(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('teacher.staffs.teachingSchedule', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses
        ]);
    ...
    public function teachingScheduleList(Request $request, $id)
    {
        ...
        return view('teacher.staffs.teachingScheduleList', [
            'sections' => $sections,
            'students' => $students,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function salarySheet(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('teacher.staffs.salarySheet', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses
        ]);
    ...
    public function salarySheetList(Request $request, $id)
    {
        ...
        return view('teacher.staffs.salarySheetList', [
    ...
    public function expenseHistory(Request $request, $id)
    {
       ...
       $sectionCourses = Section::where(function($query) use ($id) {
        ...
        return view('teacher.staffs.expenseHistory', [
            'teacher' => $teacher,
            'courses' => $courses,
            'sectionCourses' => $sectionCourses
        ]);
