...
class CourseController2 extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('teacher.edu.courses.index', [
            'courses' => $courses,
            'columns' => [
    ...
    public function editCalendar(Request $request)
    {
        ...
        return view('teacher.courses.editCalendar', [
            'course' => $course,
            'sections' => $sections
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('teacher.courses._form', [
                'errors' => $errors,
                'course' => $course,
                'action' => 'add'
            ], 400);
    ...
    public function updateCalendar(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('teacher.courses.editCalendar', [
                'errors' => $errors,
                'course' => $course
            ], 400);
        }
    ...
    public function showDetail(Request $request, $id)
    {
        ...
        return view('teacher.courses.showDetail', [
            'course' => $course,
    ...
    public function studentList(Request $request, $id)
    {
        ...
        return view('teacher.courses.studentList', [
            'course' => $course,
            'students' => $students,
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    {
        return view('teacher.courses.addSchedule', [
    ...
    public function createScheduleItem(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('teacher.courses.addSchedule', [
                "errors" => $errors,
                "schedule" => $schedule
            ], 400);
        } else {
    ...
    public function sections(Request $request, $id)
    {
        ...
        return view('teacher.courses.sections', [
            'course' => $course,
            'sections' => $sections
        ]);
    }
    ...
    public function reschedulePopup(Request $request, $id)
    {
        ...
        return view('teacher.courses.reschedulePopup', [
    ...
    public function updateSchedulePopup(Request $request, $id)
    {
        ...
        if (!empty($errors)) {
            return response()->view('teacher.courses.reschedulePopup', [
                'section' => $section,
                'errors' => $errors,
                'sectionAll' => $sectionAll,
                'students' => $students,
    ...
    public function attendancePopup(Request $request, $id)
    {
        ...
        return view('teacher.courses.attendancePopup', [
            'students' =>   $students,
            'section' => $section
        ]);
    }
    ...
    public function courseStopped(Request $request)
    {
        ...
        return view('teacher.courses.courseStopped', [
            'course' => $course
        ]);
    }
    ...
    public function suggestTeacher(Request $request)
    {
        ...
        return view('teacher.courses.suggest_teacher', [
            'subjects' => $subjects
        ]);
    }
    ...
    public function class(Request $request)
    {
        ...
        return view('teacher.edu.courses.class', [
            'contact' => $contact,
            'accounts' => $accounts,
    ...
    public function classList(Request $request)
    {
        ...
        return view('teacher.edu.courses.classList', [
            'courseStudents' => $courseStudents,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function refund(Request $request)
    {
        ...
        return view('teacher.edu.courses.refund', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'columns' => [
    ...
    public function refundList(Request $request)
    {
        ...
        return view('teacher.edu.courses.refundList', [
            'requests' => $requests,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function reserveStudent(Request $request)
    {
        ...
        return view('teacher.edu.courses.reserveStudent', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'columns' => [
    ...
    public function reserveList(Request $request)
    {
        ...
        return view('teacher.edu.courses.reserveList', [
            'reserves' => $reserves,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function transfer(Request $request)
    {
        ...
        return view('teacher.edu.courses.transfer', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'columns' => [
    ...
    public function transferList(Request $request)
    {
        ...
        //
        return view('teacher.edu.courses.transferList', [
            'transfers' => $transfers,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function reportsection(Request $request)
    {
        ...
        return view('teacher.courses.reportSectionSelect', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'columns' => [
