...
class ReserveController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('teacher.reserve.index', [
            'accounts' => $accounts,
            'tags' => $tags,
    ...
    public function list(Request $request)
    {
        ...
        return view('teacher.reserve.list', [
            'reserves' => $reserves,
    ...
    public function reserveStudent(Request $request)
    {
        ...
        return view('teacher.reserve.reserveStudent', [
            'student' => $student,
        ]);
    }
    ...
    public function reserveExtend(Request $request)
    {
        ...
        return view('teacher.reserve.reserveExtend', [
            'reserve' => $reserve,
    ...
    public function reserveCancelled(Request $request)
    {
        ...
        return view('teacher.reserve.reserveCancelled', [
            'reserve' => $reserve,
