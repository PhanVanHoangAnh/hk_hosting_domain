...
class TeacherController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('teacher.courses.create', [
                'contact' => $contact,
                'errors' => $errors,
                'tags' => $tags,
                'accounts' => $accounts,
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$errors->isEmpty()) {
            return response()->view('teacher.courses.edit', [
                'contact' => $contact,
                'errors' => $errors,
                'tags' => $tags,
                'accounts' => $accounts,
    ...
    public function class(Request $request, $id)
    {
        ...
        return view('teacher.courses.class', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function classList(Request $request, $id)
    {
        ...
        //
        return view('teacher.courses.classList', [
            'courseStudents' => $courseStudents,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function calendar(Request $request, $id)
    {
        ...
        return view('teacher.courses.calendar', [
            'contact' => $contact,
            'courseStudents' => $courseStudents,
    ...
    public function section(Request $request, $id)
    {
        ...
        $courseStudents = CourseStudent::where('student_id', $id)->get();
        //
        return view('teacher.courses.section', [
            'contact' => $contact,
            'orderItems' => $orderItems,
            'courseStudents' => $courseStudents
        ]);
    ...
    public function sectionList(Request $request, $id)
    {
        ...
        return view('teacher.courses.sectionList', [
            'contact' => $contact,
            'sections' => $sections,
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    public function schedule(Request $request, $id)
    {
        ...
        return view('teacher.courses.schedule', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
    ...
    public function contract(Request $request, $id)
    {
        ...
        //
        return view('teacher.courses.contract', [
            'courseStudents' => $courseStudents,
            'contact' => $contact,
            'accounts' => $accounts,
    ...
    public function contractList(Request $request, $id)
    {
        ...
        return view('teacher.courses.contract-list', [
            'contact' => $contact,
            'accounts' => $accounts,
            'orders' => $orders,
    ...
    public function noteLog(Request $request, $id)
    {
        ...
        return view('teacher.courses.note-logs', [
            'courseStudents' => $courseStudents,
            'contact' => $contact,
            'accounts' => $accounts,
        ]);
    ...
    public function noteLogList(Request $request, $id)
    {
        ...
        return view('teacher.courses.note-logs-list', [
            'notes' => $notes,
            'contact' => $contact,
            'sortColumn' => $sortColumn,
            'sortDirection' => $sortDirection,
    ...
    public function extraActivity(Request $request, $id)
    {
        ...
        $courseStudents = CourseStudent::where('student_id', $id)->get();
        //
        return view('teacher.courses.extra-activity', [
            'contact' => $contact,
            'courseStudents' => $courseStudents
        ]);
    }
    ...
    public function kidTech(Request $request, $id)
    {
        $contact = Contact::find($id);
        $courseStudents = CourseStudent::where('student_id', $id)->get();
        return view('teacher.courses.kid-tech', [
            'contact' => $contact,
            'courseStudents' => $courseStudents
        ]);
    }
    ...
    public function assignToClass(Request $request)
    {
        ...
        return view('teacher.courses.assignToClass', [
            'student' => $student,
        ]);
    }
    ...
    public function orderForm(Request $request)
    {
        ...
        return view('teacher.courses.order_form', [
            'orders' => $orders
        ]);
    }
    ...
    public function orderItemForm(Request $request)
    {
        ...
        return view('teacher.courses.orderItemForm', [
            'orderItems' => $orderItems,
            'student' => $student
        ]);
    }
    ...
    public function courseForm(Request $request)
    {
        ...
        return view('teacher.courses.course_form', [
            'courses' => $courses
        ]);
    }
    ...
    public function studyPartner(Request $request)
    {
        ...
        return view('teacher.courses.studyPartner', [
            'section' => $section,
            'studentId' => $studentId
        ]);
    }
    ...
    public function sectionForm(Request $request)
    {
        ...
        return view('teacher.courses.section_form', [
            'sections' => $sections
        ]);
    }
    ...
    public function courseStudentForm(Request $request)
    {
        ...
        return view('teacher.courses.course_student_form', [
            'courseStudents' => $courseStudents,
            'studentId' => $studentId
        ]);
    }
    ...
    public function sectionStudent(Request $request)
    {
        ...
        return view('teacher.courses.section_student_form', [
            'sections' => $sections
        ]);
    }
    ...
    public function coursePartner(Request $request)
    {
        ...
        return view('teacher.courses.course_partner_form', [
    ...
    public function transferClass(Request $request)
    {
        ...
        return view('teacher.courses.transferClass', [
            'student' => $student,
    ...
    public function courseTransferStudentForm(Request $request)
    {
        ...
        return view('teacher.courses.course_transfer_student_form', [
    ...
    public function courseTransfer(Request $request)
    {
        ...
        return view('teacher.courses.course_transfer_form', [
    ...
    public function reserveClass(Request $request)
    {
        ...
        return view('teacher.courses.reserveClass', [
            'student' => $student,
            'currentCourse' => $currentCourse
        ]);
    }
    ...
    public function courseReserveStudentForm(Request $request)
    {
        ...
        return view('teacher.courses.course_reserve_student_form', [
            'currentCourses' => $currentCourses,
            'currentCourseStudentId' => $currentCourseStudentId,
        ]);
    }
    ...
    public function refundRequest(Request $request)
    {
        ...
        return view('teacher.courses.refundRequest', [
            'student' => $student,
            'currentCourse' => $currentCourse
        ]);
    }
    ...
    public function courseRefundRequestForm(Request $request)
    {
        ...
        return view('teacher.courses.course_refund_request_form', [
            'currentCourses' => $currentCourses,
            'studentId' => $studentId,
        ]);
    }
    ...
    public function orderItemRefundRequestForm(Request $request)
    {
        ...
        return view('teacher.courses.order_item_refund_request_form', [
            'orderItems' => $orderItems,
    ...
    public function assignToClassRequestDemo(Request $request)
    {
        ...
        return view('teacher.courses.assignToClassRequestDemo', [
            'student' => $student,
        ]);
    }
    ...
    public function orderFormRequestDemo(Request $request)
    {
        ...
        return view('teacher.courses.order_form_request_demo', [
            'orders' => $orders
        ]);
    }
    ...
    public function orderItemFormRequestDemo(Request $request)
    {
        ...
        return view('teacher.courses.orderItemFormRequestDemo', [
            'orderItems' => $orderItems
        ]);
    }
    ...
    public function courseFormRequestDemo(Request $request)
    {
        ...
        return view('teacher.courses.course_form_request_demo', [
            'courses' => $courses
        ]);
    }
    ...
    public function sectionFormRequestDemo(Request $request)
    {
        ...
        return view('teacher.courses.section_form_request_demo', [
            'sections' => $sections
        ]);
    }
    ...
    public function refund(Request $request, $id)
    {
        ...
        return view('teacher.courses.refund', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function refundList(Request $request, $id)
    {
        ...
        return view('teacher.courses.refundList', [
            'requests' => $requests,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function transfer(Request $request)
    {
        ...
        return view('teacher.courses.transfer', [
            'student' => $student,
            'currentCourse' => $currentCourse
        ]);
    }
    ...
    public function transferOrderItemSelect(Request $request)
    {
        ...
        return view('teacher.courses.transferOrderItemSelect', [
            'orderItems' => $orderItems,
            'studentId' => $studentId,
        ]);
    }
    ...
    public function transferFormDetail(Request $request)
    {
        ...
        return view('teacher.courses.transferFormDetail', [
            'currentCourses' => $currentCourses,
            'studentId' => $studentId,
            'orderItem' => $orderItem
        ]);
    ...
    public function reserveStudentDetail(Request $request, $id)
    {
        ...
        return view('teacher.courses.reserveStudentDetail', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function reserveList(Request $request, $id)
    {
        ...
        return view('teacher.courses.reserveList', [
            'reserves' => $reserves,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function transferStudentDetail(Request $request, $id)
    {
        ...
        return view('teacher.courses.transferStudentDetail', [
            'contact' => $contact,
            'accounts' => $accounts,
            'courseStudents' => $courseStudents,
            'orderItems' => $orderItems,
    ...
    public function transferList(Request $request, $id)
    {
        ...
        return view('teacher.courses.transferList', [
            'transfers' => $transfers,
            'contact' => $contact,
            'columns' => $request->columns ?? [],
            'sortColumn' => $sortColumn,
    ...
    public function exitClass(Request $request)
    {
        ...
        return view('teacher.courses.exitClass', [
            'student' => $student,
            'course' => $course
        ]);
    }
    ...
    public function showFreeTimeSchedule(Request $request)
    {
        ...
        return view('teacher.courses.busySchedule', [
            'student' => $student,
            'contact' => $student,
            'orderItems' => $orderItems,
            'courseStudents' => $courseStudents
