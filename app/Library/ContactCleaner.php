...
class ContactCleaner
{
    ...
    public function removeDupRequests($contactRequest)
    {
        ...
        foreach ($dupRequests as $dupRequest) {
            ...
            if (!$contactRequest->birthday && $dupRequest->birthday) {
                $contactRequest->birthday = $dupRequest->birthday;
            }
    ...
    public function cleanupDuplicatedContact($contact, $index)
    {
        ...
        foreach ($duplicatedContacts as $duplicatedContact) {
            ...
            if (!$contact->birthday && $duplicatedContact->birthday) {
                $contact->birthday = $duplicatedContact->birthday;
            }
