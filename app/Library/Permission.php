...
class Permission
{
    public const SALES_ACCOUNT_GROUP_MANAGE = 'sales.account_group.manage';
    public const SALES_ACCOUNT_GROUP_MENTOR = 'sales.account_group.mentor';
    
    public const STUDENT_GENERAL = 'student.general';

    public const SALES_ORDER_CONTACT_REQUEST_All = 'sales.order.contact_request.all';
    public const SALES_ORDER_CONTACT_REQUEST_ADD = 'sales.order.contact_request.add';
    public const SALES_ORDER_CONTACT_REQUEST_UPDATE = 'sales.order.contact_request.update';
    public const SALES_ORDER_CONTACT_REQUEST_DELETE = 'sales.order.contact_request.delete';
    public const SALES_ORDER_CONTACT_REQUEST_LIST = 'sales.order.contact_request.list';
    public const SALES_ORDER_CONTACT_REQUEST_BROWSER = 'sales.order.contact_request.browser';
    ...
    public const CHANGE_TO_HN = 'branch.hn';
    public const CHANGE_TO_SG = 'branch.sg';
    ...
    public const MARKETING_CONTACT_REQUEST_EXPORT = 'marketing.contact_request.export';
    public const MARKETING_CONTACT_REQUEST_VIEW_PHONE = 'marketing.contact_request.view_phone';
    ...
    public const SALES_SALE_SELECT = 'sales.order.select_sale';
    ...
    public static function getAllMarketings()
    {
        return [
            ...
            'export' => [
                self::MARKETING_CONTACT_REQUEST_EXPORT,
            ], 
