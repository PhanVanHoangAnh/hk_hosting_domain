...
class UpdateSchoolBirthday extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:update-school-birthday {--console=} {--force=} {--line=}';
    ...
    public function handle()
    {
        ...
        foreach ($sheets as $sheet) {
            $importer = new \App\Library\ShoolBirthdayUpdater($sheet['sheet_id'], $sheet['date_format']);
