...
class ImportFromGoogleSheetWithParent extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:import-from-google-sheet-with-parent {--console=} {--force=} {--line=}';
    ...
    public function handle()
    {
        ...
        $sheets = [
            [
                'sheet_id' => "1jWetSrNFUOKzvsSu-i8I_B1UsvKMIJG-o-5Q15sM7Vg",
                'date_format' => 'Y-m-d',
            ],
        ];
