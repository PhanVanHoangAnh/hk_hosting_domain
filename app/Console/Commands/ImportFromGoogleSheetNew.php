...
class ImportFromGoogleSheetNew extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:import-from-google-sheet-new {--console=} {--force=} {--line=}';
    ...
    public function handle()
    {
        ...
        $sheets = [
            [
                'sheet_id' => "1ZUbBRBRYzkNR9s1laFxlKCZCjq1Ak3eD8ZTzTGJTr9s",
                'date_format' => 'Y-m-d',
            ],
        ];

        foreach ($sheets as $sheet) {
            $importer = new \App\Library\GoogleSheetImporterNew($sheet['sheet_id'], $sheet['date_format']);
