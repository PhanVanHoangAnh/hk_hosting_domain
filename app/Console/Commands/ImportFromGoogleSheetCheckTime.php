...
class ImportFromGoogleSheetCheckTime extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:import-from-google-sheet-check-time {--console=} {--force=} {--line=}';
    ...
    public function handle()
    {
        ...
        foreach ($sheets as $sheet) {
            $importer = new \App\Library\GoogleSheetImporterCheckTime($sheet['sheet_id'], $sheet['date_format']);
